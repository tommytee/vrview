!function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a="function"==typeof require&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}for(var i="function"==typeof require&&require,o=0;o<r.length;o++)s(r[o]);return s}({1:[function(_dereq_,module,exports){(function(process,global){!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?module.exports=factory():"function"==typeof define&&define.amd?define(factory):global.ES6Promise=factory()}(this,function(){"use strict";function objectOrFunction(x){return"function"==typeof x||"object"==typeof x&&null!==x}function isFunction(x){return"function"==typeof x}function setScheduler(scheduleFn){customSchedulerFn=scheduleFn}function setAsap(asapFn){asap=asapFn}function useNextTick(){return function(){return process.nextTick(flush)}}function useVertxTimer(){return"undefined"!=typeof vertxNext?function(){vertxNext(flush)}:useSetTimeout()}function useMutationObserver(){var iterations=0,observer=new BrowserMutationObserver(flush),node=document.createTextNode("");return observer.observe(node,{characterData:!0}),function(){node.data=iterations=++iterations%2}}function useMessageChannel(){var channel=new MessageChannel;return channel.port1.onmessage=flush,function(){return channel.port2.postMessage(0)}}function useSetTimeout(){var globalSetTimeout=setTimeout;return function(){return globalSetTimeout(flush,1)}}function flush(){for(var i=0;len>i;i+=2){var callback=queue[i],arg=queue[i+1];callback(arg),queue[i]=void 0,queue[i+1]=void 0}len=0}function attemptVertx(){try{var r=_dereq_,vertx=r("vertx");return vertxNext=vertx.runOnLoop||vertx.runOnContext,useVertxTimer()}catch(e){return useSetTimeout()}}function then(onFulfillment,onRejection){var _arguments=arguments,parent=this,child=new this.constructor(noop);void 0===child[PROMISE_ID]&&makePromise(child);var _state=parent._state;return _state?!function(){var callback=_arguments[_state-1];asap(function(){return invokeCallback(_state,child,callback,parent._result)})}():subscribe(parent,child,onFulfillment,onRejection),child}function resolve(object){var Constructor=this;if(object&&"object"==typeof object&&object.constructor===Constructor)return object;var promise=new Constructor(noop);return _resolve(promise,object),promise}function noop(){}function selfFulfillment(){return new TypeError("You cannot resolve a promise with itself")}function cannotReturnOwn(){return new TypeError("A promises callback cannot return that same promise.")}function getThen(promise){try{return promise.then}catch(error){return GET_THEN_ERROR.error=error,GET_THEN_ERROR}}function tryThen(then,value,fulfillmentHandler,rejectionHandler){try{then.call(value,fulfillmentHandler,rejectionHandler)}catch(e){return e}}function handleForeignThenable(promise,thenable,then){asap(function(promise){var sealed=!1,error=tryThen(then,thenable,function(value){sealed||(sealed=!0,thenable!==value?_resolve(promise,value):fulfill(promise,value))},function(reason){sealed||(sealed=!0,_reject(promise,reason))},"Settle: "+(promise._label||" unknown promise"));!sealed&&error&&(sealed=!0,_reject(promise,error))},promise)}function handleOwnThenable(promise,thenable){thenable._state===FULFILLED?fulfill(promise,thenable._result):thenable._state===REJECTED?_reject(promise,thenable._result):subscribe(thenable,void 0,function(value){return _resolve(promise,value)},function(reason){return _reject(promise,reason)})}function handleMaybeThenable(promise,maybeThenable,then$$){maybeThenable.constructor===promise.constructor&&then$$===then&&maybeThenable.constructor.resolve===resolve?handleOwnThenable(promise,maybeThenable):then$$===GET_THEN_ERROR?(_reject(promise,GET_THEN_ERROR.error),GET_THEN_ERROR.error=null):void 0===then$$?fulfill(promise,maybeThenable):isFunction(then$$)?handleForeignThenable(promise,maybeThenable,then$$):fulfill(promise,maybeThenable)}function _resolve(promise,value){promise===value?_reject(promise,selfFulfillment()):objectOrFunction(value)?handleMaybeThenable(promise,value,getThen(value)):fulfill(promise,value)}function publishRejection(promise){promise._onerror&&promise._onerror(promise._result),publish(promise)}function fulfill(promise,value){promise._state===PENDING&&(promise._result=value,promise._state=FULFILLED,0!==promise._subscribers.length&&asap(publish,promise))}function _reject(promise,reason){promise._state===PENDING&&(promise._state=REJECTED,promise._result=reason,asap(publishRejection,promise))}function subscribe(parent,child,onFulfillment,onRejection){var _subscribers=parent._subscribers,length=_subscribers.length;parent._onerror=null,_subscribers[length]=child,_subscribers[length+FULFILLED]=onFulfillment,_subscribers[length+REJECTED]=onRejection,0===length&&parent._state&&asap(publish,parent)}function publish(promise){var subscribers=promise._subscribers,settled=promise._state;if(0!==subscribers.length){for(var child=void 0,callback=void 0,detail=promise._result,i=0;i<subscribers.length;i+=3)child=subscribers[i],callback=subscribers[i+settled],child?invokeCallback(settled,child,callback,detail):callback(detail);promise._subscribers.length=0}}function ErrorObject(){this.error=null}function tryCatch(callback,detail){try{return callback(detail)}catch(e){return TRY_CATCH_ERROR.error=e,TRY_CATCH_ERROR}}function invokeCallback(settled,promise,callback,detail){var hasCallback=isFunction(callback),value=void 0,error=void 0,succeeded=void 0,failed=void 0;if(hasCallback){if(value=tryCatch(callback,detail),value===TRY_CATCH_ERROR?(failed=!0,error=value.error,value.error=null):succeeded=!0,promise===value)return void _reject(promise,cannotReturnOwn())}else value=detail,succeeded=!0;promise._state!==PENDING||(hasCallback&&succeeded?_resolve(promise,value):failed?_reject(promise,error):settled===FULFILLED?fulfill(promise,value):settled===REJECTED&&_reject(promise,value))}function initializePromise(promise,resolver){try{resolver(function(value){_resolve(promise,value)},function(reason){_reject(promise,reason)})}catch(e){_reject(promise,e)}}function nextId(){return id++}function makePromise(promise){promise[PROMISE_ID]=id++,promise._state=void 0,promise._result=void 0,promise._subscribers=[]}function Enumerator(Constructor,input){this._instanceConstructor=Constructor,this.promise=new Constructor(noop),this.promise[PROMISE_ID]||makePromise(this.promise),isArray(input)?(this._input=input,this.length=input.length,this._remaining=input.length,this._result=new Array(this.length),0===this.length?fulfill(this.promise,this._result):(this.length=this.length||0,this._enumerate(),0===this._remaining&&fulfill(this.promise,this._result))):_reject(this.promise,validationError())}function validationError(){return new Error("Array Methods must be provided an Array")}function all(entries){return new Enumerator(this,entries).promise}function race(entries){var Constructor=this;return new Constructor(isArray(entries)?function(resolve,reject){for(var length=entries.length,i=0;length>i;i++)Constructor.resolve(entries[i]).then(resolve,reject)}:function(_,reject){return reject(new TypeError("You must pass an array to race."))})}function reject(reason){var Constructor=this,promise=new Constructor(noop);return _reject(promise,reason),promise}function needsResolver(){throw new TypeError("You must pass a resolver function as the first argument to the promise constructor")}function needsNew(){throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.")}function Promise(resolver){this[PROMISE_ID]=nextId(),this._result=this._state=void 0,this._subscribers=[],noop!==resolver&&("function"!=typeof resolver&&needsResolver(),this instanceof Promise?initializePromise(this,resolver):needsNew())}function polyfill(){var local=void 0;if("undefined"!=typeof global)local=global;else if("undefined"!=typeof self)local=self;else try{local=Function("return this")()}catch(e){throw new Error("polyfill failed because global object is unavailable in this environment")}var P=local.Promise;if(P){var promiseToString=null;try{promiseToString=Object.prototype.toString.call(P.resolve())}catch(e){}if("[object Promise]"===promiseToString&&!P.cast)return}local.Promise=Promise}var _isArray=void 0;_isArray=Array.isArray?Array.isArray:function(x){return"[object Array]"===Object.prototype.toString.call(x)};var isArray=_isArray,len=0,vertxNext=void 0,customSchedulerFn=void 0,asap=function(callback,arg){queue[len]=callback,queue[len+1]=arg,len+=2,2===len&&(customSchedulerFn?customSchedulerFn(flush):scheduleFlush())},browserWindow="undefined"!=typeof window?window:void 0,browserGlobal=browserWindow||{},BrowserMutationObserver=browserGlobal.MutationObserver||browserGlobal.WebKitMutationObserver,isNode="undefined"==typeof self&&"undefined"!=typeof process&&"[object process]"==={}.toString.call(process),isWorker="undefined"!=typeof Uint8ClampedArray&&"undefined"!=typeof importScripts&&"undefined"!=typeof MessageChannel,queue=new Array(1e3),scheduleFlush=void 0;scheduleFlush=isNode?useNextTick():BrowserMutationObserver?useMutationObserver():isWorker?useMessageChannel():void 0===browserWindow&&"function"==typeof _dereq_?attemptVertx():useSetTimeout();var PROMISE_ID=Math.random().toString(36).substring(16),PENDING=void 0,FULFILLED=1,REJECTED=2,GET_THEN_ERROR=new ErrorObject,TRY_CATCH_ERROR=new ErrorObject,id=0;return Enumerator.prototype._enumerate=function(){for(var length=this.length,_input=this._input,i=0;this._state===PENDING&&length>i;i++)this._eachEntry(_input[i],i)},Enumerator.prototype._eachEntry=function(entry,i){var c=this._instanceConstructor,resolve$$=c.resolve;if(resolve$$===resolve){var _then=getThen(entry);if(_then===then&&entry._state!==PENDING)this._settledAt(entry._state,i,entry._result);else if("function"!=typeof _then)this._remaining--,this._result[i]=entry;else if(c===Promise){var promise=new c(noop);handleMaybeThenable(promise,entry,_then),this._willSettleAt(promise,i)}else this._willSettleAt(new c(function(resolve$$){return resolve$$(entry)}),i)}else this._willSettleAt(resolve$$(entry),i)},Enumerator.prototype._settledAt=function(state,i,value){var promise=this.promise;promise._state===PENDING&&(this._remaining--,state===REJECTED?_reject(promise,value):this._result[i]=value),0===this._remaining&&fulfill(promise,this._result)},Enumerator.prototype._willSettleAt=function(promise,i){var enumerator=this;subscribe(promise,void 0,function(value){return enumerator._settledAt(FULFILLED,i,value)},function(reason){return enumerator._settledAt(REJECTED,i,reason)})},Promise.all=all,Promise.race=race,Promise.resolve=resolve,Promise.reject=reject,Promise._setScheduler=setScheduler,Promise._setAsap=setAsap,Promise._asap=asap,Promise.prototype={constructor:Promise,then:then,"catch":function(onRejection){return this.then(null,onRejection)}},Promise.polyfill=polyfill,Promise.Promise=Promise,Promise})}).call(this,_dereq_("_process"),"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{_process:3}],2:[function(_dereq_,module){"use strict";function Events(){}function EE(fn,context,once){this.fn=fn,this.context=context,this.once=once||!1}function EventEmitter(){this._events=new Events,this._eventsCount=0}var has=Object.prototype.hasOwnProperty,prefix="~";Object.create&&(Events.prototype=Object.create(null),(new Events).__proto__||(prefix=!1)),EventEmitter.prototype.eventNames=function(){var events,name,names=[];if(0===this._eventsCount)return names;for(name in events=this._events)has.call(events,name)&&names.push(prefix?name.slice(1):name);return Object.getOwnPropertySymbols?names.concat(Object.getOwnPropertySymbols(events)):names},EventEmitter.prototype.listeners=function(event,exists){var evt=prefix?prefix+event:event,available=this._events[evt];if(exists)return!!available;if(!available)return[];if(available.fn)return[available.fn];for(var i=0,l=available.length,ee=new Array(l);l>i;i++)ee[i]=available[i].fn;return ee},EventEmitter.prototype.emit=function(event,a1,a2,a3,a4,a5){var evt=prefix?prefix+event:event;if(!this._events[evt])return!1;var args,i,listeners=this._events[evt],len=arguments.length;if(listeners.fn){switch(listeners.once&&this.removeListener(event,listeners.fn,void 0,!0),len){case 1:return listeners.fn.call(listeners.context),!0;case 2:return listeners.fn.call(listeners.context,a1),!0;case 3:return listeners.fn.call(listeners.context,a1,a2),!0;case 4:return listeners.fn.call(listeners.context,a1,a2,a3),!0;case 5:return listeners.fn.call(listeners.context,a1,a2,a3,a4),!0;case 6:return listeners.fn.call(listeners.context,a1,a2,a3,a4,a5),!0}for(i=1,args=new Array(len-1);len>i;i++)args[i-1]=arguments[i];listeners.fn.apply(listeners.context,args)}else{var j,length=listeners.length;for(i=0;length>i;i++)switch(listeners[i].once&&this.removeListener(event,listeners[i].fn,void 0,!0),len){case 1:listeners[i].fn.call(listeners[i].context);break;case 2:listeners[i].fn.call(listeners[i].context,a1);break;case 3:listeners[i].fn.call(listeners[i].context,a1,a2);break;case 4:listeners[i].fn.call(listeners[i].context,a1,a2,a3);break;default:if(!args)for(j=1,args=new Array(len-1);len>j;j++)args[j-1]=arguments[j];listeners[i].fn.apply(listeners[i].context,args)}}return!0},EventEmitter.prototype.on=function(event,fn,context){var listener=new EE(fn,context||this),evt=prefix?prefix+event:event;return this._events[evt]?this._events[evt].fn?this._events[evt]=[this._events[evt],listener]:this._events[evt].push(listener):(this._events[evt]=listener,this._eventsCount++),this},EventEmitter.prototype.once=function(event,fn,context){var listener=new EE(fn,context||this,!0),evt=prefix?prefix+event:event;return this._events[evt]?this._events[evt].fn?this._events[evt]=[this._events[evt],listener]:this._events[evt].push(listener):(this._events[evt]=listener,this._eventsCount++),this},EventEmitter.prototype.removeListener=function(event,fn,context,once){var evt=prefix?prefix+event:event;if(!this._events[evt])return this;if(!fn)return 0===--this._eventsCount?this._events=new Events:delete this._events[evt],this;var listeners=this._events[evt];if(listeners.fn)listeners.fn!==fn||once&&!listeners.once||context&&listeners.context!==context||(0===--this._eventsCount?this._events=new Events:delete this._events[evt]);else{for(var i=0,events=[],length=listeners.length;length>i;i++)(listeners[i].fn!==fn||once&&!listeners[i].once||context&&listeners[i].context!==context)&&events.push(listeners[i]);events.length?this._events[evt]=1===events.length?events[0]:events:0===--this._eventsCount?this._events=new Events:delete this._events[evt]}return this},EventEmitter.prototype.removeAllListeners=function(event){var evt;return event?(evt=prefix?prefix+event:event,this._events[evt]&&(0===--this._eventsCount?this._events=new Events:delete this._events[evt])):(this._events=new Events,this._eventsCount=0),this},EventEmitter.prototype.off=EventEmitter.prototype.removeListener,EventEmitter.prototype.addListener=EventEmitter.prototype.on,EventEmitter.prototype.setMaxListeners=function(){return this},EventEmitter.prefixed=prefix,EventEmitter.EventEmitter=EventEmitter,"undefined"!=typeof module&&(module.exports=EventEmitter)},{}],3:[function(_dereq_,module){function defaultSetTimout(){throw new Error("setTimeout has not been defined")}function defaultClearTimeout(){throw new Error("clearTimeout has not been defined")}function runTimeout(fun){if(cachedSetTimeout===setTimeout)return setTimeout(fun,0);if((cachedSetTimeout===defaultSetTimout||!cachedSetTimeout)&&setTimeout)return cachedSetTimeout=setTimeout,setTimeout(fun,0);try{return cachedSetTimeout(fun,0)}catch(e){try{return cachedSetTimeout.call(null,fun,0)}catch(e){return cachedSetTimeout.call(this,fun,0)}}}function runClearTimeout(marker){if(cachedClearTimeout===clearTimeout)return clearTimeout(marker);if((cachedClearTimeout===defaultClearTimeout||!cachedClearTimeout)&&clearTimeout)return cachedClearTimeout=clearTimeout,clearTimeout(marker);try{return cachedClearTimeout(marker)}catch(e){try{return cachedClearTimeout.call(null,marker)}catch(e){return cachedClearTimeout.call(this,marker)}}}function cleanUpNextTick(){draining&&currentQueue&&(draining=!1,currentQueue.length?queue=currentQueue.concat(queue):queueIndex=-1,queue.length&&drainQueue())}function drainQueue(){if(!draining){var timeout=runTimeout(cleanUpNextTick);draining=!0;for(var len=queue.length;len;){for(currentQueue=queue,queue=[];++queueIndex<len;)currentQueue&&currentQueue[queueIndex].run();queueIndex=-1,len=queue.length}currentQueue=null,draining=!1,runClearTimeout(timeout)}}function Item(fun,array){this.fun=fun,this.array=array}function noop(){}var cachedSetTimeout,cachedClearTimeout,process=module.exports={};!function(){try{cachedSetTimeout="function"==typeof setTimeout?setTimeout:defaultSetTimout}catch(e){cachedSetTimeout=defaultSetTimout}try{cachedClearTimeout="function"==typeof clearTimeout?clearTimeout:defaultClearTimeout}catch(e){cachedClearTimeout=defaultClearTimeout}}();var currentQueue,queue=[],draining=!1,queueIndex=-1;process.nextTick=function(fun){var args=new Array(arguments.length-1);if(arguments.length>1)for(var i=1;i<arguments.length;i++)args[i-1]=arguments[i];queue.push(new Item(fun,args)),1!==queue.length||draining||runTimeout(drainQueue)},Item.prototype.run=function(){this.fun.apply(null,this.array)},process.title="browser",process.browser=!0,process.env={},process.argv=[],process.version="",process.versions={},process.on=noop,process.addListener=noop,process.once=noop,process.off=noop,process.removeListener=noop,process.removeAllListeners=noop,process.emit=noop,process.prependListener=noop,process.prependOnceListener=noop,process.listeners=function(){return[]},process.binding=function(){throw new Error("process.binding is not supported")},process.cwd=function(){return"/"},process.chdir=function(){throw new Error("process.chdir is not supported")},process.umask=function(){return 0}},{}],4:[function(_dereq_,module){!function(){var g={};(function(window){function m(a,b){var c=a.split("."),d=aa;c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)c.length||void 0===b?d=d[e]?d[e]:d[e]={}:d[e]=b}function ba(a){function c(){}var b=p;c.prototype=b.prototype,a.ne=b.prototype,a.prototype=new c,a.prototype.constructor=a,a.ke=function(a,c){return b.prototype[c].apply(a,Array.prototype.slice.call(arguments,2))}}function ca(a){this.c=Math.exp(Math.log(.5)/a),this.b=this.a=0}function da(a,b,c){var d=Math.pow(a.c,b);c=c*(1-d)+d*a.a,isNaN(c)||(a.a=c,a.b+=b)}function ea(a){return a.a/(1-Math.pow(a.c,a.b))}function fa(){this.c=new ca(2),this.f=new ca(5),this.a=0,this.b=5e5}function ga(){}function t(a,b,c){this.severity=a,this.category=b,this.code=c,this.data=Array.prototype.slice.call(arguments,3)}function ia(a){var b;a instanceof ia?(ja(this,a.X),this.xa=a.xa,this.Z=a.Z,ka(this,a.Fa),this.U=a.U,la(this,ma(a.a)),this.qa=a.qa):a&&(b=String(a).match(ha))?(ja(this,b[1]||"",!0),this.xa=na(b[2]||""),this.Z=na(b[3]||"",!0),ka(this,b[4]),this.U=na(b[5]||"",!0),la(this,b[6]||"",!0),this.qa=na(b[7]||"")):this.a=new oa(null)}function ja(a,b,c){a.X=c?na(b,!0):b,a.X&&(a.X=a.X.replace(/:$/,""))}function ka(a,b){if(b){if(b=Number(b),isNaN(b)||0>b)throw Error("Bad port number "+b);a.Fa=b}else a.Fa=null}function la(a,b,c){b instanceof oa?a.a=b:(c||(b=qa(b,va)),a.a=new oa(b))}function na(a,b){return a?b?decodeURI(a):decodeURIComponent(a):""}function qa(a,b,c){return"string"==typeof a?(a=encodeURI(a).replace(b,wa),c&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function wa(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(15&a).toString(16)}function oa(a){this.b=a||null}function ma(a){var b=new oa;if(b.b=a.b,a.a){var d,c={};for(d in a.a)c[d]=a.a[d].concat();b.a=c,b.c=a.c}return b}function xa(a,b){return a.reduce(function(a,b,e){return b["catch"](a.bind(null,e))}.bind(null,b),Promise.reject())}function x(a,b){return a.concat(b)}function y(){}function ya(a){return null!=a}function za(a){return function(b){return b!=a}}function Aa(a,b,c){return c.indexOf(a)==b}function z(a,b){if(!b.length)return a;var c=b.map(function(a){return new ia(a)});return a.map(function(a){return new ia(a)}).map(function(a){return c.map(a.resolve.bind(a))}).reduce(x,[]).map(function(a){return a.toString()})}function Ba(a,b){return{keySystem:a,licenseServerUri:"",distinctiveIdentifierRequired:!1,persistentStateRequired:!1,audioRobustness:"",videoRobustness:"",serverCertificate:null,initData:b||[],keyIds:[]}}function Ca(a,b,c,d,e){var g,f=e in d;for(g in b){var h=e+"."+g,l=f?d[e]:c[g],n=!!{".abr.manager":!0}[h]||!!{serverCertificate:!0}[g];(f||g in a)&&(void 0===b[g]?void 0===l||f?delete a[g]:a[g]=l:n?a[g]=b[g]:"object"==typeof a[g]&&"object"==typeof b[g]?Ca(a[g],b[g],l,d,h):typeof b[g]==typeof l&&(a[g]=b[g]))}}function Da(a){return JSON.parse(JSON.stringify(a))}function A(){var a,b,c=new Promise(function(c,e){a=c,b=e});return c.resolve=a,c.reject=b,c}function B(a){this.f=!1,this.a=[],this.b=[],this.c=[],this.h=a||null}function Fa(){return{maxAttempts:2,baseDelay:1e3,backoffFactor:2,fuzzFactor:.5,timeout:0}}function C(a,b){return{uris:a,method:"GET",body:null,headers:{},allowCrossSiteCredentials:!1,retryParameters:b}}function Ga(a,b,c){for(var d=0;d<a.length;++d)if(c(a[d],b))return d;return-1}function Ha(){this.a={}}function D(){this.a=new Ha}function E(a,b,c,d){a.a&&(b=new Ja(b,c,d),a.a.push(c,b))}function Ka(a,b,c,d){E(a,b,c,function(a){this.ea(b,c),d(a)}.bind(a))}function Ia(a){if(a.a){var d,b=a.a,c=[];for(d in b.a)c.push.apply(c,b.a[d]);for(b=0;b<c.length;++b)c[b].ea();a.a.a={}}}function Ja(a,b,c){this.target=a,this.type=b,this.a=c,this.target.addEventListener(b,c,!1)}function La(a){return!a||!Object.keys(a).length}function Ma(a){return Object.keys(a).map(function(b){return a[b]})}function Na(a,b){return Object.keys(a).reduce(function(c,d){return c[d]=b(a[d],d),c},{})}function Oa(a,b){return Object.keys(a).every(function(c){return b(c,a[c])})}function F(a){if(!a)return"";a=new Uint8Array(a),239==a[0]&&187==a[1]&&191==a[2]&&(a=a.subarray(3)),a=escape(Pa(a));try{return decodeURIComponent(a)}catch(b){throw new t(2,2,2004)}}function Qa(a,b){if(!a)return"";if(a.byteLength%2)throw new t(2,2,2004);var c;if(a instanceof ArrayBuffer)c=a;else{var d=new Uint8Array(a.byteLength);d.set(new Uint8Array(a)),c=d.buffer}var d=a.byteLength/2,e=new Uint16Array(d);c=new DataView(c);for(var f=0;d>f;f++)e[f]=c.getUint16(2*f,b);return Pa(e)}function Ra(a){var b=new Uint8Array(a);if(239==b[0]&&187==b[1]&&191==b[2])return F(b);if(254==b[0]&&255==b[1])return Qa(b.subarray(2),!1);if(255==b[0]&&254==b[1])return Qa(b.subarray(2),!0);var c=function(a,b){return a.byteLength<=b||32<=a[b]&&126>=a[b]}.bind(null,b);if(!b[0]&&!b[2])return Qa(a,!1);if(!b[1]&&!b[3])return Qa(a,!0);if(c(0)&&c(1)&&c(2)&&c(3))return F(a);throw new t(2,2,2003)}function Sa(a){a=unescape(encodeURIComponent(a));for(var b=new Uint8Array(a.length),c=0;c<a.length;++c)b[c]=a.charCodeAt(c);return b.buffer}function Pa(a){for(var b="",c=0;c<a.length;c+=16e3)b+=String.fromCharCode.apply(null,a.subarray(c,c+16e3));return b}function Ta(a){this.a=null,this.b=function(){this.a=null,a()}.bind(this)}function Ua(a){a.cancel(),a.a=setTimeout(a.b,100)}function Va(a,b){var c=void 0==b?!0:b,d=window.btoa(String.fromCharCode.apply(null,a)).replace(/\+/g,"-").replace(/\//g,"_");return c?d:d.replace(/=*$/,"")}function Wa(a){a=window.atob(a.replace(/-/g,"+").replace(/_/g,"/"));for(var b=new Uint8Array(a.length),c=0;c<a.length;++c)b[c]=a.charCodeAt(c);return b}function Xa(a){for(var b=new Uint8Array(a.length/2),c=0;c<a.length;c+=2)b[c/2]=window.parseInt(a.substr(c,2),16);return b}function Ya(a){for(var b="",c=0;c<a.length;++c){var d=a[c].toString(16);1==d.length&&(d="0"+d),b+=d}return b}function Za(a,b){if(!a&&!b)return!0;if(!a||!b||a.length!=b.length)return!1;for(var c=0;c<a.length;++c)if(a[c]!=b[c])return!1;return!0}function $a(a,b,c,d){this.j=this.i=this.v=null,this.F=!1,this.b=null,this.f=new D,this.a=[],this.o=[],this.l=new A,this.ha=a,this.h=null,this.g=function(a){this.l.reject(a),b(a)}.bind(this),this.M={},this.ya=c,this.ia=d,this.A=new Ta(this.yd.bind(this)),this.ga=this.c=!1,this.B=[],this.fa=!1,this.I=setInterval(this.xd.bind(this),1e3),this.l["catch"](function(){})}function cb(a,b){if(!a.i)return Ka(a.f,b,"encrypted",function(){this.g(new t(2,6,6010))}.bind(a)),Promise.resolve();a.j=b,Ka(a.f,a.j,"play",a.dd.bind(a));var c=a.j.setMediaKeys(a.i),c=c["catch"](function(a){return Promise.reject(new t(2,6,6003,a.message))}),d=null;return a.b.serverCertificate&&(d=a.i.setServerCertificate(a.b.serverCertificate).then(function(){})["catch"](function(a){return Promise.reject(new t(2,6,6004,a.message))})),Promise.all([c,d]).then(function(){return this.c?Promise.reject():(db(this),void(this.b.initData.length||this.o.length||E(this.f,this.j,"encrypted",this.Uc.bind(this))))}.bind(a))["catch"](function(a){return this.c?Promise.resolve():Promise.reject(a)}.bind(a))}function eb(a,b){return Promise.all(b.map(function(a){return fb(this,a).then(function(a){if(a){for(var b=new A,c=0;c<this.a.length;c++)if(this.a[c].Y==a){this.a[c].cb=b;break}return Promise.all([a.remove(),b])}}.bind(this))}.bind(a)))}function db(a){var b=a.b?a.b.initData:[];return b.forEach(function(a){gb(this,a.initDataType,a.initData)}.bind(a)),a.o.forEach(function(a){fb(this,a)}.bind(a)),b.length||a.o.length||a.l.resolve(),a.l}function hb(a){return a.a.map(function(a){return a.Y.sessionId})}function ab(a,b,c,d,e){var f=ib(a);b.periods.forEach(function(a){a.variants.forEach(function(a){f&&(a.drmInfos=[f]),a.drmInfos.forEach(function(b){jb(this,b);var f=d[b.keySystem];f||(f={audioCapabilities:[],videoCapabilities:[],distinctiveIdentifier:"optional",persistentState:c?"required":"optional",sessionTypes:[c?"persistent-license":"temporary"],label:b.keySystem,drmInfos:[]},d[b.keySystem]=f,e.push(b.keySystem)),f.drmInfos.push(b),b.distinctiveIdentifierRequired&&(f.distinctiveIdentifier="required"),b.persistentStateRequired&&(f.persistentState="required");var g=[];a.video&&g.push(a.video),a.audio&&g.push(a.audio),g.forEach(function(a){var c="video"==a.type?f.videoCapabilities:f.audioCapabilities,d=("video"==a.type?b.videoRobustness:b.audioRobustness)||"",e=a.mimeType;a.codecs&&(e+='; codecs="'+a.codecs+'"'),c.push({robustness:d,contentType:e})}.bind(this))}.bind(this))}.bind(this))}.bind(a))}function bb(a,b,c){if(1==c.length&&""==c[0])return Promise.reject(new t(2,6,6e3));var d=new A,e=d;return[!0,!1].forEach(function(a){c.forEach(function(c){var d=b[c];d.drmInfos.some(function(a){return!!a.licenseServerUri})==a&&(d.audioCapabilities.length||delete d.audioCapabilities,d.videoCapabilities.length||delete d.videoCapabilities,e=e["catch"](function(){return this.c?Promise.reject():navigator.requestMediaKeySystemAccess(c,[d])}.bind(this)))}.bind(this))}.bind(a)),e=e["catch"](function(){return Promise.reject(new t(2,6,6001))}),e=e.then(function(a){if(this.c)return Promise.reject();var c=0<=navigator.userAgent.indexOf("Edge/"),d=a.getConfiguration();return this.v=(d.audioCapabilities||[]).concat(d.videoCapabilities||[]).map(function(a){return a.contentType}),c&&(this.v=null),c=b[a.keySystem],kb(this,a.keySystem,c,c.drmInfos),this.b.licenseServerUri?a.createMediaKeys():Promise.reject(new t(2,6,6012))}.bind(a)).then(function(a){return this.c?Promise.reject():(this.i=a,void(this.F=!0))}.bind(a))["catch"](function(a){return this.c?Promise.resolve():(this.v=this.b=null,Promise.reject(a instanceof t?a:new t(2,6,6002,a.message)))}.bind(a)),d.reject(),e}function jb(a,b){var c=b.keySystem;if(c){if(!b.licenseServerUri){var d=a.h.servers[c];d&&(b.licenseServerUri=d)}b.keyIds||(b.keyIds=[]),(c=a.h.advanced[c])&&(b.distinctiveIdentifierRequired||(b.distinctiveIdentifierRequired=c.distinctiveIdentifierRequired),b.persistentStateRequired||(b.persistentStateRequired=c.persistentStateRequired),b.videoRobustness||(b.videoRobustness=c.videoRobustness),b.audioRobustness||(b.audioRobustness=c.audioRobustness),b.serverCertificate||(b.serverCertificate=c.serverCertificate))}}function ib(a){if(La(a.h.clearKeys))return null;var d,b=[],c=[];for(d in a.h.clearKeys){var e=a.h.clearKeys[d],f=Xa(d),e=Xa(e),f={kty:"oct",kid:Va(f,!1),k:Va(e,!1)};b.push(f),c.push(f.kid)}return a=JSON.stringify({keys:b}),c=JSON.stringify({kids:c}),c=[{initData:new Uint8Array(Sa(c)),initDataType:"keyids"}],{keySystem:"org.w3.clearkey",licenseServerUri:"data:application/json;base64,"+window.btoa(a),distinctiveIdentifierRequired:!1,persistentStateRequired:!1,audioRobustness:"",videoRobustness:"",serverCertificate:null,initData:c,keyIds:[]}}function kb(a,b,c,d){var e=[],f=[],g=[],h=[];lb(d,e,f,g,h),a.b={keySystem:b,licenseServerUri:e[0],distinctiveIdentifierRequired:"required"==c.distinctiveIdentifier,persistentStateRequired:"required"==c.persistentState,audioRobustness:c.audioCapabilities?c.audioCapabilities[0].robustness:"",videoRobustness:c.videoCapabilities?c.videoCapabilities[0].robustness:"",serverCertificate:f[0],initData:g,keyIds:h}}function lb(a,b,c,d,e){function f(a,b){return a.keyId&&a.keyId==b.keyId?!0:a.initDataType==b.initDataType&&Za(a.initData,b.initData)}a.forEach(function(a){if(-1==b.indexOf(a.licenseServerUri)&&b.push(a.licenseServerUri),a.serverCertificate&&-1==Ga(c,a.serverCertificate,Za)&&c.push(a.serverCertificate),a.initData&&a.initData.forEach(function(a){-1==Ga(d,a,f)&&d.push(a)}),a.keyIds)for(var g=0;g<a.keyIds.length;++g)-1==e.indexOf(a.keyIds[g])&&e.push(a.keyIds[g])})}function fb(a,b){var c;try{c=a.i.createSession("persistent-license")}catch(f){var d=new t(2,6,6005,f.message);return a.g(d),Promise.reject(d)}E(a.f,c,"message",a.bc.bind(a)),E(a.f,c,"keystatuseschange",a.Wb.bind(a));var e={initData:null,Y:c,loaded:!1,sb:1/0,cb:null};return a.a.push(e),c.load(b).then(function(a){if(!this.c){if(a)return e.loaded=!0,this.a.every(function(a){return a.loaded})&&this.l.resolve(),c;this.a.splice(this.a.indexOf(e),1),this.g(new t(2,6,6013))}}.bind(a),function(a){this.c||(this.a.splice(this.a.indexOf(e),1),this.g(new t(2,6,6005,a.message)))}.bind(a))}function gb(a,b,c){var d;try{d=a.ga?a.i.createSession("persistent-license"):a.i.createSession()}catch(e){return void a.g(new t(2,6,6005,e.message))}E(a.f,d,"message",a.bc.bind(a)),E(a.f,d,"keystatuseschange",a.Wb.bind(a)),a.a.push({initData:c,Y:d,loaded:!1,sb:1/0,cb:null}),d.generateRequest(b,c.buffer)["catch"](function(a){if(!this.c){for(var b=0;b<this.a.length;++b)if(this.a[b].Y==d){this.a.splice(b,1);break}this.g(new t(2,6,6006,a.message))}}.bind(a))}function mb(a,b){for(var d,c=b.target,e=0;e<a.a.length;e++)if(a.a[e].Y==c){d=a.a[e].cb;break}e=C([a.b.licenseServerUri],a.h.retryParameters),e.body=b.message,e.method="POST","com.microsoft.playready"==a.b.keySystem&&nb(e),a.ha.request(2,e).then(function(a){return this.c?Promise.reject():c.update(a.data).then(function(){d&&d.resolve()})}.bind(a),function(a){return this.c?Promise.resolve():(a=new t(2,6,6007,a),this.g(a),void(d&&d.reject(a)))}.bind(a))["catch"](function(a){return this.c?Promise.resolve():(a=new t(2,6,6008,a.message),this.g(a),void(d&&d.reject(a)))}.bind(a))}function nb(a){for(var b=Qa(a.body,!0),b=(new DOMParser).parseFromString(b,"application/xml"),c=b.getElementsByTagName("HttpHeader"),d=0;d<c.length;++d)a.headers[c[d].querySelector("name").textContent]=c[d].querySelector("value").textContent;a.body=Wa(b.querySelector("Challenge").textContent).buffer}function ob(){var a=[],b=[{contentType:'video/mp4; codecs="avc1.42E01E"'},{contentType:'video/webm; codecs="vp8"'}],c=[{videoCapabilities:b,persistentState:"required",sessionTypes:["persistent-license"]},{videoCapabilities:b}],d={};return"org.w3.clearkey com.widevine.alpha com.microsoft.playready com.apple.fps.2_0 com.apple.fps.1_0 com.apple.fps com.adobe.primetime".split(" ").forEach(function(b){
var e=navigator.requestMediaKeySystemAccess(b,c).then(function(a){var c=a.getConfiguration().sessionTypes;return d[b]={persistentState:c?0<=c.indexOf("persistent-license"):!1},a.createMediaKeys()})["catch"](function(){d[b]=null});a.push(e)}),Promise.all(a).then(function(){return d})}function pb(a,b){var c=a.keySystem();return!b.drmInfos.length||b.drmInfos.some(function(a){return a.keySystem==c})}function qb(a,b){if(!a.length)return b;if(!b.length)return a;for(var c=[],d=0;d<a.length;d++)for(var e=0;e<b.length;e++)if(a[d].keySystem==b[e].keySystem){var f=a[d],e=b[e],g=[],g=g.concat(f.initData||[]),g=g.concat(e.initData||[]),h=[],h=h.concat(f.keyIds),h=h.concat(e.keyIds);c.push({keySystem:f.keySystem,licenseServerUri:f.licenseServerUri||e.licenseServerUri,distinctiveIdentifierRequired:f.distinctiveIdentifierRequired||e.distinctiveIdentifierRequired,persistentStateRequired:f.persistentStateRequired||e.persistentStateRequired,videoRobustness:f.videoRobustness||e.videoRobustness,audioRobustness:f.audioRobustness||e.audioRobustness,serverCertificate:f.serverCertificate||e.serverCertificate,initData:g,keyIds:h});break}return c}function rb(a){this.f=null,this.c=a,this.h=0,this.g=1/0,this.a=this.b=null}function tb(a,b){sb[a]=b.length?ub.bind(null,b):b}function vb(a,b,c){return a>=b?null:new VTTCue(a,b,c)}function xb(a,b,c,d){return Promise.resolve().then(function(){if(this.c)if(null==c||null==d)this.f.parseInit(b);else{for(var a=this.f.parseMedia(b,{periodStart:this.h,segmentStart:c,segmentEnd:d}),f=0;f<a.length&&!(a[f].startTime>=this.g);++f)this.c.addCue(a[f]);null==this.b&&(this.b=c),this.a=Math.min(d,this.g)}}.bind(a))}function wb(a,b){for(var c=a.c.cues,d=[],e=0;e<c.length;++e)b(c[e])&&d.push(c[e]);for(e=0;e<d.length;++e)a.c.removeCue(d[e])}function ub(a){this.Ja=a}function yb(a){return!a||1==a.length&&1e-6>a.end(0)-a.start(0)?null:a.length?a.end(a.length-1):null}function zb(a,b){return!a||!a.length||1==a.length&&1e-6>a.end(0)-a.start(0)?!1:b>=a.start(0)&&b<=a.end(a.length-1)}function Ab(a,b){if(!a||!a.length||1==a.length&&1e-6>a.end(0)-a.start(0))return 0;for(var c=0,d=a.length-1;d>=0&&a.end(d)>b;--d)c+=a.end(d)-Math.max(a.start(d),b);return c}function Bb(a,b,c){this.f=a,this.K=b,this.i=c,this.c={},this.a=null,this.b={},this.g=new D,this.h=!1}function Cb(){var a={};return'video/mp4; codecs="avc1.42E01E",video/mp4; codecs="avc3.42E01E",video/mp4; codecs="hvc1.1.6.L93.90",audio/mp4; codecs="mp4a.40.2",audio/mp4; codecs="ac-3",audio/mp4; codecs="ec-3",video/webm; codecs="vp8",video/webm; codecs="vp9",video/webm; codecs="av1",audio/webm; codecs="vorbis",audio/webm; codecs="opus",video/mp2t; codecs="avc1.42E01E",video/mp2t; codecs="avc3.42E01E",video/mp2t; codecs="hvc1.1.6.L93.90",video/mp2t; codecs="mp4a.40.2",video/mp2t; codecs="ac-3",video/mp2t; codecs="ec-3",video/mp2t; codecs="mp4a.40.2",text/vtt,application/mp4; codecs="wvtt",application/ttml+xml,application/mp4; codecs="stpp"'.split(",").forEach(function(b){a[b]=!!sb[b]||MediaSource.isTypeSupported(b);var c=b.split(";")[0];a[c]=a[c]||a[b]}),a}function Db(a,b){a.a||(a.a=new rb(a.i)),a.a.f=new sb[b]}function Eb(a,b){var c;return"text"==b?c=a.a.b:(c=Fb(a,b),c=!c||1==c.length&&1e-6>c.end(0)-c.start(0)?null:1==c.length&&0>c.start(0)?0:c.length?c.start(0):null),c}function Fb(a,b){try{return a.c[b].buffered}catch(c){return null}}function Gb(a,b,c,d,e){return"text"==b?xb(a.a,c,d,e):Hb(a,b,a.Xd.bind(a,b,c))}function Ib(a,b){return"text"==b?a.a.remove(0,1/0):Hb(a,b,a.fc.bind(a,b,0,a.K.duration))}function Kb(a,b,c,d){return"text"==b?(a.a.h=c,null!=d&&(a.a.g=d),Promise.resolve()):(null==d&&(d=1/0),Promise.all([Hb(a,b,a.tc.bind(a,b)),Hb(a,b,a.Nd.bind(a,b,c)),Hb(a,b,a.Ld.bind(a,b,d))]))}function Hb(a,b,c){if(a.h)return Promise.reject();if(c={start:c,p:new A},a.b[b].push(c),1==a.b[b].length)try{c.start()}catch(d){c.p.reject("QuotaExceededError"==d.name?new t(2,3,3017,b):new t(2,3,3015,d)),Mb(a,b)}return c.p}function Lb(a,b){if(a.h)return Promise.reject();var d,c=[];for(d in a.c){var e=new A,f={start:function(a){a.resolve()}.bind(null,e),p:e};a.b[d].push(f),c.push(e),1==a.b[d].length&&f.start()}return Promise.all(c).then(function(){var a,c;try{b()}catch(l){c=Promise.reject(new t(2,3,3015,l))}for(a in this.c)Mb(this,a);return c}.bind(a),function(){return Promise.reject()}.bind(a))}function Mb(a,b){a.b[b].shift();var c=a.b[b][0];if(c)try{c.start()}catch(d){c.p.reject(new t(2,3,3015,d)),Mb(a,b)}}function Nb(a,b,c){return c==b||a>=Ob&&c==b.split("-")[0]||a>=Pb&&c.split("-")[0]==b.split("-")[0]?!0:!1}function Qb(a){a=a.toLowerCase().split("-");var b=Rb[a[0]];return b&&(a[0]=b),a.join("-")}function Sb(a,b,c){var d=a.video;return d&&(d.width<b.minWidth||d.width>b.maxWidth||d.width>c.width||d.height<b.minHeight||d.height>b.maxHeight||d.height>c.height||d.width*d.height<b.minPixels||d.width*d.height>b.maxPixels)||a.bandwidth<b.minBandwidth||a.bandwidth>b.maxBandwidth?!1:!0}function Tb(a,b,c){var d=!1;return a.variants.forEach(function(a){var e=a.allowedByApplication;a.allowedByApplication=Sb(a,b,c),e!=a.allowedByApplication&&(d=!0)}),d}function Ub(a,b,c){var d=b.video,e=b.audio;for(b=0;b<c.variants.length;++b){var f=c.variants[b],g=a,h=e,l=d;(g&&g.F&&!pb(g,f)?0:Vb(f.audio,g,h)&&Vb(f.video,g,l))||(c.variants.splice(b,1),--b)}for(b=0;b<c.textStreams.length;++b)a=c.textStreams[b],sb[Wb(a.mimeType,a.codecs)]||(c.textStreams.splice(b,1),--b)}function Vb(a,b,c){if(!a)return!0;var d=null;return b&&b.F&&(d=b.v),b=Wb(a.mimeType,a.codecs),!sb[b]&&!MediaSource.isTypeSupported(b)||d&&a.encrypted&&0>d.indexOf(b)||c&&(a.mimeType!=c.mimeType||a.codecs.split(".")[0]!=c.codecs.split(".")[0])?!1:!0}function Xb(a,b,c){return Yb(a.variants).map(function(a){var d;d=a.video&&a.audio?c==a.video.id&&b==a.audio.id:a.video&&c==a.video.id||a.audio&&b==a.audio.id;var f="";a.video&&(f+=a.video.codecs),a.audio&&(""!=f&&(f+=", "),f+=a.audio.codecs);var g=a.audio?a.audio.codecs:null,h=a.video?a.video.codecs:null,l=null;a.video?l=a.video.mimeType:a.audio&&(l=a.audio.mimeType);var n=null;return a.audio?n=a.audio.kind:a.video&&(n=a.video.kind),{id:a.id,active:d,type:"variant",bandwidth:a.bandwidth,language:a.language,kind:n||null,width:a.video?a.video.width:null,height:a.video?a.video.height:null,frameRate:a.video?a.video.frameRate:void 0,mimeType:l,codecs:f,audioCodec:g,videoCodec:h,primary:a.primary}})}function Zb(a,b){return a.textStreams.map(function(a){return{id:a.id,active:b==a.id,type:"text",language:a.language,kind:a.kind,mimeType:a.mimeType,codecs:a.codecs||null,audioCodec:null,videoCodec:null,primary:a.primary}})}function $b(a,b){for(var c=0;c<a.variants.length;c++)if(a.variants[c].id==b.id)return a.variants[c];return null}function ac(a,b){for(var c=0;c<a.textStreams.length;c++)if(a.textStreams[c].id==b.id)return a.textStreams[c];return null}function Yb(a){return a.filter(function(a){return a.allowedByApplication&&a.allowedByKeySystem})}function bc(a,b,c){var d=Yb(a.variants),e=d.filter(function(a){return a.language==d[0].language});if(a=d.filter(function(a){return a.primary}),a.length&&(e=a),b){var f=Qb(b);[Pb,Ob,0].forEach(function(a){var b=!1;d.forEach(function(d){f=Qb(f);var g=Qb(d.language);Nb(a,f,g)&&(b?e.push(d):(e=[d],b=!0),c&&(c.audio=!0))})})}return e}function cc(a,b,c){var d=a.textStreams,e=d;if(a=d.filter(function(a){return a.primary}),a.length&&(e=a),b){var f=Qb(b);[Pb,Ob,0].forEach(function(a){var b=!1;d.forEach(function(d){var g=Qb(d.language);Nb(a,f,g)&&(b?e.push(d):(e=[d],b=!0),c&&(c.text=!0))})})}return e}function dc(a,b,c){for(var d=0;d<c.length;d++)if(c[d].audio==a&&c[d].video==b)return c[d];return null}function ec(a,b,c){function d(a,b){return null==a?null==b:b.id==a}for(var e=0;e<c.length;e++)if(d(a,c[e].audio)&&d(b,c[e].video))return c[e];return null}function Wb(a,b){var c=a;return b&&(c+='; codecs="'+b+'"'),c}function fc(a,b){for(var c=a.periods.length-1;c>0;--c)if(b>=a.periods[c].startTime)return c;return 0}function gc(a,b){for(var c=0;c<a.periods.length;++c){var d=a.periods[c];if("text"==b.type){for(var e=0;e<d.textStreams.length;++e)if(d.textStreams[e]==b)return c}else for(e=0;e<d.variants.length;++e){var f=d.variants[e];if(f.audio==b||f.video==b||f.video&&f.video.trickModeVideo==b)return c}}return-1}function G(){this.f=null,this.b=!1,this.a=new fa,this.h=[],this.g=[],this.j=!1,this.c=null,this.i={minWidth:0,maxWidth:1/0,minHeight:0,maxHeight:1/0,minPixels:0,maxPixels:1/0,minBandwidth:0,maxBandwidth:1/0}}function hc(a,b){return b.filter(function(b){return Sb(b,a,{width:1/0,height:1/0})}).sort(function(a,b){return a.bandwidth-b.bandwidth})}function H(a,b){var d,c=b||{};for(d in c)this[d]=c[d];this.defaultPrevented=this.cancelable=this.bubbles=!1,this.timeStamp=window.performance&&window.performance.now?window.performance.now():Date.now(),this.type=a,this.isTrusted=!1,this.target=this.currentTarget=null,this.a=!1}function sc(a){return JSON.stringify(a,function(a,c){if("manager"!=a&&"function"!=typeof c){if(c instanceof Event||c instanceof H){var e,b={};for(e in c){var f=c[e];f&&"object"==typeof f||e in Event||(b[e]=f)}return b}if(c instanceof TimeRanges)for(b={__type__:"TimeRanges",length:c.length,start:[],end:[]},e=0;e<c.length;++e)b.start.push(c.start(e)),b.end.push(c.end(e));else b="number"==typeof c?isNaN(c)?"NaN":isFinite(c)?c:0>c?"-Infinity":"Infinity":c;return b}})}function tc(a){return JSON.parse(a,function(a,c){return"NaN"==c?0/0:"-Infinity"==c?-(1/0):"Infinity"==c?1/0:c&&"object"==typeof c&&"TimeRanges"==c.__type__?uc(c):c})}function uc(a){return{length:a.length,start:function(b){return a.start[b]},end:function(b){return a.end[b]}}}function vc(a,b,c,d,e){this.I=a,this.l=b,this.B=c,this.F=d,this.v=e,this.c=this.j=this.h=!1,this.A="",this.a=this.i=null,this.b={video:{},player:{}},this.o=0,this.f={},this.g=null}function wc(a){for(var b in a.f){var c=a.f[b];delete a.f[b],c.reject(new t(1,7,7e3))}}function xc(a,b){var c=sc(b);a.a.sendMessage("urn:x-cast:com.google.shaka.v2",c,function(){},ga)}function p(){this.gb=new Ha,this.Oa=this}function I(a,b,c){p.call(this),this.c=a,this.b=b,this.h=this.f=this.g=this.i=this.j=null,this.a=new vc(c,this.Td.bind(this),this.Ud.bind(this),this.Vd.bind(this),this.Mb.bind(this)),yc(this)}function yc(a){a.a.init(),a.h=new D,ic.forEach(function(a){E(this.h,this.c,a,this.he.bind(this))}.bind(a)),mc.forEach(function(a){E(this.h,this.b,a,this.wd.bind(this))}.bind(a)),a.j={};for(var b in a.c)Object.defineProperty(a.j,b,{configurable:!1,enumerable:!0,get:a.ge.bind(a,b),set:a.ie.bind(a,b)});a.i={};for(b in a.b)Object.defineProperty(a.i,b,{configurable:!1,enumerable:!0,get:a.vd.bind(a,b)});a.g=new p,a.g.Oa=a.j,a.f=new p,a.f.Oa=a.i}function J(a,b,c,d){p.call(this),this.a=a,this.b=b,this.j={video:a,player:b},this.l=c||function(){},this.o=d||function(a){return a},this.i=!1,this.f=!0,this.h=this.g=this.c=null,zc(this)}function zc(a){var b=cast.receiver.CastReceiverManager.getInstance();b.onSenderConnected=a.ac.bind(a),b.onSenderDisconnected=a.ac.bind(a),b.onSystemVolumeChanged=a.Bc.bind(a),a.g=b.getCastMessageBus("urn:x-cast:com.google.cast.media"),a.g.onMessage=a.Wc.bind(a),a.c=b.getCastMessageBus("urn:x-cast:com.google.shaka.v2"),a.c.onMessage=a.jd.bind(a),b.start(),ic.forEach(function(a){this.a.addEventListener(a,this.dc.bind(this,"video"))}.bind(a)),mc.forEach(function(a){this.b.addEventListener(a,this.dc.bind(this,"player"))}.bind(a)),cast.__platform__&&cast.__platform__.canDisplayType('video/mp4; codecs="avc1.640028"; width=3840; height=2160')?a.b.Ab(3840,2160):a.b.Ab(1920,1080),a.b.addEventListener("loading",function(){this.f=!1,Ac(this)}.bind(a)),a.a.addEventListener("playing",function(){this.f=!1,Ac(this)}.bind(a)),a.a.addEventListener("pause",function(){Ac(this)}.bind(a)),a.b.addEventListener("unloading",function(){this.f=!0,Ac(this)}.bind(a)),a.a.addEventListener("ended",function(){window.setTimeout(function(){this.a&&this.a.ended&&(this.f=!0,Ac(this))}.bind(this),5e3)}.bind(a))}function Ac(a){Promise.resolve().then(function(){this.dispatchEvent(new H("caststatuschanged")),Bc(this,0)}.bind(a))}function Cc(a,b,c){for(var d in b.player)a.b[d](b.player[d]);a.l(c),c=Promise.resolve();var e=a.a.autoplay;b.manifest&&(a.a.autoplay=!1,c=a.b.load(b.manifest,b.startTime),c["catch"](function(a){this.b.dispatchEvent(new H("error",{detail:a}))}.bind(a))),c.then(function(){for(var a in b.video){var c=b.video[a];this.a[a]=c}for(a in b.playerAfterLoad)c=b.playerAfterLoad[a],this.b[a](c);this.a.autoplay=e,b.manifest&&(this.a.play(),Bc(this,0))}.bind(a))}function Dc(a,b,c,d){a.i&&(a=sc(b),d?c.getCastChannel(d).send(a):c.broadcast(a))}function Bc(a,b,c){var d=Ec,d={mediaSessionId:0,playbackRate:a.a.playbackRate,playerState:a.f?d.IDLE:a.b.ha?d.pc:a.a.paused?d.qc:d.rc,currentTime:a.a.currentTime,supportedMediaCommands:15,volume:{level:a.a.volume,muted:a.a.muted}};c&&(d.media=c),Dc(a,{requestId:b,type:"MEDIA_STATUS",status:[d]},a.g)}function Fc(a,b){var c=L(a,b);return 1!=c.length?null:c[0]}function L(a,b){return Array.prototype.filter.call(a.childNodes,function(a){return a.tagName==b})}function Gc(a){var b=a.firstChild;return b&&b.nodeType==Node.TEXT_NODE?a.textContent.trim():null}function M(a,b,c,d){var e=null;return a=a.getAttribute(b),null!=a&&(e=c(a)),null==e?void 0!=d?d:null:e}function Hc(a){return a?(a=Date.parse(a),isNaN(a)?null:Math.floor(a/1e3)):null}function Ic(a){return a&&(a=/^P(?:([0-9]*)Y)?(?:([0-9]*)M)?(?:([0-9]*)D)?(?:T(?:([0-9]*)H)?(?:([0-9]*)M)?(?:([0-9.]*)S)?)?$/.exec(a))?(a=31536e3*Number(a[1]||null)+2592e3*Number(a[2]||null)+86400*Number(a[3]||null)+3600*Number(a[4]||null)+60*Number(a[5]||null)+Number(a[6]||null),isFinite(a)?a:null):null}function Jc(a){var b=/([0-9]+)-([0-9]+)/.exec(a);return b?(a=Number(b[1]),isFinite(a)?(b=Number(b[2]),isFinite(b)?{start:a,end:b}:null):null):null}function Kc(a){return a=Number(a),a%1?null:a}function Lc(a){return a=Number(a),!(a%1)&&a>0?a:null}function Mc(a){return a=Number(a),!(a%1)&&a>=0?a:null}function Nc(a){var b;return a=Number((b=a.match(/^(\d+)\/(\d+)$/))?b[1]/b[2]:a),isNaN(a)?null:a}function Pc(a,b,c){a=Qc(a);var d=null,e=null,f=[],g=[],h=a.map(function(a){return a.keyId}).filter(ya);if(0<h.length&&(e=h[0],h.some(za(e))))throw new t(2,4,4010);return c||(g=a.filter(function(a){return"urn:mpeg:dash:mp4protection:2011"==a.hc?(d=a.init||d,!1):!0}),0<g.length&&(f=Rc(d,b,g),f.length||(f=[Ba("",d)]))),0<a.length&&(c||!g.length)&&(f=Ma(Oc).map(function(a){return Ba(a,d)})),e&&f.forEach(function(a){a.initData.forEach(function(a){a.keyId=e})}),{Jb:e,le:d,drmInfos:f,Lb:!0}}function Sc(a,b,c,d){var e=Pc(a,b,d);if(c.Lb)a=1==c.drmInfos.length&&!c.drmInfos[0].keySystem,b=!e.drmInfos.length,(!c.drmInfos.length||a&&!b)&&(c.drmInfos=e.drmInfos),c.Lb=!1;else if(0<e.drmInfos.length&&(c.drmInfos=c.drmInfos.filter(function(a){return e.drmInfos.some(function(b){return b.keySystem==a.keySystem})}),!c.drmInfos.length))throw new t(2,4,4008);return e.Jb||c.Jb}function Rc(a,b,c){return c.map(function(c){var d=Oc[c.hc];return d?[Ba(d,c.init||a)]:b(c.node)||[]}).reduce(x,[])}function Qc(a){return a.map(function(a){var b=a.getAttribute("schemeIdUri"),d=a.getAttribute("cenc:default_KID"),e=L(a,"cenc:pssh").map(Gc);if(!b)return null;if(b=b.toLowerCase(),d&&(d=d.replace(/-/g,"").toLowerCase(),0<=d.indexOf(" ")))throw new t(2,4,4009);var f=[];try{f=e.map(function(a){return{initDataType:"cenc",initData:Wa(a),keyId:null}})}catch(g){throw new t(2,4,4007)}return{node:a,hc:b,keyId:d,init:0<f.length?f:null}}).filter(ya)}function Tc(a,b,c,d,e){null!=e&&(e=Math.round(e));var f={RepresentationID:b,Number:c,Bandwidth:d,Time:e};return a.replace(/\$(RepresentationID|Number|Bandwidth|Time)?(?:%0([0-9]+)d)?\$/g,function(a,b,c){if("$$"==a)return"$";var d=f[b];return null==d?a:("RepresentationID"==b&&c&&(c=void 0),a=d.toString(),c=window.parseInt(c,10)||1,Array(Math.max(0,c-a.length)+1).join("0")+a)})}function Uc(a,b){var c=Vc(a,b,"timescale"),d=1;c&&(d=Lc(c)||1),c=Vc(a,b,"duration"),(c=Lc(c||""))&&(c/=d);var e=Vc(a,b,"startNumber"),f=Vc(a,b,"presentationTimeOffset"),g=Mc(e||"");(null==e||null==g)&&(g=1);var h=Wc(a,b,"SegmentTimeline"),e=null;if(h){for(var e=d,l=Number(f),n=a.N.duration||1/0,h=L(h,"S"),q=[],r=0,v=0;v<h.length;++v){var u=h[v],w=M(u,"t",Mc),K=M(u,"d",Mc),u=M(u,"r",Kc);if(null!=w&&(w-=l),!K)break;if(w=null!=w?w:r,u=u||0,0>u)if(v+1<h.length){if(u=M(h[v+1],"t",Mc),null==u)break;if(w>=u)break;u=Math.ceil((u-w)/K)-1}else{if(1/0==n)break;if(w/e>=n)break;u=Math.ceil((n*e-w)/K)-1}0<q.length&&w!=r&&(q[q.length-1].end=w/e);for(var pa=0;u>=pa;++pa)r=w+K,q.push({start:w/e,end:r/e,ee:w}),w=r}e=q}return{timescale:d,L:c,va:g,presentationTimeOffset:Number(f)/d||0,Gb:Number(f),D:e}}function Vc(a,b,c){return[b(a.w),b(a.P),b(a.R)].filter(ya).map(function(a){return a.getAttribute(c)}).reduce(function(a,b){return a||b})}function Wc(a,b,c){return[b(a.w),b(a.P),b(a.R)].filter(ya).map(function(a){return Fc(a,c)}).reduce(function(a,b){return a||b})}function Xc(a,b,c){this.a=a,this.V=b,this.J=c}function N(a,b,c,d,e,f){this.position=a,this.startTime=b,this.endTime=c,this.a=d,this.V=e,this.J=f}function Yc(a){this.H=a,this.a=0==Zc,this.u=0}function $c(a){return a.u<a.H.byteLength}function ad(a){try{var b=a.H.getUint8(a.u)}catch(c){bd()}return a.u+=1,b}function cd(a){try{var b=a.H.getUint16(a.u,a.a)}catch(c){bd()}return a.u+=2,b}function O(a){try{var b=a.H.getUint32(a.u,a.a)}catch(c){bd()}return a.u+=4,b}function dd(a){var b,c;try{a.a?(b=a.H.getUint32(a.u,!0),c=a.H.getUint32(a.u+4,!0)):(c=a.H.getUint32(a.u,!1),b=a.H.getUint32(a.u+4,!1))}catch(d){bd()}if(c>2097151)throw new t(2,3,3001);return a.u+=8,c*Math.pow(2,32)+b}function ed(a,b){a.u+b>a.H.byteLength&&bd();var c=a.H.buffer.slice(a.u,a.u+b);return a.u+=b,new Uint8Array(c)}function P(a,b){a.u+b>a.H.byteLength&&bd(),a.u+=b}function fd(a){for(var b=a.u;$c(a)&&a.H.getUint8(a.u);)a.u+=1;return b=a.H.buffer.slice(b,a.u),a.u+=1,F(b)}function bd(){throw new t(2,3,3e3)}function Q(){this.b=[],this.a=[]}function R(a){for(;$c(a.s);)a.Ja.Za(a.start,a.s)}function hd(a){for(var b=O(a.s);b>0;--b)a.Ja.Za(a.start,a.s)}function id(a){return function(b){a(ed(b.s,b.s.H.byteLength-b.s.u))}}function gd(a){for(var b=0,c=0;c<a.length;c++)b=b<<8|a.charCodeAt(c);return b}function jd(a,b,c,d){var e,f=(new Q).$("sidx",function(a){e=kd(b,d,c,a)});if(a&&f.parse(a),e)return e;throw new t(2,3,3004)}function kd(a,b,c,d){var e=[];P(d.s,4);var f=O(d.s);if(!f)throw new t(2,3,3005);var g,h;d.version?(g=dd(d.s),h=dd(d.s)):(g=O(d.s),h=O(d.s)),P(d.s,2);var l=cd(d.s);for(b=g-b,a=a+d.size+h,h=0;l>h;h++){var n=O(d.s);g=(2147483648&n)>>>31;var n=2147483647&n,q=O(d.s);if(P(d.s,4),1==g)throw new t(2,3,3006);e.push(new N(e.length,b/f,(b+q)/f,function(){return c},a,a+n-1)),b+=q,a+=n}return e}function S(a){this.a=a}function ld(a,b){if(a.a.length){var c=a.a[a.a.length-1];c.startTime>b||(a.a[a.a.length-1]=new N(c.position,c.startTime,b,c.a,c.V,c.J))}}function md(a){this.b=a,this.a=new Yc(a),nd||(nd=[new Uint8Array([255]),new Uint8Array([127,255]),new Uint8Array([63,255,255]),new Uint8Array([31,255,255,255]),new Uint8Array([15,255,255,255,255]),new Uint8Array([7,255,255,255,255,255]),new Uint8Array([3,255,255,255,255,255,255]),new Uint8Array([1,255,255,255,255,255,255,255])])}function od(a){var b;if(b=pd(a),7<b.length)throw new t(2,3,3002);for(var c=0,d=0;d<b.length;d++)c=256*c+b[d];b=c,c=pd(a);a:{for(d=0;d<nd.length;d++)if(Za(c,nd[d])){d=!0;break a}d=!1}if(d)c=a.b.byteLength-a.a.u;else{if(8==c.length&&224&c[1])throw new t(2,3,3001);for(var d=c[0]&(1<<8-c.length)-1,e=1;e<c.length;e++)d=256*d+c[e];c=d}return c=a.a.u+c<=a.b.byteLength?c:a.b.byteLength-a.a.u,d=new DataView(a.b.buffer,a.b.byteOffset+a.a.u,c),P(a.a,c),new qd(b,d)}function pd(a){var c,b=ad(a.a);for(c=1;8>=c&&!(b&1<<8-c);c++);if(c>8)throw new t(2,3,3002);var d=new Uint8Array(c);for(d[0]=b,b=1;c>b;b++)d[b]=ad(a.a);return d}function qd(a,b){this.id=a,this.a=b}function rd(a){if(8<a.a.byteLength)throw new t(2,3,3002);if(8==a.a.byteLength&&224&a.a.getUint8(0))throw new t(2,3,3001);for(var b=0,c=0;c<a.a.byteLength;c++)var d=a.a.getUint8(c),b=256*b+d;return b}function sd(){}function td(a,b,c,d,e,f){function g(){return e}var h=[];a=new md(a.a);for(var l=-1,n=-1;$c(a.a);){var q=od(a);if(187==q.id){var r=ud(q);r&&(q=c*(r.fe-f),r=b+r.Bd,l>=0&&h.push(new N(h.length,l,q,g,n,r-1)),l=q,n=r)}}return l>=0&&h.push(new N(h.length,l,d,g,n,null)),h}function ud(a){var b=new md(a.a);if(a=od(b),179!=a.id)throw new t(2,3,3013);if(a=rd(a),b=od(b),183!=b.id)throw new t(2,3,3012);for(var b=new md(b.a),c=0;$c(b.a);){var d=od(b);if(241==d.id){c=rd(d);break}}return{fe:a,Bd:c}}function vd(a,b){var c=Wc(a,b,"Initialization");if(!c)return null;var d=a.w.S,e=c.getAttribute("sourceURL");e&&(d=z(a.w.S,[e]));var e=0,f=null;return(c=M(c,"range",Jc))&&(e=c.start,f=c.end),new Xc(function(){return d},e,f)}function wd(a,b){var e,c=Vc(a,xd,"presentationTimeOffset"),d=vd(a,xd);e=Number(c);var f=a.w.contentType,g=a.w.mimeType.split("/")[1];if("text"!=f&&"mp4"!=g&&"webm"!=g)throw new t(2,4,4006);if("webm"==g&&!d)throw new t(2,4,4005);var f=Wc(a,xd,"RepresentationIndex"),h=Vc(a,xd,"indexRange"),l=a.w.S,h=Jc(h||"");if(f){var n=f.getAttribute("sourceURL");n&&(l=z(a.w.S,[n])),h=M(f,"range",Jc,h)}if(!h)throw new t(2,4,4002);return e=yd(a,b,d,l,h.start,h.end,g,e),{createSegmentIndex:e.createSegmentIndex,findSegmentPosition:e.findSegmentPosition,getSegmentReference:e.getSegmentReference,initSegmentReference:d,presentationTimeOffset:Number(c)||0}}function yd(a,b,c,d,e,f,g,h){var l=a.presentationTimeline,n=!a.za||!a.N.nb,q=a.N.duration,r=b,v=null;return{createSegmentIndex:function(){var a=[r(d,e,f),"webm"==g?r(c.a(),c.V,c.J):null];return r=null,Promise.all(a).then(function(a){var b=a[0];a=a[1]||null,b="mp4"==g?jd(b,e,d,h):(new sd).parse(b,a,d,h),l.Da(0,b),v=new S(b),n&&ld(v,q)})},findSegmentPosition:function(a){return v.find(a)},getSegmentReference:function(a){return v.get(a)}}}function xd(a){return a.La}function zd(a,b){var d,c=vd(a,Ad);d=Bd(a);var e=Uc(a,Ad),f=e.va;f||(f=1);var g=0;if(e.L?g=e.L*(f-1):e.D&&0<e.D.length&&(g=e.D[0].start),d={L:e.L,startTime:g,va:f,presentationTimeOffset:e.presentationTimeOffset,D:e.D,Ca:d},!d.L&&!d.D&&1<d.Ca.length)throw new t(2,4,4002);if(!d.L&&!a.N.duration&&!d.D&&1==d.Ca.length)throw new t(2,4,4002);if(d.D&&!d.D.length)throw new t(2,4,4002);return f=e=null,a.R.id&&a.w.id&&(f=a.R.id+","+a.w.id,e=b[f]),g=Cd(a.N.duration,d.va,a.w.S,d),e?(e.qb(g),e.jb(a.presentationTimeline.ja()-a.N.start)):(a.presentationTimeline.Da(0,g),e=new S(g),f&&a.za&&(b[f]=e)),a.za&&a.N.nb||ld(e,a.N.duration),{createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:e.find.bind(e),getSegmentReference:e.get.bind(e),initSegmentReference:c,presentationTimeOffset:d.presentationTimeOffset}}function Ad(a){return a.la}function Cd(a,b,c,d){var e=d.Ca.length;d.D&&d.D.length!=d.Ca.length&&(e=Math.min(d.D.length,d.Ca.length));for(var f=[],g=d.startTime,h=0;e>h;h++){var q,l=d.Ca[h],n=z(c,[l.Rc]);q=null!=d.L?g+d.L:d.D?d.D[h].end:g+a,f.push(new N(h+b,g,q,function(a){return a}.bind(null,n),l.start,l.end)),g=q}return f}function Bd(a){return[a.w.la,a.P.la,a.R.la].filter(ya).map(function(a){return L(a,"SegmentURL")}).reduce(function(a,c){return 0<a.length?a:c}).map(function(b){b.getAttribute("indexRange")&&!a.Rb&&(a.Rb=!0);var c=b.getAttribute("media");return b=M(b,"mediaRange",Jc,{start:0,end:null}),{Rc:c,start:b.start,end:b.end}})}function Dd(a,b,c,d){var f,e=Ed(a);f=Uc(a,Fd);var g=Vc(a,Fd,"media"),h=Vc(a,Fd,"index");if(f={L:f.L,timescale:f.timescale,va:f.va,presentationTimeOffset:f.presentationTimeOffset,Gb:f.Gb,D:f.D,pb:g,Ha:h},g=0+(f.Ha?1:0),g+=f.D?1:0,g+=f.L?1:0,!g)throw new t(2,4,4002);if(1!=g&&(f.Ha&&(f.D=null),f.L=null),!f.Ha&&!f.pb)throw new t(2,4,4002);if(f.Ha){if(c=a.w.mimeType.split("/")[1],"mp4"!=c&&"webm"!=c)throw new t(2,4,4006);if("webm"==c&&!e)throw new t(2,4,4005);d=Tc(f.Ha,a.w.id,null,a.bandwidth||null,null),d=z(a.w.S,[d]),a=yd(a,b,e,d,0,null,c,f.presentationTimeOffset)}else f.L?(d||a.presentationTimeline.rb(f.L),a=Gd(a,f)):(d=b=null,a.R.id&&a.w.id&&(d=a.R.id+","+a.w.id,b=c[d]),g=Hd(a,f),b?(b.qb(g),b.jb(a.presentationTimeline.ja()-a.N.start)):(a.presentationTimeline.Da(0,g),b=new S(g),d&&a.za&&(c[d]=b)),a.za&&a.N.nb||ld(b,a.N.duration),a={createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:b.find.bind(b),getSegmentReference:b.get.bind(b)});return{createSegmentIndex:a.createSegmentIndex,findSegmentPosition:a.findSegmentPosition,getSegmentReference:a.getSegmentReference,initSegmentReference:e,presentationTimeOffset:f.presentationTimeOffset}}function Fd(a){return a.Ma}function Gd(a,b){var c=a.N.duration,d=b.L,e=b.va,f=b.timescale,g=b.pb,h=a.bandwidth||null,l=a.w.id,n=a.w.S;return{createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(a){return 0>a||c&&a>=c?null:Math.floor(a/d)},getSegmentReference:function(a){var b=a*d;return 0>b||c&&b>=c?null:new N(a,b,b+d,function(){var c=Tc(g,l,a+e,h,b*f);return z(n,[c])},0,null)}}}function Hd(a,b){for(var c=[],d=0;d<b.D.length;d++){var e=d+b.va;c.push(new N(e,b.D[d].start,b.D[d].end,function(a,b,c,d,e,q){return a=Tc(a,b,e,c,q),z(d,[a]).map(function(a){return a.toString()})}.bind(null,b.pb,a.w.id,a.bandwidth||null,a.w.S,e,b.D[d].ee+b.Gb),0,null))}return c}function Ed(a){var b=Vc(a,Fd,"initialization");if(!b)return null;var c=a.w.id,d=a.bandwidth||null,e=a.w.S;return new Xc(function(){var a=Tc(b,c,null,d,null);return z(e,[a])},0,null)}function Kd(){var b,a={};for(b in Id)a[b]=!0;for(b in Jd)a[b]=!0;return["application/dash+xml","application/x-mpegurl","application/vnd.apple.mpegurl","application/vnd.ms-sstr+xml"].forEach(function(b){a[b]=!!Id[b]}),["mpd","m3u8","ism"].forEach(function(b){a[b]=!!Jd[b]}),a}function Ld(a,b,c,d){var e=d;return e||(d=new ia(a).U.split("/").pop().split("."),1<d.length&&(d=d.pop().toLowerCase(),e=Jd[d])),e?Promise.resolve(e):(c=C([a],c),c.method="HEAD",b.request(0,c).then(function(b){return(b=b.headers["content-type"])&&(b=b.toLowerCase()),(e=Id[b])?e:Promise.reject(new t(2,4,4e3,a))},function(a){return a.severity=2,Promise.reject(a)}))}function T(a,b){this.f=a,this.i=b,this.c=this.a=1/0,this.b=1,this.h=0,this.g=!0}function Md(){this.a=this.b=null,this.g=[],this.c=null,this.i=[],this.h=1,this.j={},this.l=0,this.f=null}function Nd(a){return a.a.networkingEngine.request(0,C(a.g,a.b.retryParameters)).then(function(a){return this.a?Pd(this,a.data,a.uri):void 0}.bind(a))}function Pd(a,b,c){var d=F(b),e=new DOMParser,f=null;b=null;try{f=e.parseFromString(d,"text/xml")}catch(v){}if(f&&"MPD"==f.documentElement.tagName&&(b=f.documentElement),b&&0<b.getElementsByTagName("parsererror").length&&(b=null),!b)throw new t(2,4,4001);c=[c],d=L(b,"Location").map(Gc).filter(ya),0<d.length&&(c=a.g=d),d=L(b,"BaseURL").map(Gc),c=z(c,d);var g=M(b,"minBufferTime",Ic);a.l=M(b,"minimumUpdatePeriod",Ic,-1);var n,h=M(b,"availabilityStartTime",Hc),d=M(b,"timeShiftBufferDepth",Ic),l=M(b,"suggestedPresentationDelay",Ic),e=M(b,"maxSegmentDuration",Ic),f=b.getAttribute("type")||"static";if(a.c)n=a.c.presentationTimeline;else{var q=Math.max(10,1.5*g);n=new T(h,null!=l?l:q)}var h=Qd(a,{za:"static"!=f,presentationTimeline:n,R:null,N:null,P:null,w:null,bandwidth:void 0,Rb:!1},c,b),l=h.duration,r=h.periods;return n.nc("static"==f),n.ma(l||1/0),n.mc(null!=d?d:1/0),n.rb(e||1),a.c?Promise.resolve():(b=L(b,"UTCTiming"),Rd(a,c,b,n.aa()).then(function(a){this.a&&(n.lc(a),this.c={presentationTimeline:n,periods:r,offlineSessionIds:[],minBufferTime:g||0})}.bind(a)))}function Qd(a,b,c,d){var e=M(d,"mediaPresentationDuration",Ic),f=[],g=0;d=L(d,"Period");for(var h=0;h<d.length;h++){var l=d[h],g=M(l,"start",Ic,g),n=M(l,"duration",Ic),q=null;if(h!=d.length-1){var r=M(d[h+1],"start",Ic);null!=r&&(q=r-g)}else null!=e&&(q=e-g);if(null==q&&(q=n),l=Sd(a,b,c,{start:g,duration:q,node:l,nb:null==q||h==d.length-1}),f.push(l),n=b.R.id,a.i.every(za(n))&&(a.a.filterPeriod(l),a.i.push(n),a.c&&a.c.periods.push(l)),null==q){g=null;break}g+=q}return null!=e?{periods:f,duration:e}:{periods:f,duration:g}}function Sd(a,b,c,d){b.R=Td(d.node,null,c),b.N=d,b.R.id||(b.R.id="__shaka_period_"+d.start),L(d.node,"EventStream").forEach(a.td.bind(a,d.start,d.duration)),c=L(d.node,"AdaptationSet").map(a.rd.bind(a,b)).filter(ya);var e=c.map(function(a){return a.Dd}).reduce(x,[]),f=e.filter(Aa);if(b.za&&e.length!=f.length)throw new t(2,4,4018);var g=c.filter(function(a){return!a.Fb});if(c.filter(function(a){return a.Fb}).forEach(function(a){var b=a.streams[0],c=a.Fb;g.forEach(function(a){a.id==c&&a.streams.forEach(function(a){a.trickModeVideo=b})})}),e=Ud(g,"video"),f=Ud(g,"audio"),!e.length&&!f.length)throw new t(2,4,4004);for(f.length||(f=[null]),e.length||(e=[null]),b=[],c=0;c<f.length;c++)for(var h=0;h<e.length;h++)Vd(a,f[c],e[h],b);for(a=Ud(g,"text"),e=[],c=0;c<a.length;c++)e.push.apply(e,a[c].streams);return{startTime:d.start,textStreams:e,variants:b}}function Ud(a,b){return a.filter(function(a){return a.contentType==b})}function Vd(a,b,c,d){var e;if(b||c)if(b&&c){var f=b.drmInfos;if(e=c.drmInfos,f.length&&e.length?0<qb(f,e).length:1)for(var g=qb(b.drmInfos,c.drmInfos),f=0;f<b.streams.length;f++)for(var h=0;h<c.streams.length;h++)e=c.streams[h].bandwidth+b.streams[f].bandwidth,e={id:a.h++,language:b.language,primary:b.ob||c.ob,audio:b.streams[f],video:c.streams[h],bandwidth:e,drmInfos:g,allowedByApplication:!0,allowedByKeySystem:!0},d.push(e)}else for(g=b||c,f=0;f<g.streams.length;f++)e=g.streams[f].bandwidth,e={id:a.h++,language:g.language||"und",primary:g.ob,audio:b?g.streams[f]:null,video:c?g.streams[f]:null,bandwidth:e,drmInfos:g.drmInfos,allowedByApplication:!0,allowedByKeySystem:!0},d.push(e)}function Od(a,b){0>a.l||(a.f=window.setTimeout(a.Wd.bind(a),1e3*Math.max(Math.max(3,a.l)-b,0)))}function Td(a,b,c){b=b||{contentType:"",mimeType:"",codecs:"",containsEmsgBoxes:!1,frameRate:void 0},c=c||b.S;var d=L(a,"BaseURL").map(Gc),e=a.getAttribute("contentType")||b.contentType,f=a.getAttribute("mimeType")||b.mimeType,g=a.getAttribute("codecs")||b.codecs,h=M(a,"frameRate",Nc)||b.frameRate,l=!!L(a,"InbandEventStream").length;return e||(e=Wd(f,g)),{S:z(c,d),La:Fc(a,"SegmentBase")||b.La,la:Fc(a,"SegmentList")||b.la,Ma:Fc(a,"SegmentTemplate")||b.Ma,width:M(a,"width",Mc)||b.width,height:M(a,"height",Mc)||b.height,contentType:e,mimeType:f,codecs:g,frameRate:h,containsEmsgBoxes:l||b.containsEmsgBoxes,id:a.getAttribute("id")}}function Xd(a){var b;return b=0+(a.La?1:0),b+=a.la?1:0,(b+=a.Ma?1:0)?(1!=b&&(a.La&&(a.la=null),a.Ma=null),!0):"text"==a.contentType||"application"==a.contentType?!0:!1}function Yd(a,b,c,d){return b=z(b,[c]),b=C(b,a.b.retryParameters),b.method=d,a.a.networkingEngine.request(0,b).then(function(a){if("HEAD"==d){if(!a.headers||!a.headers.date)return 0;a=a.headers.date}else a=F(a.data);return a=Date.parse(a),isNaN(a)?0:a-Date.now()})}function Rd(a,b,c,d){c=c.map(function(a){return{scheme:a.getAttribute("schemeIdUri"),value:a.getAttribute("value")}});var e=a.b.dash.clockSyncUri;return d&&!c.length&&e&&c.push({scheme:"urn:mpeg:dash:utc:http-head:2014",value:e}),xa(c,function(a){var c=a.value;switch(a.scheme){case"urn:mpeg:dash:utc:http-head:2014":case"urn:mpeg:dash:utc:http-head:2012":return Yd(this,b,c,"HEAD");case"urn:mpeg:dash:utc:http-xsdate:2014":case"urn:mpeg:dash:utc:http-iso:2014":case"urn:mpeg:dash:utc:http-xsdate:2012":case"urn:mpeg:dash:utc:http-iso:2012":return Yd(this,b,c,"GET");case"urn:mpeg:dash:utc:direct:2014":case"urn:mpeg:dash:utc:direct:2012":return a=Date.parse(c),isNaN(a)?0:a-Date.now();case"urn:mpeg:dash:utc:http-ntp:2014":case"urn:mpeg:dash:utc:ntp:2014":case"urn:mpeg:dash:utc:sntp:2014":return Promise.reject();default:return Promise.reject()}}.bind(a))["catch"](function(){return 0})}function Wd(a,b){return sb[Wb(a,b)]?"text":a.split("/")[0]}function Zd(a,b,c,d){this.uri=a,this.type=b,this.da=c,this.segments=d||null}function $d(a,b,c,d){this.id=a,this.name=b,this.a=c,this.value=d||null}function ae(a,b){this.name=a,this.value=b}function be(a,b){this.da=b,this.uri=a}function ce(a,b){return a.filter(function(a){return a.name==b})}function de(a,b){var c=ce(a,b);return c.length?c[0]:null}function ee(a,b,c){return a.filter(function(a){var d=a.getAttribute("TYPE");return a=a.getAttribute("GROUP-ID"),
d.value==b&&a.value==c})}function fe(a){this.b=a,this.a=0}function ge(a,b){var c;return b.lastIndex=a.a,c=(c=b.exec(a.b))?{position:c.index,length:c[0].length,Gd:c}:null,a.a!=a.b.length&&c&&c.position==a.a?(a.a+=c.length,c.Gd):null}function he(a){return a.a==a.b.length?null:(a=ge(a,/[^ \t\n]*/gm))?a[0]:null}function ie(){this.a=0}function ke(a,b,c){b=F(b),b=b.replace(/\r\n|\r(?=[^\n]|$)/gm,"\n").trim();var d=b.split(/\n+/m);if(!/^#EXTM3U($|[ \t\n])/m.test(d[0]))throw new t(2,4,4015);b=0;for(var e=[],f=1;f<d.length;)if(/^#(?!EXT)/m.test(d[f]))f+=1;else{var g;if(g=d[f],g=le(a.a++,g),0<=me.indexOf(g.name))b=1;else if(0<=ne.indexOf(g.name)){if(1!=b)throw new t(2,4,4017);return d=d.splice(f,d.length-f),a=oe(a,d),new Zd(c,b,e,a)}e.push(g),f+=1,"EXT-X-STREAM-INF"==g.name&&(g.a.push(new ae("URI",d[f])),f+=1)}return new Zd(c,b,e)}function oe(a,b){var c=[],d=[];return b.forEach(function(a){/^(#EXT)/.test(a)?(a=le(this.a++,a),d.push(a)):/^#(?!EXT)/m.test(a)||(c.push(new be(a.trim(),d)),d=[])}.bind(a)),c}function le(a,b){var c=b.match(/^#(EXT[^:]*)(?::(.*))?$/);if(!c)throw new t(2,4,4016);var d=c[1],e=c[2],c=[];if(e&&0<=e.indexOf("="))for(var f,e=new fe(e),g=/([^=]+)=(?:"([^"]*)"|([^",]*))(?:,|$)/g;f=ge(e,g);)c.push(new ae(f[1],f[2]||f[3]));else if(e)return new $d(a,d,c,e);return new $d(a,d,c)}function pe(a){return new Promise(function(b){var c=pe.parse(a);b({uri:a,data:c.data,headers:{"content-type":c.contentType}})})}function qe(){this.b=this.c=null,this.i=1,this.g={},this.f={},this.a=null,this.j="",this.h=new ie}function se(a,b,c){if(b=ke(a.h,b,c),0!=b.type)throw new t(2,4,4022);return a.a=new T(null,0),te(a,b).then(function(a){return this.c.filterPeriod(a),{presentationTimeline:this.a,periods:[a],offlineSessionIds:[],minBufferTime:0}}.bind(a))}function te(a,b){var c=ce(b.da,"EXT-X-STREAM-INF").map(function(a){return ue(this,a,b)}.bind(a)),d=ce(b.da,"EXT-X-MEDIA").filter(function(a){return"SUBTITLES"==U(a,"TYPE")}.bind(a)).map(function(a){return ve(this,a,b)}.bind(a));return Promise.all(c).then(function(a){return Promise.all(d).then(function(b){var c=a.reduce(x,[]);return we(this,c),{startTime:0,variants:c,textStreams:b}}.bind(this))}.bind(a))}function ue(a,b,c){var g,h,l,d=Number(U(b,"BANDWIDTH")),e=U(b,"CODECS").split(","),f=b.getAttribute("RESOLUTION"),n=b.getAttribute("FRAME-RATE");n&&(l=n.value),f&&(f=f.value.split("x"),g=f[0],h=f[1]);var q=xe(a,c);c=ce(c.da,"EXT-X-MEDIA");var f=b.getAttribute("AUDIO"),n=b.getAttribute("VIDEO"),r=[],v=[];f&&(r=ee(c,"AUDIO",f.value).map(function(a){return ye(this,a,e,q)}.bind(a))),n&&(v=ee(c,"VIDEO",n.value).map(function(a){return ye(this,a,e,q)}.bind(a)));var u=[],w=[];return Promise.all([Promise.all(r),Promise.all(v)]).then(function(a){return u=a[0],w=a[1],w.length&&u.length?a=null:w.length&&!u.length?(a=U(b,"URI"),a=ze(this,a,e,"audio",q,"und",!1)):(a=U(b,"URI"),a=ze(this,a,e,"video",q,"und",!1)),a}.bind(a)).then(function(a){return a&&("audio"==a.stream.type?u=[a]:w=[a]),Ae(this,u,w,d,g,h,l)}.bind(a))}function Ae(a,b,c,d,e,f,g){c.forEach(function(a){(a=a.stream)&&(a.width=Number(e)||void 0,a.height=Number(f)||void 0,a.frameRate=Number(g)||void 0)}.bind(a)),b.length||(b=[null]),c.length||(c=[null]);for(var h=[],l=0;l<b.length;l++)for(var n=0;n<c.length;n++){var w,q=b[l]?b[l].stream:null,r=c[n]?c[n].stream:null,v=b[l]?b[l].drmInfos:null,u=c[n]?c[n].drmInfos:null;if(q&&r){if(!(v.length&&u.length?0<qb(v,u).length:1))continue;w=qb(v,u)}else q?w=v:r&&(w=u);h.push(Be(a,q,r,d,w))}return h}function Be(a,b,c,d,e){return{id:a.i++,language:b?b.language:"und",primary:!!b&&b.primary||!!c&&c.primary,audio:b,video:c,bandwidth:d,drmInfos:e,allowedByApplication:!0,allowedByKeySystem:!0}}function ve(a,b,c){return U(b,"TYPE"),c=xe(a,c),ye(a,b,[],c).then(function(a){return a.stream})}function ye(a,b,c,d){if(a.g[b.id])return Promise.resolve().then(function(){return this.g[b.id]}.bind(a));var e=U(b,"TYPE").toLowerCase();"subtitles"==e&&(e="text");var f=b.getAttribute("LANGUAGE"),f=f?Qb(f.value):"und",g=b.getAttribute("DEFAULT"),h=b.getAttribute("AUTOSELECT"),l=U(b,"URI");return ze(a,l,c,e,d,f,!!g||!!h).then(function(a){return this.g[b.id]=a}.bind(a))}function ze(a,b,c,d,e,f,g){return b=z([a.j],[b])[0],a.c.networkingEngine.request(0,C([b],a.b.retryParameters)).then(function(a){if(a=ke(this.h,a.data,a.uri),1!=a.type)throw new t(2,4,4017);e=xe(this,a)||e;var b=null;"text"!=d&&(b=Ce(a));var h=de(a.da,"EXT-X-MEDIA-SEQUENCE"),h=De(this,a,h?Number(h.value):0);this.a.Da(0,h);var q=h[h.length-1].endTime-h[0].startTime,r=this.a.W();(1/0==r||q>r)&&this.a.ma(q);var v=Ee(d,c),u=void 0;"text"==d&&(u="subtitle");var w=new S(h),K=[];a.segments.forEach(function(a){a=ce(a.da,"EXT-X-KEY"),K.push.apply(K,a)});var pa=!1,Jb=[],re=null;if(K.forEach(function(a){if("NONE"!=U(a,"METHOD")){pa=!0;var b=U(a,"KEYFORMAT");(a=(b=Fe[b])?b(a):null)&&(a.keyIds.length&&(re=a.keyIds[0]),Jb.push(a))}}),pa&&!Jb.length)throw new t(2,4,4026);return Ge(this,d,h[0].a()[0]).then(function(a){return a={id:this.i++,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:w.find.bind(w),getSegmentReference:w.get.bind(w),initSegmentReference:b,presentationTimeOffset:e||0,mimeType:a,codecs:v,kind:u,encrypted:pa,keyId:re,language:f,type:d,primary:g,trickModeVideo:null,containsEmsgBoxes:!1,frameRate:void 0,width:void 0,height:void 0,bandwidth:void 0},this.f[a.id]=w,{stream:a,me:w,drmInfos:Jb}}.bind(this))}.bind(a))}function Ce(a){var b=ce(a.da,"EXT-X-MAP");if(!b.length)return null;if(1<b.length)throw new t(2,4,4020);var b=b[0],c=U(b,"URI"),d=z([a.uri],[c])[0];return a=0,c=null,(b=b.getAttribute("BYTERANGE"))&&(a=b.value.split("@"),b=Number(a[0]),a=Number(a[1]),c=a+b-1),new Xc(function(){return[d]},a,c)}function De(a,b,c){var d=b.segments,e=[];return d.forEach(function(a){var n,f=a.da,h=z([b.uri],[a.uri])[0],l=He(f).value.split(","),l=Number(l[0]);n=(a=d.indexOf(a))?e[a-1].endTime:0;var l=n+l,q=0,r=null;(f=de(f,"EXT-X-BYTERANGE"))&&(f=f.value.split("@"),r=Number(f[0]),q=f[1]?Number(f[1]):e[a-1].J,r=q+r-1,a==d.length-1&&(r=null)),e.push(new N(c+a,n,l,function(){return[h]},q,r))}.bind(a)),e}function we(a,b){b.forEach(function(a){var b=this.a.W(),c=a.video;a=a.audio,c&&this.f[c.id]&&ld(this.f[c.id],b),a&&this.f[a.id]&&ld(this.f[a.id],b)}.bind(a))}function Ee(a,b){if(1==b.length)return b[0];if("text"==a)return"";var c=Ie;"audio"==a&&(c=Je);for(var d=0;d<c.length;d++)for(var e=0;e<b.length;e++)if(c[d].test(b[e].trim()))return b[e].trim();throw new t(2,4,4025,b)}function Ge(a,b,c){var d=c.split("."),e=d[d.length-1];return"text"==b?Promise.resolve("text/vtt"):(d=Ke,"video"==b&&(d=Le),(b=d[e])?Promise.resolve(b):(c=C([c],a.b.retryParameters),c.method="HEAD",a.c.networkingEngine.request(1,c).then(function(a){if(a=a.headers["content-type"],!a)throw new t(2,4,4021,e);return a})))}function xe(a,b){var c=de(b.da,"EXT-X-START");return c?Number(U(c,"TIME-OFFSET")):a.b.hls.defaultTimeOffset}function U(a,b){var c=a.getAttribute(b);if(!c)throw new t(2,4,4023,b);return c.value}function He(a){if(a=de(a,"EXTINF"),!a)throw new t(2,4,4024,"EXTINF");return a}function Me(){}function Oe(a){var b=[];if(!a)return b;for(var c=a.childNodes,d=0;d<c.length;d++){var e="span"==c[d].nodeName&&"p"==a.nodeName;c[d].nodeType!=Node.ELEMENT_NODE||"br"==c[d].nodeName||e||(e=Oe(c[d]),b=b.concat(e))}return b.length||b.push(a),b}function Pe(a,b){for(var c=a.childNodes,d=0;d<c.length;d++)if("br"==c[d].nodeName&&d>0)c[d-1].textContent+="\n";else if(0<c[d].childNodes.length)Pe(c[d],b);else if(b){var e=c[d].textContent.trim(),e=e.replace(/\s+/g," ");c[d].textContent=e}}function Se(a,b,c,d){for(var e=Oe(b),f=0;f<e.length;f++){var g=e[f].getAttribute(d);if(g)return g}return e=Re,(a=e(b,"style",c)||e(a,"style",c))?a.getAttribute(d):null}function Re(a,b,c){if(!a||1>c.length)return null;var d=null,e=a;for(a=null;e&&!(a=e.getAttribute(b))&&(e=e.parentNode,e instanceof Element););if(b=a)for(a=0;a<c.length;a++)if(c[a].getAttribute("xml:id")==b){d=c[a];break}return d}function Qe(a,b){var c=null;if(We.test(a))var c=We.exec(a),d=Number(c[1]),e=Number(c[2]),f=Number(c[3]),g=Number(c[4]),g=g+(Number(c[5])||0)/b.b,f=f+g/b.frameRate,c=f+60*e+3600*d;else Xe.test(a)?c=bf(Xe,a):Ye.test(a)?c=bf(Ye,a):Ze.test(a)?(c=Ze.exec(a),c=Number(c[1])/b.frameRate):$e.test(a)?(c=$e.exec(a),c=Number(c[1])/b.a):af.test(a)&&(c=bf(af,a));return c}function bf(a,b){var c=a.exec(b);return c&&""!=c[0]?(Number(c[4])||0)/1e3+(Number(c[3])||0)+60*(Number(c[2])||0)+3600*(Number(c[1])||0):null}function Ne(a,b,c,d){this.frameRate=Number(a)||30,this.b=Number(b)||1,this.a=Number(d),this.a||(this.a=a?this.frameRate*this.b:1),c&&(a=/^(\d+) (\d+)$/g.exec(c))&&(this.frameRate*=a[1]/a[2])}function cf(){this.a=new Me}function df(){}function ff(a,b){var c;(c=/^align:(start|middle|center|end|left|right)$/.exec(b))?(a.align=c[1],"center"==c[1]&&"center"!=a.align&&(a.position="auto",a.align="middle")):(c=/^vertical:(lr|rl)$/.exec(b))?a.vertical=c[1]:(c=/^size:(\d{1,2}|100)%$/.exec(b))?a.size=Number(c[1]):(c=/^position:(\d{1,2}|100)%(?:,(line-left|line-right|center|start|end))?$/.exec(b))?(a.position=Number(c[1]),c[2]&&(a.positionAlign=c[2])):(c=/^line:(\d{1,2}|100)%(?:,(start|end|center))?$/.exec(b))?(a.snapToLines=!1,a.line=Number(c[1]),c[2]&&(a.lineAlign=c[2])):(c=/^line:(-?\d+)(?:,(start|end|center))?$/.exec(b))&&(a.snapToLines=!0,a.line=Number(c[1]),c[2]&&(a.lineAlign=c[2]))}function ef(a){if(a=ge(a,/(?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3})/g),!a)return null;var b=Number(a[2]),c=Number(a[3]);return b>59||c>59?null:Number(a[4])/1e3+c+60*b+3600*(Number(a[1])||0)}function gf(){this.a=null}function hf(a,b,c){var d,e,f;return(new Q).C("payl",id(function(a){d=F(a)})).C("iden",id(function(a){e=F(a)})).C("sttg",id(function(a){f=F(a)})).parse(a),d?jf(d,e,f,b,c):null}function jf(a,b,c,d,e){if((a=vb(d,e,a))&&b&&(a.id=b),a&&c)for(b=new fe(c),c=he(b);c;)ff(a,c),ge(b,/[ \t]+/gm),c=he(b);return a}function kf(a,b,c,d,e,f){this.a=a,this.c=b,this.l=c,this.A=d,this.I=e,this.F=f,this.b=new D,this.h=!1,this.g=1,this.j=this.f=null,this.B=a.readyState,this.i=!1,this.M=this.v=-1,this.o=!1,0<a.readyState?this.Xb():Ka(this.b,a,"loadedmetadata",this.Xb.bind(this)),b=this.Zb.bind(this),E(this.b,a,"ratechange",this.ed.bind(this)),E(this.b,a,"waiting",b),this.j=setInterval(b,250)}function lf(a,b){0<a.a.readyState?a.a.currentTime=mf(a,b):a.A=b}function nf(a){return 0<a.a.readyState?mf(a,a.a.currentTime):of(a)}function of(a){return a.A?mf(a,a.A):(a=a.c.presentationTimeline,1/0>a.W()?a.ja():a.Xa())}function pf(a,b){null!=a.f&&(window.clearInterval(a.f),a.f=null),a.g=b,a.a.playbackRate=a.h||0>b?0:b,!a.h&&0>b&&(a.f=window.setInterval(function(){this.a.currentTime+=b/4}.bind(a),250))}function rf(a,b){var c=zb.bind(null,a.a.buffered),d=1*Math.max(a.c.minBufferTime||0,a.l.rebufferingGoal),e=a.c.presentationTimeline,f=e.ra(),g=e.Aa(d),h=e.Aa(5),d=e.Aa(d+5);return b>f?f:b<e.Aa(0)?c(h)?h:d:b>=g||c(b)?b:d}function qf(a,b,c){a.a.currentTime=c;var d=0,e=function(){!this.a||10<=d++||this.a.currentTime!=b||(this.a.currentTime=c,setTimeout(e,100))}.bind(a);setTimeout(e,100)}function mf(a,b){var c=a.c.presentationTimeline.ja();return c>b?c:(c=a.c.presentationTimeline.ra(),b>c?c:b)}function sf(a,b,c,d,e,f){this.a=a,this.g=b,this.A=c,this.l=d,this.h=e,this.B=f,this.c=[],this.j=new D,this.b=!1,this.i=-1,this.f=null,tf(this)}function vf(a){var b=Da(a);return b.eventElement=a.eventElement,b}function tf(a){uf(a),a.f=window.setTimeout(a.F.bind(a),250)}function uf(a){a.f&&(window.clearTimeout(a.f),a.f=null)}function wf(a,b){this.a=b,this.b=a,this.h=null,this.i=1,this.o=Promise.resolve(),this.g=[],this.j={},this.c={},this.f=this.l=this.v=!1}function V(a){return a.b.periods[fc(a.b,nf(a.a.Ka))]}function zf(a){return Na(a.c,function(a){return a.ka||a.stream})}function Af(a,b){var c={};return c.text=b,yf(a,c)}function Bf(a,b){var c=a.c.video;if(c){var d=c.stream;if(d)if(b){var e=d.trickModeVideo;if(e){var f=c.ka;f||(Cf(a,"video",e,!1),c.ka=d)}}else(f=c.ka)&&(c.ka=null,Cf(a,"video",f,!0))}}function Cf(a,b,c,d){var e=a.c[b];!e&&"text"==b&&a.h.ignoreTextStreamFailures?Af(a,c):e&&(e.ka&&(c.trickModeVideo?(e.ka=c,c=c.trickModeVideo):e.ka=null),"text"==b&&Db(a.a.G,Wb(c.mimeType,c.codecs)),(b=a.g[gc(a.b,c)])&&b.Ga&&(b=a.j[c.id])&&b.Ga&&e.stream!=c&&(e.stream=c,e.Ya=!0,d&&(e.pa?e.fb=!0:e.ta?(e.oa=!0,e.fb=!0):(xf(e),Df(a,e,!0)))))}function Ef(a){var b=nf(a.a.Ka);if(!Object.keys(a.c).every(function(a){var c=this.a.G;return"text"==a?(a=c.a,a=b>=a.b&&b<a.a):(a=Fb(c,a),a=zb(a,b)),a}.bind(a)))for(var c in a.c){var d=a.c[c];d.pa||d.oa||(d.ta?d.oa=!0:null==Eb(a.a.G,c)?null==d.na&&Ff(a,d,0):(xf(d),Df(a,d,!1)))}}function yf(a,b,c){var d=fc(a.b,nf(a.a.Ka)),e=Na(b,function(a){return Wb(a.mimeType,a.codecs)});return a.a.G.init(e),Gf(a),e=Ma(b),Hf(a,e).then(function(){if(!this.f)for(var a in b){var e=b[a];this.c[a]||(this.c[a]={stream:e,type:a,Ba:null,ba:null,ka:null,Ya:!0,Ia:d,endOfStream:!1,ta:!1,na:null,oa:!1,fb:!1,pa:!1,xb:!1,mb:!1,gc:c||0},Ff(this,this.c[a],0))}}.bind(a))}function If(a,b){var c=a.g[b];if(c)return c.O;c={O:new A,Ga:!1},a.g[b]=c;var d=a.b.periods[b].variants.map(function(a){var b=[];return a.audio&&b.push(a.audio),a.video&&b.push(a.video),a.video&&a.video.trickModeVideo&&b.push(a.video.trickModeVideo),b}).reduce(x,[]).filter(Aa);return d.push.apply(d,a.b.periods[b].textStreams),a.o=a.o.then(function(){return this.f?void 0:Hf(this,d)}.bind(a)).then(function(){this.f||(this.g[b].O.resolve(),this.g[b].Ga=!0)}.bind(a))["catch"](function(a){this.f||(this.g[b].O.reject(),delete this.g[b],this.a.onError(a))}.bind(a)),c.O}function Hf(a,b){b.map(function(a){return a.id}).filter(Aa);for(var c=[],d=0;d<b.length;++d){var e=b[d],f=a.j[e.id];f?c.push(f.O):(a.j[e.id]={O:new A,Ga:!1},c.push(e.createSegmentIndex()))}return Promise.all(c).then(function(){if(!this.f)for(var a=0;a<b.length;++a){var c=this.j[b[a].id];c.Ga||(c.O.resolve(),c.Ga=!0)}}.bind(a))["catch"](function(a){return this.f?void 0:(this.j[e.id].O.reject(),delete this.j[e.id],Promise.reject(a))}.bind(a))}function Gf(a){var b=a.b.presentationTimeline.W();a.a.G.ma(1/0>b?b:Math.pow(2,32))}function Jf(a,b){var c=nf(a.a.Ka),d=b.Ba&&b.ba?a.b.periods[gc(a.b,b.Ba)].startTime+b.ba.endTime:Math.max(c,b.gc);b.gc=0;var g,e=gc(a.b,b.stream),f=fc(a.b,d);g=a.a.G;var h=b.type;return"text"==h?(g=g.a,g=null==g.a||g.a<c?0:g.a-Math.max(c,g.b)):(g=Fb(g,h),g=Ab(g,c)),h=Math.max(a.i*Math.max(a.b.minBufferTime||0,a.h.rebufferingGoal),a.i*a.h.bufferingGoal),d>=a.b.presentationTimeline.W()?(b.endOfStream=!0,null):(b.endOfStream=!1,b.Ia=f,f!=e?null:g>=h?.5:(d=a.a.G,f=b.type,d="text"==f?d.a.a:yb(Fb(d,f)),b.ba&&b.stream==b.Ba?(f=b.ba.position+1,d=Lf(a,b,e,f)):(f=b.stream.findSegmentPosition(b.ba?Math.max(0,a.b.periods[gc(a.b,b.Ba)].startTime+b.ba.endTime-a.b.periods[e].startTime):Math.max(0,(d||c)-a.b.periods[e].startTime)),null==f?d=null:(g=null,null==d&&(g=Lf(a,b,e,Math.max(0,f-1))),d=g||Lf(a,b,e,f))),d?(Mf(a,b,c,e,d),null):1))}function Lf(a,b,c,d){return c=a.b.periods[c],(b=b.stream.getSegmentReference(d))?(a=a.b.presentationTimeline,d=a.ra(),c.startTime+b.endTime<a.ja()||c.startTime+b.startTime>d?null:b):null}function Mf(a,b,c,d,e){var f=a.b.periods[d],g=b.stream,h=a.b.periods[d+1],l=null,l=h?h.startTime:a.b.presentationTimeline.W();d=Nf(a,b,d,l),b.ta=!0,b.Ya=!1,h=Of(a,e),Promise.all([d,h]).then(function(a){return this.f||this.l?void 0:Pf(this,b,c,f,g,e,a[1])}.bind(a)).then(function(){this.f||this.l||(b.ta=!1,b.xb=!1,b.oa||this.a.tb(),Ff(this,b,0),Qf(this,g))}.bind(a))["catch"](function(a){this.f||this.l||(b.ta=!1,1001==a.code||1002==a.code||1003==a.code?"text"==b.type&&this.h.ignoreTextStreamFailures&&1001==a.code?delete this.c.text:(a.severity=1,this.a.onError(a),Ff(this,b,4)):3017==a.code?Rf(this,b,a):"text"==b.type&&this.h.ignoreTextStreamFailures?delete this.c.text:(b.mb=!0,a.severity=2,this.a.onError(a)))}.bind(a))}function Rf(a,b,c){if(!Ma(a.c).some(function(a){return a!=b&&a.xb})){var d=Math.round(100*a.i);if(d>20)a.i-=.2;else{if(!(d>4))return b.mb=!0,a.l=!0,void a.a.onError(c);a.i-=.04}b.xb=!0}Ff(a,b,4)}function Nf(a,b,c,d){return b.Ya?(c=Kb(a.a.G,b.type,a.b.periods[c].startTime-b.stream.presentationTimeOffset,d),b.stream.initSegmentReference?(a=Of(a,b.stream.initSegmentReference).then(function(a){return this.f?void 0:Gb(this.a.G,b.type,a,null,null)}.bind(a))["catch"](function(a){return b.Ya=!0,Promise.reject(a)}),Promise.all([c,a])):c):Promise.resolve()}function Pf(a,b,c,d,e,f,g){return e.containsEmsgBoxes&&(new Q).$("emsg",a.sd.bind(a,d,f)).parse(g),Sf(a,b,c).then(function(){return this.f?void 0:Gb(this.a.G,b.type,g,f.startTime+d.startTime,f.endTime+d.startTime)}.bind(a)).then(function(){return this.f?void 0:(b.Ba=e,b.ba=f,Promise.resolve())}.bind(a))}function Sf(a,b,c){var d=Eb(a.a.G,b.type);return null==d?Promise.resolve():(c=c-d-a.h.bufferBehind,0>=c?Promise.resolve():a.a.G.remove(b.type,d,d+c).then(function(){}.bind(a)))}function Qf(a,b){if(!a.v&&(a.v=Ma(a.c).every(function(a){return"text"==a.type?!0:!a.oa&&!a.pa&&a.ba}),a.v)){var c=gc(a.b,b);for(a.g[c]||If(a,c).then(function(){this.a.Sb()}.bind(a))["catch"](y),c=0;c<a.b.periods.length;++c)If(a,c)["catch"](y);a.a.kd&&a.a.kd()}}function Kf(a,b){if(b.Ia!=gc(a.b,b.stream)){var c=b.Ia,d=Ma(a.c);d.every(function(a){return a.Ia==c})&&d.every(Tf)&&If(a,c).then(function(){if(!this.f&&d.every(function(a){var b=gc(this.b,a.stream);return Tf(a)&&a.Ia==c&&b!=c}.bind(this))){var g,a=this.b.periods[c],b=this.a.Tb(a);for(g in this.c)if(!b[g]&&"text"!=g)return void this.a.onError(new t(2,5,5005));for(g in b)if(!this.c[g]){if("text"!=g)return void this.a.onError(new t(2,5,5005));yf(this,{text:b.text},a.startTime),delete b[g]}for(g in this.c)(a=b[g])?(Cf(this,g,a,!1),Ff(this,this.c[g],0)):delete this.c[g];this.a.Sb()}}.bind(a))["catch"](y)}}function Tf(a){return!a.ta&&null==a.na&&!a.oa&&!a.pa}function Of(a,b){var c=C(b.a(),a.h.retryParameters);if(b.V||null!=b.J){var d="bytes="+b.V+"-";null!=b.J&&(d+=b.J),c.headers.Range=d}return a.a.Sc.request(1,c).then(function(a){return a.data})}function Df(a,b,c){b.oa=!1,b.fb=!1,b.pa=!0,Ib(a.a.G,b.type).then(function(){if(!this.f&&c){var a=this.a.G,e=b.type;return"text"==e?Promise.resolve():Hb(a,e,a.Dc.bind(a,e))}}.bind(a)).then(function(){this.f||(b.Ba=null,b.ba=null,b.pa=!1,b.endOfStream=!1,Ff(this,b,0))}.bind(a))}function Ff(a,b,c){b.na=window.setTimeout(a.Zd.bind(a,b),1e3*c)}function xf(a){null!=a.na&&(window.clearTimeout(a.na),a.na=null)}function Uf(a,b){return new Promise(function(c,d){var e=new XMLHttpRequest;e.open(b.method,a,!0),e.responseType="arraybuffer",e.timeout=b.retryParameters.timeout,e.withCredentials=b.allowCrossSiteCredentials,e.onload=function(b){b=b.target;var e=b.getAllResponseHeaders().split("\r\n").reduce(function(a,b){var c=b.split(": ");return a[c[0].toLowerCase()]=c.slice(1).join(": "),a},{});if(200<=b.status&&299>=b.status&&202!=b.status)b.responseURL&&(a=b.responseURL),c({uri:a,data:b.response,headers:e,fromCache:!!e["x-shaka-from-cache"]});else{var f=null;try{f=Ra(b.response)}catch(n){}d(new t(401==b.status||403==b.status?2:1,1,1001,a,b.status,f,e))}},e.onerror=function(){d(new t(1,1,1002,a))},e.ontimeout=function(){d(new t(1,1,1003,a))};for(var f in b.headers)e.setRequestHeader(f,b.headers[f]);e.send(b.body)})}function Vf(){this.a=null,this.c=[],this.b={}}function Zf(a,b,c){return Yf(a,b,"readwrite",function(a){return a.put(c)})}function $f(a,b){var c=[];return Yf(a,"segment","readwrite",function(a){return a.openCursor()},function(a){if(a){if(b(a.value)){var d=a["delete"](),f=new A;d.onsuccess=f.resolve,d.onerror=ag.bind(null,d,f),c.push(f)}a["continue"]()}}).then(function(){return Promise.all(c)}).then(function(){return c.length})}function Xf(a,b){var c=0;return Yf(a,b,"readonly",function(a){return a.openCursor(null,"prev")},function(a){a&&(c=a.key+1)}).then(function(){return c})}function Yf(a,b,c,d,e){c=a.a.transaction([b],c);var f=d(c.objectStore(b)),g=new A;e&&(f.onsuccess=function(a){e(a.target.result)}),f.onerror=function(){};var h={transaction:c,O:g};a.c.push(h);var l=function(){this.c.splice(this.c.indexOf(h),1)}.bind(a);return c.oncomplete=function(){l(),g.resolve(f.result)},c.onerror=function(a){a.preventDefault()},c.onabort=function(a){l(),ag(f,g,a)},g}function Wf(a,b,c){var d=window.indexedDB.open("shaka_offline_db",1),e=!1,f=new A;return d.onupgradeneeded=function(a){e=!0,a=a.target.result;for(var c in b)a.createObjectStore(c,{keyPath:b[c]})},d.onsuccess=function(a){c&&!e?(a.target.result.close(),setTimeout(function(){Wf(this,b,c-1).then(f.resolve,f.reject)}.bind(this),1e3)):(this.a=a.target.result,f.resolve())}.bind(a),d.onerror=ag.bind(null,d,f),f}function ag(a,b,c){b.reject(a.error&&"AbortError"!=a.error.name?new t(2,9,9001,a.error):new t(2,9,9002)),c.preventDefault()}function cg(a){var b=dg(a.periods[0],[],new T(null,0)),c=Xb(b,null,null),b=Zb(b,null);return c.push.apply(c,b),{offlineUri:"offline:"+a.key,originalManifestUri:a.originalManifestUri,duration:a.duration,size:a.size,expiration:void 0==a.expiration?1/0:a.expiration,tracks:c,appMetadata:a.appMetadata}}function dg(a,b,c){var d=a.streams.filter(function(a){return"text"==a.contentType}),e=a.streams.filter(function(a){return"audio"==a.contentType}),f=a.streams.filter(function(a){return"video"==a.contentType});return b=eg(e,f,b),d=d.map(fg),a.streams.forEach(function(a){a=gg(a),c.Da(0,a)}),{startTime:a.startTime,variants:b,textStreams:d}}function gg(a){return a.segments.map(function(a,c){return new N(c,a.startTime,a.endTime,function(){return[a.uri]},0,null)})}function eg(a,b,c){var d=[];if(!a.length&&!b.length)return d;a.length?b.length||(b=[null]):a=[null];for(var e=0,f=0;f<a.length;f++)for(var g=0;g<b.length;g++)if(hg(a[f],b[g])){var h;h=a[f];var l=b[g],n=c;h={id:e++,language:h?h.language:"",primary:!!h&&h.primary||!!l&&l.primary,audio:fg(h),video:fg(l),bandwidth:0,drmInfos:n,allowedByApplication:!0,allowedByKeySystem:!0},d.push(h)}return d}function hg(a,b){if(!(a&&b&&a.variantIds&&b.variantIds))return!0;for(var c=0;c<a.variantIds.length;c++)if(b.variantIds.some(function(b){return b==a.variantIds[c]}))return!0;return!1}function fg(a){if(!a)return null;var b=gg(a),b=new S(b);return{id:a.id,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:b.find.bind(b),getSegmentReference:b.get.bind(b),initSegmentReference:a.initSegmentUri?new Xc(function(){return[a.initSegmentUri]},0,null):null,presentationTimeOffset:a.presentationTimeOffset,mimeType:a.mimeType,codecs:a.codecs,width:a.width||void 0,height:a.height||void 0,frameRate:a.frameRate||void 0,kind:a.kind,encrypted:a.encrypted,keyId:a.keyId,language:a.language,type:a.contentType,primary:a.primary,trickModeVideo:null,containsEmsgBoxes:!1}}function ig(){return window.indexedDB?new Vf:null}function jg(a,b,c,d){this.b={},this.l=[],this.o=d,this.j=a,this.v=b,this.A=c,this.i=this.a=null,this.f=this.g=this.h=this.c=0}function kg(a,b,c,d,e){a.b[b]=a.b[b]||[],a.b[b].push({uris:c.a(),V:c.V,J:c.J,Ib:d,yb:e})}function lg(a,b){a.c=0,a.h=0,a.g=0,a.f=0,Ma(a.b).forEach(function(a){a.forEach(function(a){null!=a.J?this.c+=a.J-a.V+1:this.g+=a.Ib}.bind(this))}.bind(a)),a.a=b,a.a.size=a.c;var c=Ma(a.b).map(function(a){var b=0,c=function(){if(!this.o)return Promise.reject(new t(2,9,9002));if(b>=a.length)return Promise.resolve();var d=a[b++];return mg(this,d).then(c)}.bind(this);return c()}.bind(a));return a.b={},a.i=Promise.all(c).then(function(){return Zf(this.j,"manifest",b)}.bind(a)).then(function(){this.l=[]}.bind(a)),a.i}function mg(a,b){var c=C(b.uris,a.A);(b.V||null!=b.J)&&(c.headers.Range="bytes="+b.V+"-"+(null==b.J?"":b.J));var d;return a.v.request(1,c).then(function(a){return this.a?(d=a.data.byteLength,this.l.push(b.yb.key),b.yb.data=a.data,Zf(this.j,"segment",b.yb)):Promise.reject(new t(2,9,9002))}.bind(a)).then(function(){if(!this.a)return Promise.reject(new t(2,9,9002));null==b.J?(this.a.size+=d,this.f+=b.Ib):this.h+=d;var a=(this.h+this.f)/(this.c+this.g),c=cg(this.a);this.o.progressCallback(c,a)}.bind(a))}function ng(){this.a=-1}function og(a){var b=new T(null,0);b.ma(a.duration);var c=a.drmInfo?[a.drmInfo]:[];return{presentationTimeline:b,minBufferTime:10,offlineSessionIds:a.sessionIds,periods:a.periods.map(function(a){return dg(a,c,b)})}}function pg(a){if(/^offline:([0-9]+)$/.exec(a)){var b={uri:a,data:new ArrayBuffer(0),headers:{"content-type":"application/x-offline-manifest"}};return Promise.resolve(b)}if(b=/^offline:[0-9]+\/[0-9]+\/([0-9]+)$/.exec(a)){var c=Number(b[1]),d=ig();return d?d.init(bg).then(function(){return d.get("segment",c)}).then(function(b){return d.m().then(function(){if(!b)throw new t(2,9,9003,c);return{uri:a,data:b.data,headers:{}}})}):Promise.reject(new t(2,9,9e3))}return Promise.reject(new t(2,1,9004,a))}function qg(){this.a=Promise.resolve(),this.c=this.b=this.f=!1,this.g=new Promise(function(a){this.h=a}.bind(this))}function rg(a){return a.f||(a.a=a.a.then(function(a){return this.b=!0,Promise.resolve(a)}.bind(a),function(a){return this.b=!0,Promise.reject(a)}.bind(a))),a.f=!0,a.a}function W(a,b){p.call(this),this.I=!1,this.f=a,this.A=null,this.l=new D,this.Hb=new G,this.Ta=this.c=this.h=this.a=this.v=this.g=this.Ra=this.ga=this.K=this.j=this.o=null,this.sc=1e9,this.Qa=[],this.ha=!1,this.Ua=!0,this.ia=this.F=null,this.B={},this.Sa=[],this.M={},this.b=sg(this),this.hb={width:1/0,height:1/0},this.i=tg(),this.Pa=0,this.fa=this.b.preferredAudioLanguage,this.ya=this.b.preferredTextLanguage,b&&b(this),this.o=new B(this.Sd.bind(this)),this.Ra=ug(this);for(var c=0;c<this.f.textTracks.length;++c){var d=this.f.textTracks[c];d.mode="disabled","Shaka Player TextTrack"==d.label&&(this.A=d)}this.A||(this.A=this.f.addTextTrack("subtitles","Shaka Player TextTrack")),this.A.mode="hidden",E(this.l,this.f,"error",this.md.bind(this))}function ug(a){a.K=new MediaSource;var b=new A;return E(a.l,a.K,"sourceopen",b.resolve),a.f.src=window.URL.createObjectURL(a.K),b}function Bg(a){if(a.h&&a.h.configure(a.b.manifest),a.j&&a.j.configure(a.b.drm),a.a){a.a.configure(a.b.streaming);try{a.c.periods.forEach(a.$a.bind(a))}catch(b){a.ua(b)}Cg(a,V(a.a))}a.b.abr.enabled&&!a.Ua?a.b.abr.manager.enable():a.b.abr.manager.disable(),a.b.abr.manager.setDefaultEstimate(a.b.abr.defaultBandwidthEstimate),a.b.abr.manager.setRestrictions(a.b.abr.restrictions)}function Eg(a,b,c){a.i.switchHistory.push({timestamp:Date.now()/1e3,id:b.id,type:b.type,fromAdaptation:c}),Gg(a,b)}function Gg(a,b){var c=gc(a.c,b);a.M[c]||(a.M[c]={}),a.M[c][b.type]=b.id}function vg(a){a.l&&(a.l.ea(a.K,"sourceopen"),a.l.ea(a.f,"loadeddata"),a.l.ea(a.f,"playing"),a.l.ea(a.f,"pause"),a.l.ea(a.f,"ended")),a.f&&(a.f.removeAttribute("src"),a.f.load());var b=Promise.all([a.b?a.b.abr.manager.stop():null,a.j?a.j.m():null,a.ga?a.ga.m():null,a.g?a.g.m():null,a.v?a.v.m():null,a.a?a.a.m():null,a.h?a.h.stop():null]);return a.j=null,a.ga=null,a.g=null,a.v=null,a.a=null,a.h=null,a.c=null,a.Ta=null,a.Ra=null,a.K=null,a.Sa=[],a.M={},a.B={},a.i=tg(),b}function Dg(a){return a.h?vg(a).then(function(){this.I||(this.oc(!1),this.Ra=ug(this))}.bind(a)):Promise.resolve()}function Ag(){return{".drm.servers":"",".drm.clearKeys":"",".drm.advanced":{distinctiveIdentifierRequired:!1,persistentStateRequired:!1,videoRobustness:"",audioRobustness:"",serverCertificate:null}}}function sg(a){return{drm:{retryParameters:Fa(),servers:{},clearKeys:{},advanced:{},delayLicenseRequestUntilPlayed:!1},manifest:{retryParameters:Fa(),dash:{customScheme:function(a){return a?null:void 0},clockSyncUri:"",ignoreDrmInfo:!1},hls:{defaultTimeOffset:0}},streaming:{retryParameters:Fa(),rebufferingGoal:2,bufferingGoal:10,bufferBehind:30,ignoreTextStreamFailures:!1,startAtSegmentBoundary:!1,smallGapLimit:.5,jumpLargeGaps:!1},abr:{manager:a.Hb,enabled:!0,defaultBandwidthEstimate:5e5,restrictions:{minWidth:0,maxWidth:1/0,minHeight:0,maxHeight:1/0,minPixels:0,maxPixels:1/0,minBandwidth:0,maxBandwidth:1/0}},preferredAudioLanguage:"",preferredTextLanguage:"",restrictions:{minWidth:0,maxWidth:1/0,minHeight:0,maxHeight:1/0,minPixels:0,maxPixels:1/0,minBandwidth:0,maxBandwidth:1/0}}}function tg(){return{width:0/0,height:0/0,streamBandwidth:0/0,decodedFrames:0/0,droppedFrames:0/0,estimatedBandwidth:0/0,loadLatency:0/0,playTime:0,bufferingTime:0,switchHistory:[],stateHistory:[]}}function Fg(a,b,c){for(var d in b){var e=b[d],f=c||!1;"text"==d&&(f=!0),a.Ua?a.B[d]={stream:e,zc:f}:Cf(a.a,d,e,f)}}function Ig(a){if(a.c){var b=Date.now()/1e3;a.ha?a.i.bufferingTime+=b-a.Pa:a.i.playTime+=b-a.Pa,a.Pa=b}}function xg(a,b){function c(a,b){if(!a)return null;var c=a.findSegmentPosition(b-e.startTime);return null==c?null:(c=a.getSegmentReference(c))?c.startTime+e.startTime:null}var d=zf(a.a),e=V(a.a),f=c(d.video,b),d=c(d.audio,b);return null!=f&&null!=d?Math.max(f,d):null!=f?f:null!=d?d:b}function Jg(a,b,c,d,e){if(!c||1>c.length)return a.ua(new t(2,4,4012)),{};a.b.abr.manager.setVariants(c),a.b.abr.manager.setTextStreams(d);var f=[];if(e&&(f=["video","audio"],b.textStreams.length&&f.push("text")),e=zf(a.a),b=dc(e.audio,e.video,b.variants)){b.allowedByApplication&&b.allowedByKeySystem||(f.push("audio"),f.push("video"));for(var g in e)b=e[g],"audio"==b.type&&b.language!=c[0].language?f.push(g):"text"==b.type&&0<d.length&&b.language!=d[0].language&&f.push(g)}if(f=f.filter(Aa),0<f.length){c={};try{c=a.b.abr.manager.chooseStreams(f)}catch(h){a.ua(h)}return c}return{}}function Cg(a,b){var f,c={audio:!1,text:!1},d=bc(b,a.fa,c),e=cc(b,a.ya,c),d=Jg(a,b,d,e);for(f in d)Eg(a,d[f],!0);Fg(a,d,!0),zg(a),d.text&&d.audio&&c.text&&d.text.language!=d.audio.language&&(a.A.mode="showing",Hg(a))}function zg(a){Promise.resolve().then(function(){this.I||this.dispatchEvent(new H("adaptation"))}.bind(a))}function yg(a){Promise.resolve().then(function(){this.I||this.dispatchEvent(new H("trackschanged"))}.bind(a))}function Hg(a){a.dispatchEvent(new H("texttrackvisibility"))}function X(a){this.a=ig(),this.f=a,this.i=Kg(this),this.b=null,this.v=!1,this.j=null,this.g=-1,this.l=0,this.c=null,this.h=new jg(this.a,a.o,a.getConfiguration().streaming.retryParameters,this.i)}function Lg(){return!!window.indexedDB}function Ng(a,b,c,d){function e(){}var h,l,n,f=a.f.o,g=a.f.getConfiguration();return Ld(b,f,g.manifest.retryParameters,d).then(function(a){return Y(this),n=new a,n.configure(g.manifest),n.start(b,{networkingEngine:f,filterPeriod:this.o.bind(this),onTimelineRegionAdded:function(){},onEvent:function(){},onError:c})}.bind(a)).then(function(a){return Y(this),h=a,l=new $a(f,c,e,function(){}),l.configure(g.drm),l.init(h,!0)}.bind(a)).then(function(){return Y(this),Pg(h)}.bind(a)).then(function(){return Y(this),db(l)}.bind(a)).then(function(){return Y(this),n.stop()}.bind(a)).then(function(){return Y(this),{manifest:h,Ac:l}}.bind(a))["catch"](function(a){if(n)return n.stop().then(function(){throw a});throw a})}function Kg(a){return{trackSelectionCallback:a.A.bind(a),progressCallback:function(a,c){return a||c?null:void 0}}}function Mg(a){return a.a?a.a.a?Promise.resolve():a.a.init(bg):Promise.reject(new t(2,9,9e3))}function Og(a){var b=a.b?a.b.m():Promise.resolve();return a.b=null,a.c=null,a.v=!1,a.j=null,a.g=-1,b}function Pg(a){var b=a.periods.map(function(a){return a.variants}).reduce(x,[]).map(function(a){var b=[];return a.audio&&b.push(a.audio),a.video&&b.push(a.video),b}).reduce(x,[]).filter(Aa);return a=a.periods.map(function(a){return a.textStreams}).reduce(x,[]),b.push.apply(b,a),Promise.all(b.map(function(a){return a.createSegmentIndex()}))}function Qg(a,b,c,d,e){for(var f=[],g=a.c.presentationTimeline.ja(),h=g,l=c.findSegmentPosition(g),n=null!=l?c.getSegmentReference(l):null;n;)h=a.a.b.segment++,kg(a.h,c.type,n,(n.endTime-n.startTime)*d/8,{key:h,data:null,manifestKey:a.g,streamNumber:c.id,segmentNumber:h}),f.push({startTime:n.startTime,endTime:n.endTime,uri:"offline:"+a.g+"/"+c.id+"/"+h}),h=n.endTime+b.startTime,n=c.getSegmentReference(++l);return a.l=Math.max(a.l,h-g),b=null,c.initSegmentReference&&(h=a.a.b.segment++,b="offline:"+a.g+"/"+c.id+"/"+h,kg(a.h,c.contentType,c.initSegmentReference,0,{key:h,data:null,manifestKey:a.g,streamNumber:c.id,segmentNumber:-1})),a=[],null!=e&&a.push(e),{id:c.id,primary:c.primary,presentationTimeOffset:c.presentationTimeOffset||0,
contentType:c.type,mimeType:c.mimeType,codecs:c.codecs,frameRate:c.frameRate,kind:c.kind,language:c.language,width:c.width||null,height:c.height||null,initSegmentUri:b,encrypted:c.encrypted,keyId:c.keyId,segments:f,variantIds:a}}function Y(a){if(!a.f)throw new t(2,9,9002)}function Sg(a){Rg.push(a)}function Tg(a){var c,b=a.type.replace(/^(webkit|moz|MS)/,"").toLowerCase();"function"==typeof Event?c=new Event(b,a):(c=document.createEvent("Event"),c.initEvent(b,a.bubbles,a.cancelable)),a.target.dispatchEvent(c)}function Ug(a){this.f=[],this.b=[],this.a=[],(new Q).$("pssh",this.c.bind(this)).parse(a.buffer)}function Vg(a,b){try{var c=new Wg(a,b);return Promise.resolve(c)}catch(d){return Promise.reject(d)}}function Wg(a,b){this.keySystem=a;for(var c=!1,d=0;d<b.length;++d){var e=b[d],f={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:e.initDataTypes,sessionTypes:["temporary"],label:e.label},g=!1;if(e.audioCapabilities)for(var h=0;h<e.audioCapabilities.length;++h){var l=e.audioCapabilities[h];if(l.contentType){var g=!0,n=l.contentType.split(";")[0];MSMediaKeys.isTypeSupported(this.keySystem,n)&&(f.audioCapabilities.push(l),c=!0)}}if(e.videoCapabilities)for(h=0;h<e.videoCapabilities.length;++h)l=e.videoCapabilities[h],l.contentType&&(g=!0,n=l.contentType.split(";")[0],MSMediaKeys.isTypeSupported(this.keySystem,n)&&(f.videoCapabilities.push(l),c=!0));if(g||(c=MSMediaKeys.isTypeSupported(this.keySystem,"video/mp4")),"required"==e.persistentState&&(f.persistentState="required",f.sessionTypes=["persistent-license"]),c)return void(this.a=f)}throw c=Error("Unsupported keySystem"),c.name="NotSupportedError",c.code=DOMException.NOT_SUPPORTED_ERR,c}function Yg(a){var b=this.mediaKeys;return b&&b!=a&&Zg(b,null),delete this.mediaKeys,(this.mediaKeys=a)?Zg(a,this):Promise.resolve()}function Xg(a){this.a=new MSMediaKeys(a),this.b=new D}function Zg(a,b){function c(){b.msSetMediaKeys(d.a),b.removeEventListener("loadedmetadata",c)}if(Ia(a.b),!b)return Promise.resolve();E(a.b,b,"msneedkey",ah);var d=a;try{return 1<=b.readyState?b.msSetMediaKeys(a.a):b.addEventListener("loadedmetadata",c),Promise.resolve()}catch(e){return Promise.reject(e)}}function $g(a){p.call(this),this.c=null,this.g=a,this.b=this.a=null,this.f=new D,this.sessionId="",this.expiration=0/0,this.closed=new A,this.keyStatuses=new bh}function ah(a){var b=document.createEvent("CustomEvent");if(b.initCustomEvent("encrypted",!1,!1,null),b.initDataType="cenc",a=a.initData){var c=new Ug(a);if(!(1>=c.a.length)){for(var d=[],e=0;e<c.a.length;e++)d.push(a.subarray(c.a[e].start,c.a[e].end+1));for(e=dh,a=[],c=0;c<d.length;++c){for(var f=!1,g=0;g<a.length&&!(f=e?e(d[c],a[g]):d[c]===a[g]);++g);f||a.push(d[c])}for(e=d=0;e<a.length;e++)d+=a[e].length;for(d=new Uint8Array(d),e=c=0;e<a.length;e++)d.set(a[e],c),c+=a[e].length;a=d}}b.initData=a,this.dispatchEvent(b)}function dh(a,b){return Za(a,b)}function ch(a,b){a.keyStatuses.Bb(b),a.dispatchEvent(new H("keystatuseschange"))}function bh(){this.size=0,this.a=void 0}function fh(){return Promise.reject(Error("The key system specified is not supported."))}function gh(a){return a?Promise.reject(Error("MediaKeys not supported.")):Promise.resolve()}function hh(){throw new TypeError("Illegal constructor.")}function ih(){throw new TypeError("Illegal constructor.")}function kh(a){jh=a,lh=new Uint8Array([0]).buffer,navigator.requestMediaKeySystemAccess=mh,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=nh,window.MediaKeys=oh,window.MediaKeySystemAccess=ph}function qh(a){var b=jh;return b?b+a.charAt(0).toUpperCase()+a.slice(1):a}function mh(a,b){try{var c=new ph(a,b);return Promise.resolve(c)}catch(d){return Promise.reject(d)}}function nh(a){var b=this.mediaKeys;return b&&b!=a&&rh(b,null),delete this.mediaKeys,(this.mediaKeys=a)&&rh(a,this),Promise.resolve()}function ph(a,b){this.a=this.keySystem=a;var c=!0;"org.w3.clearkey"==a&&(this.a="webkit-org.w3.clearkey",c=!1);var e,d=!1;e=document.getElementsByTagName("video"),e=e.length?e[0]:document.createElement("video");for(var f=0;f<b.length;++f){var g=b[f],h={audioCapabilities:[],videoCapabilities:[],persistentState:"optional",distinctiveIdentifier:"optional",initDataTypes:g.initDataTypes,sessionTypes:["temporary"],label:g.label},l=!1;if(g.audioCapabilities)for(var n=0;n<g.audioCapabilities.length;++n){var q=g.audioCapabilities[n];if(q.contentType){var l=!0,r=q.contentType.split(";")[0];e.canPlayType(r,this.a)&&(h.audioCapabilities.push(q),d=!0)}}if(g.videoCapabilities)for(n=0;n<g.videoCapabilities.length;++n)q=g.videoCapabilities[n],q.contentType&&(l=!0,e.canPlayType(q.contentType,this.a)&&(h.videoCapabilities.push(q),d=!0));if(l||(d=e.canPlayType("video/mp4",this.a)||e.canPlayType("video/webm",this.a)),"required"==g.persistentState&&(c?(h.persistentState="required",h.sessionTypes=["persistent-license"]):d=!1),d)return void(this.b=h)}throw c="Unsupported keySystem",("org.w3.clearkey"==a||"com.widevine.alpha"==a)&&(c="None of the requested configurations were supported."),c=Error(c),c.name="NotSupportedError",c.code=DOMException.NOT_SUPPORTED_ERR,c}function oh(a){this.g=a,this.b=null,this.a=new D,this.c=[],this.f={}}function rh(a,b){a.b=b,Ia(a.a);var c=jh;b&&(E(a.a,b,c+"needkey",a.qd.bind(a)),E(a.a,b,c+"keymessage",a.pd.bind(a)),E(a.a,b,c+"keyadded",a.nd.bind(a)),E(a.a,b,c+"keyerror",a.od.bind(a)))}function th(a,b){var c=a.f[b];return c?c:(c=a.c.shift())?(c.sessionId=b,a.f[b]=c):null}function sh(a,b,c){p.call(this),this.f=a,this.h=!1,this.a=this.b=null,this.c=b,this.g=c,this.sessionId="",this.expiration=0/0,this.closed=new A,this.keyStatuses=new vh}function wh(a,b,c){if(a.h)return Promise.reject(Error("The session is already initialized."));a.h=!0;var d;try{if("persistent-license"==a.g)if(c)d=new Uint8Array(Sa("LOAD_SESSION|"+c));else{var e=Sa("PERSISTENT|"),f=new Uint8Array(e.byteLength+b.byteLength);f.set(new Uint8Array(e),0),f.set(new Uint8Array(b),e.byteLength),d=f}else d=new Uint8Array(b)}catch(h){return Promise.reject(h)}a.b=new A;var g=qh("generateKeyRequest");try{a.f[g](a.c,d)}catch(h){if("InvalidStateError"!=h.name)return a.b=null,Promise.reject(h);setTimeout(function(){try{this.f[g](this.c,d)}catch(l){this.b.reject(l),this.b=null}}.bind(a),10)}return a.b}function uh(a,b){a.keyStatuses.Bb(b),a.dispatchEvent(new H("keystatuseschange"))}function vh(){this.size=0,this.a=void 0}function xh(){var a=MediaSource.prototype.addSourceBuffer;MediaSource.prototype.addSourceBuffer=function(){var b=a.apply(this,arguments);return b.abort=function(){},b}}function yh(){var a=MediaSource.prototype.endOfStream;MediaSource.prototype.endOfStream=function(){for(var b=0,d=0;d<this.sourceBuffers.length;++d)var e=this.sourceBuffers[d],e=e.buffered.end(e.buffered.length-1),b=Math.max(b,e);if(!isNaN(this.duration)&&b<this.duration)for(this.Qb=!0,d=0;d<this.sourceBuffers.length;++d)e=this.sourceBuffers[d],e.Kb=!1;return a.apply(this,arguments)};var b=MediaSource.prototype.addSourceBuffer;MediaSource.prototype.addSourceBuffer=function(){var a=b.apply(this,arguments);return a.K=this,a.addEventListener("updateend",zh,!1),this.a||(this.addEventListener("sourceclose",Ah,!1),this.a=!0),a}}function zh(a){var b=a.target,c=b.K;if(c.Qb){for(a.preventDefault(),a.stopPropagation(),a.stopImmediatePropagation(),b.Kb=!0,a=0;a<c.sourceBuffers.length;++a)if(0==c.sourceBuffers[a].Kb)return;c.Qb=!1}}function Ah(a){a=a.target;for(var b=0;b<a.sourceBuffers.length;++b)a.sourceBuffers[b].removeEventListener("updateend",zh,!1);a.removeEventListener("sourceclose",Ah,!1)}function Z(a){if(this.c=[],this.b=[],this.wa=Bh,a)try{a(this.ca.bind(this),this.a.bind(this))}catch(b){this.a(b)}}function Ch(a){var b=new Z;return b.ca(void 0),b.then(function(){return a})}function Dh(a){var b=new Z;return b.a(a),b}function Eh(a){function b(a,b,c){a.wa==Bh&&(e[b]=c,d++,d==e.length&&a.ca(e))}var c=new Z;if(!a.length)return c.ca([]),c;for(var d=0,e=Array(a.length),f=c.a.bind(c),g=0;g<a.length;++g)a[g]&&a[g].then?a[g].then(b.bind(null,c,g),f):b(c,g,a[g]);return c}function Fh(a){for(var b=new Z,c=b.ca.bind(b),d=b.a.bind(b),e=0;e<a.length;++e)a[e]&&a[e].then?a[e].then(c,d):c(a[e]);return b}function Gh(a,b,c){Hh.push(function(){if(c&&"function"==typeof c){try{var a=c(this.eb)}catch(f){return void b.a(f)}var e;try{e=a&&a.then}catch(f){return void b.a(f)}a instanceof Z?a==b?b.a(new TypeError("Chaining cycle detected")):a.then(b.ca.bind(b),b.a.bind(b)):e?Ih(a,e,b):b.ca(a)}else 1==this.wa?b.ca(this.eb):b.a(this.eb)}.bind(a)),null==Jh&&(Jh=Kh(Lh))}function Ih(a,b,c){try{var d=!1;b.call(a,function(a){if(!d){d=!0;var b;try{b=a&&a.then}catch(g){return void c.a(g)}b?Ih(a,b,c):c.ca(a)}},c.a.bind(c))}catch(e){c.a(e)}}function Lh(){for(;Hh.length;){null!=Jh&&(Mh(Jh),Jh=null);var a=Hh;Hh=[];for(var b=0;b<a.length;++b)a[b]()}}function Kh(){return 0}function Mh(){}function Nh(){return{droppedVideoFrames:this.webkitDroppedFrameCount,totalVideoFrames:this.webkitDecodedFrameCount,corruptedVideoFrames:0,creationTime:0/0,totalFrameDelay:0}}function Oh(a,b,c){return new window.TextTrackCue(a,b,c)}function Ph(a,b,c){return new window.TextTrackCue(a+"-"+b+"-"+c,a,b,c)}var k,aa=this;aa.je=!0,fa.prototype.setDefaultEstimate=function(a){this.b=a},fa.prototype.getBandwidthEstimate=function(){return 128e3>this.a?this.b:Math.min(ea(this.c),ea(this.f))},m("shaka.util.Error",t),t.prototype.toString=function(){return"shaka.util.Error "+JSON.stringify(this,null,"  ")},t.Severity={RECOVERABLE:1,CRITICAL:2},t.Category={NETWORK:1,TEXT:2,MEDIA:3,MANIFEST:4,STREAMING:5,DRM:6,PLAYER:7,CAST:8,STORAGE:9},t.Code={UNSUPPORTED_SCHEME:1e3,BAD_HTTP_STATUS:1001,HTTP_ERROR:1002,TIMEOUT:1003,MALFORMED_DATA_URI:1004,UNKNOWN_DATA_URI_ENCODING:1005,REQUEST_FILTER_ERROR:1006,RESPONSE_FILTER_ERROR:1007,INVALID_TEXT_HEADER:2e3,INVALID_TEXT_CUE:2001,UNABLE_TO_DETECT_ENCODING:2003,BAD_ENCODING:2004,INVALID_XML:2005,INVALID_MP4_TTML:2007,INVALID_MP4_VTT:2008,BUFFER_READ_OUT_OF_BOUNDS:3e3,JS_INTEGER_OVERFLOW:3001,EBML_OVERFLOW:3002,EBML_BAD_FLOATING_POINT_SIZE:3003,MP4_SIDX_WRONG_BOX_TYPE:3004,MP4_SIDX_INVALID_TIMESCALE:3005,MP4_SIDX_TYPE_NOT_SUPPORTED:3006,WEBM_CUES_ELEMENT_MISSING:3007,WEBM_EBML_HEADER_ELEMENT_MISSING:3008,WEBM_SEGMENT_ELEMENT_MISSING:3009,WEBM_INFO_ELEMENT_MISSING:3010,WEBM_DURATION_ELEMENT_MISSING:3011,WEBM_CUE_TRACK_POSITIONS_ELEMENT_MISSING:3012,WEBM_CUE_TIME_ELEMENT_MISSING:3013,MEDIA_SOURCE_OPERATION_FAILED:3014,MEDIA_SOURCE_OPERATION_THREW:3015,VIDEO_ERROR:3016,QUOTA_EXCEEDED_ERROR:3017,UNABLE_TO_GUESS_MANIFEST_TYPE:4e3,DASH_INVALID_XML:4001,DASH_NO_SEGMENT_INFO:4002,DASH_EMPTY_ADAPTATION_SET:4003,DASH_EMPTY_PERIOD:4004,DASH_WEBM_MISSING_INIT:4005,DASH_UNSUPPORTED_CONTAINER:4006,DASH_PSSH_BAD_ENCODING:4007,DASH_NO_COMMON_KEY_SYSTEM:4008,DASH_MULTIPLE_KEY_IDS_NOT_SUPPORTED:4009,DASH_CONFLICTING_KEY_IDS:4010,UNPLAYABLE_PERIOD:4011,RESTRICTIONS_CANNOT_BE_MET:4012,NO_PERIODS:4014,HLS_PLAYLIST_HEADER_MISSING:4015,INVALID_HLS_TAG:4016,HLS_INVALID_PLAYLIST_HIERARCHY:4017,DASH_DUPLICATE_REPRESENTATION_ID:4018,HLS_MULTIPLE_MEDIA_INIT_SECTIONS_FOUND:4020,HLS_COULD_NOT_GUESS_MIME_TYPE:4021,HLS_MASTER_PLAYLIST_NOT_PROVIDED:4022,HLS_REQUIRED_ATTRIBUTE_MISSING:4023,HLS_REQUIRED_TAG_MISSING:4024,HLS_COULD_NOT_GUESS_CODECS:4025,HLS_KEYFORMATS_NOT_SUPPORTED:4026,INVALID_STREAMS_CHOSEN:5005,NO_RECOGNIZED_KEY_SYSTEMS:6e3,REQUESTED_KEY_SYSTEM_CONFIG_UNAVAILABLE:6001,FAILED_TO_CREATE_CDM:6002,FAILED_TO_ATTACH_TO_VIDEO:6003,INVALID_SERVER_CERTIFICATE:6004,FAILED_TO_CREATE_SESSION:6005,FAILED_TO_GENERATE_LICENSE_REQUEST:6006,LICENSE_REQUEST_FAILED:6007,LICENSE_RESPONSE_REJECTED:6008,ENCRYPTED_CONTENT_WITHOUT_DRM_INFO:6010,NO_LICENSE_SERVER_GIVEN:6012,OFFLINE_SESSION_REMOVED:6013,EXPIRED:6014,LOAD_INTERRUPTED:7e3,CAST_API_UNAVAILABLE:8e3,NO_CAST_RECEIVERS:8001,ALREADY_CASTING:8002,UNEXPECTED_CAST_ERROR:8003,CAST_CANCELED_BY_USER:8004,CAST_CONNECTION_TIMED_OUT:8005,CAST_RECEIVER_APP_UNAVAILABLE:8006,STORAGE_NOT_SUPPORTED:9e3,INDEXED_DB_ERROR:9001,OPERATION_ABORTED:9002,REQUESTED_ITEM_NOT_FOUND:9003,MALFORMED_OFFLINE_URI:9004,CANNOT_STORE_LIVE_OFFLINE:9005,STORE_ALREADY_IN_PROGRESS:9006,NO_INIT_DATA_FOR_OFFLINE:9007};var ha=/^(?:([^:\/?#.]+):)?(?:\/\/(?:([^\/?#]*)@)?([^\/#?]*?)(?::([0-9]+))?(?=[\/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/;k=ia.prototype,k.X="",k.xa="",k.Z="",k.Fa=null,k.U="",k.qa="",k.toString=function(){var a=[],b=this.X;if(b&&a.push(qa(b,ra,!0),":"),b=this.Z){a.push("//");var c=this.xa;c&&a.push(qa(c,ra,!0),"@"),a.push(encodeURIComponent(b).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),b=this.Fa,null!=b&&a.push(":",String(b))}return(b=this.U)&&(this.Z&&"/"!=b.charAt(0)&&a.push("/"),a.push(qa(b,"/"==b.charAt(0)?sa:ta,!0))),(b=this.a.toString())&&a.push("?",b),(b=this.qa)&&a.push("#",qa(b,ua)),a.join("")},k.resolve=function(a){var b=new ia(this);"data"===b.X&&(b=new ia);var c=!!a.X;c?ja(b,a.X):c=!!a.xa,c?b.xa=a.xa:c=!!a.Z,c?b.Z=a.Z:c=null!=a.Fa;var d=a.U;if(c)ka(b,a.Fa);else if(c=!!a.U){if("/"!=d.charAt(0))if(this.Z&&!this.U)d="/"+d;else{var e=b.U.lastIndexOf("/");-1!=e&&(d=b.U.substr(0,e+1)+d)}if(".."==d||"."==d)d="";else if(-1!=d.indexOf("./")||-1!=d.indexOf("/.")){for(var e=!d.lastIndexOf("/",0),d=d.split("/"),f=[],g=0;g<d.length;){var h=d[g++];"."==h?e&&g==d.length&&f.push(""):".."==h?((1<f.length||1==f.length&&""!=f[0])&&f.pop(),e&&g==d.length&&f.push("")):(f.push(h),e=!0)}d=f.join("/")}}return c?b.U=d:c=""!==a.a.toString(),c?la(b,ma(a.a)):c=!!a.qa,c&&(b.qa=a.qa),b};var ra=/[#\/\?@]/g,ta=/[\#\?:]/g,sa=/[\#\?]/g,va=/[\#\?@]/g,ua=/#/g;oa.prototype.a=null,oa.prototype.c=null,oa.prototype.toString=function(){if(this.b)return this.b;if(!this.a)return"";var b,a=[];for(b in this.a)for(var c=encodeURIComponent(b),d=this.a[b],e=0;e<d.length;e++){var f=c;""!==d[e]&&(f+="="+encodeURIComponent(d[e])),a.push(f)}return this.b=a.join("&")},m("shaka.net.NetworkingEngine",B),B.RequestType={MANIFEST:0,SEGMENT:1,LICENSE:2,APP:3};var Ea={};B.registerScheme=function(a,b){Ea[a]=b},B.unregisterScheme=function(a){delete Ea[a]},B.prototype.zd=function(a){this.b.push(a)},B.prototype.registerRequestFilter=B.prototype.zd,B.prototype.ce=function(a){var b=this.b;a=b.indexOf(a),a>=0&&b.splice(a,1)},B.prototype.unregisterRequestFilter=B.prototype.ce,B.prototype.xc=function(){this.b=[]},B.prototype.clearAllRequestFilters=B.prototype.xc,B.prototype.Ad=function(a){this.c.push(a)},B.prototype.registerResponseFilter=B.prototype.Ad,B.prototype.de=function(a){var b=this.c;a=b.indexOf(a),a>=0&&b.splice(a,1)},B.prototype.unregisterResponseFilter=B.prototype.de,B.prototype.yc=function(){this.c=[]},B.prototype.clearAllResponseFilters=B.prototype.yc,B.prototype.m=function(){this.f=!0,this.b=[],this.c=[];for(var a=[],b=0;b<this.a.length;++b)a.push(this.a[b]["catch"](y));return Promise.all(a)},B.prototype.destroy=B.prototype.m,B.prototype.request=function(a,b){if(this.f)return Promise.reject();b.method=b.method||"GET",b.headers=b.headers||{},b.retryParameters=b.retryParameters?Da(b.retryParameters):Fa(),b.uris=Da(b.uris);var c=Date.now(),d=Promise.resolve();return this.b.forEach(function(c){d=d.then(c.bind(null,a,b))}),d=d["catch"](function(a){throw new t(2,1,1006,a)}),d=d.then(function(){for(var d=Date.now()-c,f=b.retryParameters||{},g=f.maxAttempts||1,h=f.backoffFactor||2,f=null==f.baseDelay?1e3:f.baseDelay,l=this.g(a,b,0,d),n=1;g>n;n++)l=l["catch"](function(c,e,f){if(f&&1==f.severity){f=new A;var g=b.retryParameters||{};return window.setTimeout(f.resolve,c*(1+(2*Math.random()-1)*(null==g.fuzzFactor?.5:g.fuzzFactor))),f.then(this.g.bind(this,a,b,e,d))}throw f}.bind(this,f,n%b.uris.length)),f*=h;return l}.bind(this)),this.a.push(d),d.then(function(b){return 0<=this.a.indexOf(d)&&this.a.splice(this.a.indexOf(d),1),this.h&&!b.fromCache&&1==a&&this.h(b.timeMs,b.data.byteLength),b}.bind(this))["catch"](function(a){return a&&(a.severity=2),0<=this.a.indexOf(d)&&this.a.splice(this.a.indexOf(d),1),Promise.reject(a)}.bind(this))},B.prototype.request=B.prototype.request,B.prototype.g=function(a,b,c,d){if(this.f)return Promise.reject();var e=new ia(b.uris[c]),f=e.X;if(f||(f=location.protocol,f=f.slice(0,-1),ja(e,f),b.uris[c]=e.toString()),f=Ea[f],!f)return Promise.reject(new t(2,1,1e3,e));var g=Date.now();return f(b.uris[c],b,a).then(function(b){void 0==b.timeMs&&(b.timeMs=Date.now()-g);var c=Date.now(),e=Promise.resolve();return this.c.forEach(function(c){e=e.then(function(){return Promise.resolve(c(a,b))}.bind(this))}),e=e["catch"](function(a){var b=2;throw a instanceof t&&(b=a.severity),new t(b,1,1007,a)}),e.then(function(){return b.timeMs+=Date.now()-c,b.timeMs+=d,b})}.bind(this))},Ha.prototype.push=function(a,b){this.a.hasOwnProperty(a)?this.a[a].push(b):this.a[a]=[b]},Ha.prototype.get=function(a){return(a=this.a[a])?a.slice():null},Ha.prototype.remove=function(a,b){var c=this.a[a];if(c)for(var d=0;d<c.length;++d)c[d]==b&&(c.splice(d,1),--d)},D.prototype.m=function(){return Ia(this),this.a=null,Promise.resolve()},D.prototype.ea=function(a,b){if(this.a)for(var c=this.a.get(b)||[],d=0;d<c.length;++d){var e=c[d];e.target==a&&(e.ea(),this.a.remove(b,e))}},Ja.prototype.ea=function(){this.target.removeEventListener(this.type,this.a,!1),this.a=this.target=null},m("shaka.util.StringUtils.fromUTF8",F),m("shaka.util.StringUtils.fromUTF16",Qa),m("shaka.util.StringUtils.fromBytesAutoDetect",Ra),m("shaka.util.StringUtils.toUTF8",Sa),Ta.prototype.cancel=function(){null!=this.a&&(clearTimeout(this.a),this.a=null)},m("shaka.util.Uint8ArrayUtils.toBase64",Va),m("shaka.util.Uint8ArrayUtils.fromBase64",Wa),m("shaka.util.Uint8ArrayUtils.fromHex",Xa),m("shaka.util.Uint8ArrayUtils.toHex",Ya),m("shaka.util.Uint8ArrayUtils.equal",Za),m("shaka.util.Uint8ArrayUtils.concat",function(){for(var b=0,c=0;c<arguments.length;++c)b+=arguments[c].length;for(var b=new Uint8Array(b),d=0,c=0;c<arguments.length;++c)b.set(arguments[c],d),d+=arguments[c].length;return b}),k=$a.prototype,k.m=function(){this.c=!0;var a=this.a.map(function(a){return(a.Y.close()||Promise.resolve())["catch"](y)});return this.l.reject(),this.f&&a.push(this.f.m()),this.j&&a.push(this.j.setMediaKeys(null)["catch"](y)),this.I&&(clearInterval(this.I),this.I=null),this.A&&this.A.cancel(),this.f=this.j=this.i=this.v=this.b=this.A=null,this.a=[],this.o=[],this.ia=this.g=this.h=this.ha=null,Promise.all(a)},k.configure=function(a){this.h=a},k.init=function(a,b){var c={},d=[];return this.ga=b,this.o=a.offlineSessionIds,ab(this,a,b||0<a.offlineSessionIds.length,c,d),d.length?bb(this,c,d):(this.F=!0,Promise.resolve())},k.keySystem=function(){return this.b?this.b.keySystem:""},k.Wa=function(){var a=this.a.map(function(a){return a=a.Y.expiration,isNaN(a)?1/0:a});return Math.min.apply(Math,a)},k.Uc=function(a){for(var b=new Uint8Array(a.initData),c=0;c<this.a.length;++c)if(Za(b,this.a[c].initData))return;gb(this,a.initDataType,b)},k.bc=function(a){this.h.delayLicenseRequestUntilPlayed&&this.j.paused&&!this.fa?this.B.push(a):mb(this,a)},k.Wb=function(a){a=a.target;var b;for(b=0;b<this.a.length&&this.a[b].Y!=a;++b);if(b!=this.a.length){var c=!1;a.keyStatuses.forEach(function(a,d){if("string"==typeof d){var e=d;d=a,a=e}if("com.microsoft.playready"==this.b.keySystem&&16==d.byteLength){var e=new DataView(d),f=e.getUint32(0,!0),l=e.getUint16(4,!0),n=e.getUint16(6,!0);e.setUint32(0,f,!1),e.setUint16(4,l,!1),e.setUint16(6,n,!1)}"com.microsoft.playready"==this.b.keySystem&&"status-pending"==a&&(a="usable"),"status-pending"!=a&&(this.a[b].loaded=!0,this.a.every(function(a){return a.loaded})&&this.l.resolve()),"expired"==a&&(c=!0),e=Ya(new Uint8Array(d)),this.M[e]=a}.bind(this));var d=a.expiration-Date.now();(0>d||c&&1e3>d)&&!this.a[b].cb&&(this.a.splice(b,1),a.close()),Ua(this.A)}},k.yd=function(){Oa(this.M,function(a,b){return"expired"==b})&&this.g(new t(2,6,6014)),this.ya(this.M)},k.dd=function(){for(var a=0;a<this.B.length;a++)mb(this,this.B[a]);this.fa=!0,this.B=[]},k.xd=function(){this.a.forEach(function(a){var b=a.sb,c=a.Y.expiration;isNaN(c)&&(c=1/0),c!=b&&(this.ia(a.Y.sessionId,c),a.sb=c)}.bind(this))};var sb={};m("shaka.media.TextEngine.registerParser",tb),m("shaka.media.TextEngine.unregisterParser",function(a){delete sb[a]}),m("shaka.media.TextEngine.makeCue",vb),rb.prototype.m=function(){return this.c&&wb(this,function(){return!0}),this.c=this.f=null,Promise.resolve()},rb.prototype.remove=function(a,b){return Promise.resolve().then(function(){this.c&&(wb(this,function(c){return c.startTime>=b||c.endTime<=a?!1:!0}),null==this.b||b<=this.b||a>=this.a||(a<=this.b&&b>=this.a?this.b=this.a=null:a<=this.b&&b<this.a?this.b=b:a>this.b&&b>=this.a&&(this.a=a)))}.bind(this))},ub.prototype.parseInit=function(a){this.Ja(a,0,null,null)},ub.prototype.parseMedia=function(a,b){return this.Ja(a,b.periodStart,b.segmentStart,b.segmentEnd)},k=Bb.prototype,k.m=function(){this.h=!0;var b,a=[];for(b in this.b){var c=this.b[b],d=c[0];for(this.b[b]=c.slice(0,1),d&&a.push(d.p["catch"](y)),d=1;d<c.length;++d)c[d].p["catch"](y),c[d].p.reject()}return this.a&&a.push(this.a.m()),Promise.all(a).then(function(){this.g.m(),this.a=this.i=this.K=this.f=this.g=null,this.c={},this.b={}}.bind(this))},k.init=function(a){for(var b in a){var c=a[b];"text"==b?Db(this,c):(c=this.K.addSourceBuffer(c),E(this.g,c,"error",this.Yd.bind(this,b)),E(this.g,c,"updateend",this.Ea.bind(this,b)),this.c[b]=c,this.b[b]=[])}},k.remove=function(a,b,c){return"text"==a?this.a.remove(b,c):Hb(this,a,this.fc.bind(this,a,b,c))},k.endOfStream=function(a){return Lb(this,function(){a?this.K.endOfStream(a):this.K.endOfStream()}.bind(this))},k.ma=function(a){return Lb(this,function(){this.K.duration=a}.bind(this))},k.W=function(){return this.K.duration},k.Xd=function(a,b){this.c[a].appendBuffer(b)},k.fc=function(a,b,c){b>=c?this.Ea(a):this.c[a].remove(b,c)},k.tc=function(a){var b=this.c[a].appendWindowEnd;this.c[a].abort(),this.c[a].appendWindowEnd=b,this.Ea(a)},k.Dc=function(a){this.f.currentTime-=.001,this.Ea(a)},k.Nd=function(a,b){this.c[a].timestampOffset=b,this.Ea(a)},k.Ld=function(a,b){this.c[a].appendWindowEnd=b+.04,this.Ea(a)},k.Yd=function(a){this.b[a][0].p.reject(new t(2,3,3014,this.f.error?this.f.error.code:0))},k.Ea=function(a){var b=this.b[a][0];b&&(b.p.resolve(),Mb(this,a))};var Ob=1,Pb=2,Rb={aar:"aa",abk:"ab",afr:"af",aka:"ak",alb:"sq",amh:"am",ara:"ar",arg:"an",arm:"hy",asm:"as",ava:"av",ave:"ae",aym:"ay",aze:"az",bak:"ba",bam:"bm",baq:"eu",bel:"be",ben:"bn",bih:"bh",bis:"bi",bod:"bo",bos:"bs",bre:"br",bul:"bg",bur:"my",cat:"ca",ces:"cs",cha:"ch",che:"ce",chi:"zh",chu:"cu",chv:"cv",cor:"kw",cos:"co",cre:"cr",cym:"cy",cze:"cs",dan:"da",deu:"de",div:"dv",dut:"nl",dzo:"dz",ell:"el",eng:"en",epo:"eo",est:"et",eus:"eu",ewe:"ee",fao:"fo",fas:"fa",fij:"fj",fin:"fi",fra:"fr",fre:"fr",fry:"fy",ful:"ff",geo:"ka",ger:"de",gla:"gd",gle:"ga",glg:"gl",glv:"gv",gre:"el",grn:"gn",guj:"gu",hat:"ht",hau:"ha",heb:"he",her:"hz",hin:"hi",hmo:"ho",hrv:"hr",hun:"hu",hye:"hy",ibo:"ig",ice:"is",ido:"io",iii:"ii",iku:"iu",ile:"ie",ina:"ia",ind:"id",ipk:"ik",isl:"is",ita:"it",jav:"jv",jpn:"ja",kal:"kl",kan:"kn",kas:"ks",kat:"ka",kau:"kr",kaz:"kk",khm:"km",kik:"ki",kin:"rw",kir:"ky",kom:"kv",kon:"kg",kor:"ko",kua:"kj",kur:"ku",lao:"lo",lat:"la",lav:"lv",lim:"li",lin:"ln",lit:"lt",ltz:"lb",lub:"lu",lug:"lg",mac:"mk",mah:"mh",mal:"ml",mao:"mi",mar:"mr",may:"ms",mkd:"mk",mlg:"mg",mlt:"mt",mon:"mn",mri:"mi",msa:"ms",mya:"my",nau:"na",nav:"nv",nbl:"nr",nde:"nd",ndo:"ng",nep:"ne",nld:"nl",nno:"nn",nob:"nb",nor:"no",nya:"ny",oci:"oc",oji:"oj",ori:"or",orm:"om",oss:"os",pan:"pa",per:"fa",pli:"pi",pol:"pl",por:"pt",pus:"ps",que:"qu",roh:"rm",ron:"ro",rum:"ro",run:"rn",rus:"ru",sag:"sg",san:"sa",sin:"si",slk:"sk",slo:"sk",slv:"sl",sme:"se",smo:"sm",sna:"sn",snd:"sd",som:"so",sot:"st",spa:"es",sqi:"sq",srd:"sc",srp:"sr",ssw:"ss",sun:"su",swa:"sw",swe:"sv",tah:"ty",tam:"ta",tat:"tt",tel:"te",tgk:"tg",tgl:"tl",tha:"th",tib:"bo",tir:"ti",ton:"to",tsn:"tn",tso:"ts",tuk:"tk",tur:"tr",twi:"tw",uig:"ug",ukr:"uk",urd:"ur",uzb:"uz",ven:"ve",vie:"vi",vol:"vo",wel:"cy",wln:"wa",wol:"wo",xho:"xh",yid:"yi",yor:"yo",zha:"za",zho:"zh",zul:"zu"};m("shaka.abr.SimpleAbrManager",G),G.prototype.stop=function(){this.f=null,this.b=!1,this.h=[],this.g=[],this.c=null},G.prototype.stop=G.prototype.stop,G.prototype.init=function(a){this.f=a},G.prototype.init=G.prototype.init,G.prototype.chooseStreams=function(a){var b={};if(-1<a.indexOf("audio")||-1<a.indexOf("video")){var c,d=this.h;c=hc(this.i,d);var e=this.a.getBandwidthEstimate();if(d.length&&!c.length)throw new t(2,4,4012);for(var d=c[0],f=0;f<c.length;++f){var g=c[f],h=(c[f+1]||{bandwidth:1/0}).bandwidth/.85;e>=g.bandwidth/.95&&h>=e&&(d=g)}(c=d)&&c.video&&(b.video=c.video),c&&c.audio&&(b.audio=c.audio)}return-1<a.indexOf("text")&&(b.text=this.g[0]),this.c=Date.now(),b},G.prototype.chooseStreams=G.prototype.chooseStreams,G.prototype.enable=function(){this.b=!0},G.prototype.enable=G.prototype.enable,G.prototype.disable=function(){this.b=!1},G.prototype.disable=G.prototype.disable,G.prototype.segmentDownloaded=function(a,b){var c=this.a;if(!(16e3>b)){var d=8e3*b/a,e=a/1e3;c.a+=b,da(c.c,e,d),da(c.f,e,d)}if(null!=this.c&&this.b)a:{if(this.j){if(8e3>Date.now()-this.c)break a}else{if(!(128e3<=this.a.a))break a;this.j=!0}c=this.chooseStreams(["audio","video"]),this.a.getBandwidthEstimate(),this.f(c)}},G.prototype.segmentDownloaded=G.prototype.segmentDownloaded,G.prototype.getBandwidthEstimate=function(){return this.a.getBandwidthEstimate()},G.prototype.getBandwidthEstimate=G.prototype.getBandwidthEstimate,G.prototype.setDefaultEstimate=function(a){this.a.setDefaultEstimate(a)},G.prototype.setDefaultEstimate=G.prototype.setDefaultEstimate,G.prototype.setRestrictions=function(a){this.i=a},G.prototype.setRestrictions=G.prototype.setRestrictions,G.prototype.setVariants=function(a){this.h=a},G.prototype.setVariants=G.prototype.setVariants,G.prototype.setTextStreams=function(a){this.g=a},G.prototype.setTextStreams=G.prototype.setTextStreams,H.prototype.preventDefault=function(){this.cancelable&&(this.defaultPrevented=!0)},H.prototype.stopImmediatePropagation=function(){this.a=!0},H.prototype.stopPropagation=function(){};var ic="ended play playing pause pausing ratechange seeked seeking timeupdate volumechange".split(" "),jc="buffered currentTime duration ended loop muted paused playbackRate seeking videoHeight videoWidth volume".split(" "),kc=["loop","playbackRate"],lc=["pause","play"],mc="adaptation buffering emsg error loading unloading texttrackvisibility timelineregionadded timelineregionenter timelineregionexit trackschanged".split(" "),nc="drmInfo getAudioLanguages getConfiguration getExpiration getManifestUri getPlaybackRate getPlayheadTimeAsDate getTextLanguages getTextTracks getTracks getStats getVariantTracks isBuffering isInProgress isLive isTextTrackVisible keySystem seekRange".split(" "),oc=[["getConfiguration","configure"]],pc=[["isTextTrackVisible","setTextTrackVisibility"]],qc="addTextTrack cancelTrickPlay configure resetConfiguration selectAudioLanguage selectTextLanguage selectTextTrack selectTrack selectVariantTrack setTextTrackVisibility trickPlay".split(" "),rc=["load","unload"];k=vc.prototype,k.m=function(){return wc(this),this.a&&(this.a.leave(function(){},function(){}),this.a=null),this.F=this.B=this.l=null,this.c=this.j=this.h=!1,this.g=this.f=this.b=this.i=null,Promise.resolve()},k.T=function(){return this.c},k.wb=function(){return this.A},k.init=function(){if(window.chrome&&chrome.cast&&chrome.cast.isAvailable){delete window.__onGCastApiAvailable,this.h=!0,this.l();var a=new chrome.cast.SessionRequest(this.I),a=new chrome.cast.ApiConfig(a,this.Vc.bind(this),this.fd.bind(this),"origin_scoped");chrome.cast.initialize(a,function(){},function(){})}else window.__onGCastApiAvailable=function(a){a&&this.init()}.bind(this)},k.zb=function(a){this.i=a,this.c&&xc(this,{type:"appData",appData:this.i})},k.cast=function(a){return this.h?this.j?this.c?Promise.reject(new t(1,8,8002)):(this.g=new A,chrome.cast.requestSession(this.ub.bind(this,a),this.Ub.bind(this)),this.g):Promise.reject(new t(1,8,8001)):Promise.reject(new t(1,8,8e3))},k.Va=function(){this.c&&(wc(this),this.a&&(this.a.stop(function(){},function(){}),this.a=null))},k.get=function(a,b){if("video"==a){if(0<=lc.indexOf(b))return this.ec.bind(this,a,b)}else if("player"==a){if(0<=qc.indexOf(b))return this.ec.bind(this,a,b);if(0<=rc.indexOf(b))return this.Cd.bind(this,a,b);if(0<=nc.indexOf(b))return this.cc.bind(this,a,b)}return this.cc(a,b)},k.set=function(a,b,c){this.b[a][b]=c,xc(this,{type:"set",targetName:a,property:b,value:c})},k.ub=function(a,b){this.a=b,this.a.addUpdateListener(this.Vb.bind(this)),this.a.addMessageListener("urn:x-cast:com.google.shaka.v2",this.$c.bind(this)),this.Vb(),xc(this,{type:"init",initState:a,appData:this.i}),this.g.resolve()},k.Ub=function(a){var b=8003;switch(a.code){case"cancel":b=8004;break;case"timeout":b=8005;break;case"receiver_unavailable":b=8006}this.g.reject(new t(2,8,b,a))},k.cc=function(a,b){return this.b[a][b]},k.ec=function(a,b){xc(this,{type:"call",targetName:a,methodName:b,args:Array.prototype.slice.call(arguments,2)})},k.Cd=function(a,b){var c=Array.prototype.slice.call(arguments,2),d=new A,e=this.o.toString();return this.o++,this.f[e]=d,xc(this,{type:"asyncCall",targetName:a,methodName:b,args:c,id:e}),d},k.Vc=function(a){var b=this.v();this.g=new A,this.ub(b,a)},k.fd=function(a){this.j="available"==a,this.l()},k.Vb=function(){var a=this.a?"connected"==this.a.status:!1;if(this.c&&!a){this.F();for(var b in this.b)this.b[b]={};wc(this)}this.A=(this.c=a)?this.a.receiver.friendlyName:"",this.l()},k.$c=function(a,b){var c=tc(b);switch(c.type){case"event":var d=c.targetName,e=c.event;this.B(d,new H(e.type,e));break;case"update":e=c.update;for(d in e){var f,c=this.b[d]||{};for(f in e[d])c[f]=e[d][f]}break;case"asyncComplete":if(d=c.id,f=c.error,c=this.f[d],delete this.f[d],c)if(f){d=new t(f.severity,f.category,f.code);for(e in f)d[e]=f[e];c.reject(d)}else c.resolve()}},p.prototype.addEventListener=function(a,b){this.gb.push(a,b)},p.prototype.removeEventListener=function(a,b){this.gb.remove(a,b)},p.prototype.dispatchEvent=function(a){for(var b=this.gb.get(a.type)||[],c=0;c<b.length;++c){a.target=this.Oa,a.currentTarget=this.Oa;var d=b[c];try{d.handleEvent?d.handleEvent(a):d.call(this,a)}catch(e){}if(a.a)break}return a.defaultPrevented},ba(I),m("shaka.cast.CastProxy",I),I.prototype.m=function(a){return a&&this.a&&this.a.Va(),a=[this.h?this.h.m():null,this.b?this.b.m():null,this.a?this.a.m():null],this.a=this.h=this.i=this.j=this.b=this.c=null,Promise.all(a)},I.prototype.destroy=I.prototype.m,I.prototype.Mc=function(){return this.j},I.prototype.getVideo=I.prototype.Mc,I.prototype.Hc=function(){return this.i},I.prototype.getPlayer=I.prototype.Hc,I.prototype.uc=function(){return this.a?this.a.h&&this.a.j:!1},I.prototype.canCast=I.prototype.uc,I.prototype.T=function(){return this.a?this.a.T():!1},I.prototype.isCasting=I.prototype.T,I.prototype.wb=function(){return this.a?this.a.wb():""},I.prototype.receiverName=I.prototype.wb,I.prototype.cast=function(){var a=this.Mb();return this.a.cast(a).then(function(){return this.b.bb()}.bind(this))},I.prototype.cast=I.prototype.cast,I.prototype.zb=function(a){this.a.zb(a)},I.prototype.setAppData=I.prototype.zb,I.prototype.ae=function(){var a=this.a;if(a.c){var b=a.v();chrome.cast.requestSession(a.ub.bind(a,b),a.Ub.bind(a))}},I.prototype.suggestDisconnect=I.prototype.ae,I.prototype.Va=function(){this.a.Va()},I.prototype.forceDisconnect=I.prototype.Va,k=I.prototype,k.Mb=function(){var a={video:{},player:{},playerAfterLoad:{},manifest:this.b.Ta,startTime:null};return this.c.pause(),kc.forEach(function(b){a.video[b]=this.c[b]}.bind(this)),this.c.ended||(a.startTime=this.c.currentTime),oc.forEach(function(b){var c=b[1];b=this.b[b[0]](),a.player[c]=b}.bind(this)),pc.forEach(function(b){var c=b[1];b=this.b[b[0]](),a.playerAfterLoad[c]=b}.bind(this)),a},k.Td=function(){this.dispatchEvent(new H("caststatuschanged"))},k.Vd=function(){oc.forEach(function(a){var b=a[1];a=this.a.get("player",a[0])(),this.b[b](a);

}.bind(this));var a=this.a.get("player","getManifestUri")(),b=this.a.get("video","ended"),c=Promise.resolve(),d=this.c.autoplay,e=null;b||(e=this.a.get("video","currentTime")),a&&(this.c.autoplay=!1,c=this.b.load(a,e),c["catch"](function(a){this.b.dispatchEvent(new H("error",{detail:a}))}.bind(this)));var f={};kc.forEach(function(a){f[a]=this.a.get("video",a)}.bind(this)),c.then(function(){kc.forEach(function(a){this.c[a]=f[a]}.bind(this)),pc.forEach(function(a){var b=a[1];a=this.a.get("player",a[0])(),this.b[b](a)}.bind(this)),this.c.autoplay=d,a&&this.c.play()}.bind(this))},k.ge=function(a){if("addEventListener"==a)return this.g.addEventListener.bind(this.g);if("removeEventListener"==a)return this.g.removeEventListener.bind(this.g);if(this.a.T()&&!Object.keys(this.a.b.video).length){var b=this.c[a];if("function"!=typeof b)return b}return this.a.T()?this.a.get("video",a):(b=this.c[a],"function"==typeof b&&(b=b.bind(this.c)),b)},k.ie=function(a,b){this.a.T()?this.a.set("video",a,b):this.c[a]=b},k.he=function(a){this.a.T()||this.g.dispatchEvent(new H(a.type,a))},k.vd=function(a){return"addEventListener"==a?this.f.addEventListener.bind(this.f):"removeEventListener"==a?this.f.removeEventListener.bind(this.f):"getNetworkingEngine"==a?this.b.Nb.bind(this.b):this.a.T()&&!Object.keys(this.a.b.video).length&&0<=nc.indexOf(a)||!this.a.T()?(a=this.b[a],a.bind(this.b)):this.a.get("player",a)},k.wd=function(a){this.a.T()||this.f.dispatchEvent(a)},k.Ud=function(a,b){this.a.T()&&("video"==a?this.g.dispatchEvent(b):"player"==a&&this.f.dispatchEvent(b))},ba(J),m("shaka.cast.CastReceiver",J),J.prototype.Oc=function(){return this.i},J.prototype.isConnected=J.prototype.Oc,J.prototype.Pc=function(){return this.f},J.prototype.isIdle=J.prototype.Pc,J.prototype.m=function(){var a=this.b?this.b.m():Promise.resolve();return null!=this.h&&window.clearTimeout(this.h),this.l=this.j=this.b=this.a=null,this.i=!1,this.f=!0,this.h=this.g=this.c=null,a.then(function(){cast.receiver.CastReceiverManager.getInstance().stop()})},J.prototype.destroy=J.prototype.m,k=J.prototype,k.ac=function(){this.i=!!cast.receiver.CastReceiverManager.getInstance().getSenders().length,Ac(this)},k.dc=function(a,b){this.vb(),Dc(this,{type:"event",targetName:a,event:b},this.c)},k.vb=function(){null!=this.h&&window.clearTimeout(this.h),this.h=window.setTimeout(this.vb.bind(this),500);var a={video:{},player:{}};jc.forEach(function(b){a.video[b]=this.a[b]}.bind(this)),nc.forEach(function(b){a.player[b]=this.b[b]()}.bind(this));var b=cast.receiver.CastReceiverManager.getInstance().getSystemVolume();b&&(a.video.volume=b.level,a.video.muted=b.muted),Dc(this,{type:"update",update:a},this.c)},k.Bc=function(){var a=cast.receiver.CastReceiverManager.getInstance().getSystemVolume();a&&Dc(this,{type:"update",update:{video:{volume:a.level,muted:a.muted}}},this.c),Dc(this,{type:"event",targetName:"video",event:{type:"volumechange"}},this.c)},k.jd=function(a){var b=tc(a.data);switch(b.type){case"init":Cc(this,b.initState,b.appData),this.vb();break;case"appData":this.l(b.appData);break;case"set":var c=b.targetName,d=b.property,e=b.value;if("video"==c){if(b=cast.receiver.CastReceiverManager.getInstance(),"volume"==d){b.setSystemVolumeLevel(e);break}if("muted"==d){b.setSystemVolumeMuted(e);break}}this.j[c][d]=e;break;case"call":c=b.targetName,d=b.methodName,e=b.args,c=this.j[c],c[d].apply(c,e);break;case"asyncCall":c=b.targetName,d=b.methodName,e=b.args,b=b.id,a=a.senderId,c=this.j[c],c[d].apply(c,e).then(this.kc.bind(this,a,b,null),this.kc.bind(this,a,b))}},k.Wc=function(a){var b=tc(a.data);switch(b.type){case"PLAY":this.a.play(),Bc(this,0);break;case"PAUSE":this.a.pause(),Bc(this,0);break;case"SEEK":a=b.currentTime;var c=b.resumeState;null!=a&&(this.a.currentTime=Number(a)),c&&"PLAYBACK_START"==c?(this.a.play(),Bc(this,0)):c&&"PLAYBACK_PAUSE"==c&&(this.a.pause(),Bc(this,0));break;case"STOP":this.b.bb().then(function(){Bc(this,0)}.bind(this));break;case"GET_STATUS":Bc(this,Number(b.requestId));break;case"VOLUME":c=b.volume,a=c.level;var c=c.muted,d=this.a.volume,e=this.a.muted;null!=a&&(this.a.volume=Number(a)),null!=c&&(this.a.muted=c),d==this.a.volume&&e==this.a.muted||Bc(this,0);break;case"LOAD":c=b.media.contentId,a=b.currentTime;var f=this.o(c);this.a.autoplay=!0,this.b.load(f,a).then(function(){Bc(this,0,{contentId:f,streamType:this.b.aa()?"LIVE":"BUFFERED",contentType:""})}.bind(this))["catch"](function(a){var c="LOAD_FAILED";7==a.category&&7e3==a.code&&(c="LOAD_CANCELLED"),Dc(this,{requestId:Number(b.requestId),type:c},this.g)}.bind(this));break;default:Dc(this,{requestId:Number(b.requestId),type:"INVALID_REQUEST",reason:"INVALID_COMMAND"},this.g)}},k.kc=function(a,b,c){Dc(this,{type:"asyncComplete",id:b,error:c},this.c,a)};var Ec={IDLE:"IDLE",rc:"PLAYING",pc:"BUFFERING",qc:"PAUSED"},Oc={"urn:uuid:1077efec-c0b2-4d02-ace3-3c1e52e2fb4b":"org.w3.clearkey","urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed":"com.widevine.alpha","urn:uuid:9a04f079-9840-4286-ab92-e65be0885f95":"com.microsoft.playready","urn:uuid:f239e769-efa3-4850-9c16-a903c6932efb":"com.adobe.primetime"};m("shaka.media.InitSegmentReference",Xc),m("shaka.media.SegmentReference",N);var Zc=1;m("shaka.util.Mp4Parser",Q),Q.prototype.C=function(a,b){var c=gd(a);return this.b[c]=0,this.a[c]=b,this},Q.prototype.box=Q.prototype.C,Q.prototype.$=function(a,b){var c=gd(a);return this.b[c]=1,this.a[c]=b,this},Q.prototype.fullBox=Q.prototype.$,Q.prototype.parse=function(a){for(a=new Yc(new DataView(a));$c(a);)this.Za(0,a)},Q.prototype.parse=Q.prototype.parse,Q.prototype.Za=function(a,b){var c=b.u,d=O(b),e=O(b);switch(d){case 0:d=b.H.byteLength-c;break;case 1:d=dd(b)}var f=this.a[e];if(f){var g=null,h=null;1==this.b[e]&&(h=O(b),g=h>>>24,h&=16777215),e=c+d-b.u,e=e>0?ed(b,e).buffer:new ArrayBuffer(0),e=new Yc(new DataView(e)),f({Ja:this,version:g,Cc:h,s:e,size:d,start:c+a})}else P(b,c+d-b.u)},Q.prototype.parseNext=Q.prototype.Za,Q.children=R,Q.sampleDescription=hd,Q.allData=id,m("shaka.media.SegmentIndex",S),S.prototype.m=function(){return this.a=null,Promise.resolve()},S.prototype.destroy=S.prototype.m,S.prototype.find=function(a){for(var b=this.a.length-1;b>=0;--b){var c=this.a[b];if(a>=c.startTime&&a<c.endTime)return c.position}return this.a.length&&a<this.a[0].startTime?this.a[0].position:null},S.prototype.find=S.prototype.find,S.prototype.get=function(a){return this.a.length?(a-=this.a[0].position,0>a||a>=this.a.length?null:this.a[a]):null},S.prototype.get=S.prototype.get,S.prototype.qb=function(a){for(var b=[],c=0,d=0;c<this.a.length&&d<a.length;){var e=this.a[c],f=a[d];e.startTime<f.startTime?(b.push(e),c++):(e.startTime>f.startTime||(b.push(.1<Math.abs(e.endTime-f.endTime)?f:e),c++),d++)}for(;c<this.a.length;)b.push(this.a[c++]);if(b.length)for(c=b[b.length-1].position+1;d<a.length;)f=a[d++],f=new N(c++,f.startTime,f.endTime,f.a,f.V,f.J),b.push(f);else b=a;this.a=b},S.prototype.merge=S.prototype.qb,S.prototype.jb=function(a){for(var b=0;b<this.a.length&&!(this.a[b].endTime>a);++b);this.a.splice(0,b)},S.prototype.evict=S.prototype.jb;var nd;sd.prototype.parse=function(a,b,c,d){var e;if(b=new md(new DataView(b)),440786851!=od(b).id)throw new t(2,3,3008);var f=od(b);if(408125543!=f.id)throw new t(2,3,3009);for(b=f.a.byteOffset,f=new md(f.a),e=null;$c(f.a);){var g=od(f);if(357149030==g.id){e=g;break}}if(!e)throw new t(2,3,3010);for(f=new md(e.a),e=1e6,g=null;$c(f.a);){var h=od(f);if(2807729==h.id)e=rd(h);else if(17545==h.id)if(g=h,4==g.a.byteLength)g=g.a.getFloat32(0);else{if(8!=g.a.byteLength)throw new t(2,3,3003);g=g.a.getFloat64(0)}}if(null==g)throw new t(2,3,3011);if(f=e/1e9,e=g*f,a=od(new md(new DataView(a))),475249515!=a.id)throw new t(2,3,3007);return td(a,b,f,e,c,d)};var Id={},Jd={};m("shaka.media.ManifestParser.registerParserByExtension",function(a,b){Jd[a]=b}),m("shaka.media.ManifestParser.registerParserByMime",function(a,b){Id[a]=b}),m("shaka.media.PresentationTimeline",T),T.prototype.W=function(){return this.a},T.prototype.getDuration=T.prototype.W,T.prototype.ma=function(a){this.a=a},T.prototype.setDuration=T.prototype.ma,T.prototype.Jc=function(){return this.f},T.prototype.getPresentationStartTime=T.prototype.Jc,T.prototype.lc=function(a){this.h=a},T.prototype.setClockOffset=T.prototype.lc,T.prototype.nc=function(a){this.g=a},T.prototype.setStatic=T.prototype.nc,T.prototype.Kc=function(){return this.c},T.prototype.getSegmentAvailabilityDuration=T.prototype.Kc,T.prototype.mc=function(a){this.c=a},T.prototype.setSegmentAvailabilityDuration=T.prototype.mc,T.prototype.Da=function(a,b){b.length&&(this.b=b.reduce(function(a,b){return Math.max(a,b.endTime-b.startTime)},this.b))},T.prototype.notifySegments=T.prototype.Da,T.prototype.rb=function(a){this.b=Math.max(this.b,a)},T.prototype.notifyMaxSegmentDuration=T.prototype.rb,T.prototype.aa=function(){return 1/0==this.a&&!this.g},T.prototype.isLive=T.prototype.aa,T.prototype.sa=function(){return 1/0!=this.a&&!this.g},T.prototype.isInProgress=T.prototype.sa,T.prototype.ja=function(){return this.Aa(0)},T.prototype.getSegmentAvailabilityStart=T.prototype.ja,T.prototype.Aa=function(a){if(1/0==this.c)return 0;var b=this.ra();return Math.max(0,Math.min(b-this.c+a,b))},T.prototype.getSafeAvailabilityStart=T.prototype.Aa,T.prototype.ra=function(){return this.aa()||this.sa()?Math.min(Math.max(0,(Date.now()+this.h)/1e3-this.b-this.f),this.a):this.a},T.prototype.getSegmentAvailabilityEnd=T.prototype.ra,T.prototype.Xa=function(){return Math.max(0,this.ra()-(this.aa()||this.sa()?this.i:0))},T.prototype.getSeekRangeEnd=T.prototype.Xa,m("shaka.dash.DashParser",Md),k=Md.prototype,k.configure=function(a){this.b=a},k.start=function(a,b){return this.g=[a],this.a=b,Nd(this).then(function(){return this.a&&Od(this,0),this.c}.bind(this))},k.stop=function(){return this.b=this.a=null,this.g=[],this.c=null,this.i=[],this.j={},null!=this.f&&(window.clearTimeout(this.f),this.f=null),Promise.resolve()},k.update=function(){Nd(this)["catch"](function(a){this.a&&this.a.onError(a)}.bind(this))},k.onExpirationUpdated=function(){},k.rd=function(a,b){a.P=Td(b,a.R,null);var c=!1,d=L(b,"Role"),e=void 0;"text"==a.P.contentType&&(e="subtitle");for(var f=0;f<d.length;f++){var g=d[f].getAttribute("schemeIdUri");if(null==g||"urn:mpeg:dash:role:2011"==g)switch(g=d[f].getAttribute("value")){case"main":c=!0;break;case"caption":case"subtitle":e=g}}var h=null,l=!1;if(L(b,"EssentialProperty").forEach(function(a){"http://dashif.org/guidelines/trickmode"==a.getAttribute("schemeIdUri")?h=a.getAttribute("value"):l=!0}),l)return null;var d=L(b,"ContentProtection"),n=Pc(d,this.b.dash.customScheme,this.b.dash.ignoreDrmInfo),d=Qb(b.getAttribute("lang")||"und"),f=L(b,"Representation"),e=f.map(this.ud.bind(this,a,n,e,d,c)).filter(function(a){return!!a});if(!e.length)throw new t(2,4,4003);return a.P.contentType||(a.P.contentType=Wd(e[0].mimeType,e[0].codecs),e.forEach(function(b){b.type=a.P.contentType})),e.forEach(function(a){n.drmInfos.forEach(function(b){a.keyId&&b.keyIds.push(a.keyId)})}),f=f.map(function(a){return a.getAttribute("id")}).filter(ya),{id:a.P.id||"__fake__"+this.h++,contentType:a.P.contentType,language:d,ob:c,streams:e,drmInfos:n.drmInfos,Fb:h,Dd:f}},k.ud=function(a,b,c,d,e,f){if(a.w=Td(f,a.P,null),!Xd(a.w))return null;a.bandwidth=M(f,"bandwidth",Lc)||void 0;var g;if(g=this.Ed.bind(this),a.w.La)g=wd(a,g);else if(a.w.la)g=zd(a,this.j);else if(a.w.Ma)g=Dd(a,g,this.j,!!this.c);else{var h=a.w.S,l=a.N.duration||0;g={createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(a){return a>=0&&l>a?1:null},getSegmentReference:function(a){return 1!=a?null:new N(1,0,l,function(){return h},0,null)},initSegmentReference:null,presentationTimeOffset:0}}return f=L(f,"ContentProtection"),f=Sc(f,this.b.dash.customScheme,b,this.b.dash.ignoreDrmInfo),{id:this.h++,createSegmentIndex:g.createSegmentIndex,findSegmentPosition:g.findSegmentPosition,getSegmentReference:g.getSegmentReference,initSegmentReference:g.initSegmentReference,presentationTimeOffset:g.presentationTimeOffset,mimeType:a.w.mimeType,codecs:a.w.codecs,frameRate:a.w.frameRate,bandwidth:a.bandwidth,width:a.w.width,height:a.w.height,kind:c,encrypted:0<b.drmInfos.length,keyId:f,language:d,type:a.P.contentType,primary:e,trickModeVideo:null,containsEmsgBoxes:a.w.containsEmsgBoxes}},k.Wd=function(){this.f=null;var a=Date.now();Nd(this).then(function(){this.a&&Od(this,(Date.now()-a)/1e3)}.bind(this))["catch"](function(a){this.a&&(a.severity=1,this.a.onError(a),Od(this,0))}.bind(this))},k.td=function(a,b,c){var d=c.getAttribute("schemeIdUri")||"",e=c.getAttribute("value")||"",f=M(c,"timescale",Mc)||1;L(c,"Event").forEach(function(c){var g=M(c,"presentationTime",Mc)||0,l=M(c,"duration",Mc)||0,g=g/f+a,l=g+l/f;null!=b&&(g=Math.min(g,a+b),l=Math.min(l,a+b)),c={schemeIdUri:d,value:e,startTime:g,endTime:l,id:c.getAttribute("id")||"",eventElement:c},this.a.onTimelineRegionAdded(c)}.bind(this))},k.Ed=function(a,b,c){return a=C(a,this.b.retryParameters),null!=b&&(a.headers.Range="bytes="+b+"-"+(null!=c?c:"")),this.a.networkingEngine.request(1,a).then(function(a){return a.data})},Jd.mpd=Md,Id["application/dash+xml"]=Md,$d.prototype.toString=function(){function a(a){return a.name+'="'+a.value+'"'}return this.value?"#"+this.name+":"+this.value:0<this.a.length?"#"+this.name+":"+this.a.map(a).join(","):"#"+this.name},$d.prototype.getAttribute=function(a){var b=this.a.filter(function(b){return b.name==a});return b.length?b[0]:null};var me="EXT-X-TARGETDURATION EXT-X-MEDIA-SEQUENCE EXT-X-DISCONTINUITY-SEQUENCE EXT-X-PLAYLIST-TYPE EXT-X-MAP EXT-X-I-FRAMES-ONLY".split(" "),ne="EXTINF EXT-X-BYTERANGE EXT-X-DISCONTINUITY EXT-X-PROGRAM-DATE-TIME EXT-X-KEY EXT-X-DATERANGE".split(" ");m("shaka.net.DataUriPlugin",pe),pe.parse=function(a){var b=a.split(":");if(2>b.length||"data"!=b[0])throw new t(2,1,1004,a);if(b=b.slice(1).join(":").split(","),2>b.length)throw new t(2,1,1004,a);var c=b[0],b=window.decodeURIComponent(b.slice(1).join(",")),c=c.split(";"),d=null;if(1<c.length&&(d=c[1]),"base64"==d)a=Wa(b).buffer;else{if(d)throw new t(2,1,1005,a);a=Sa(b)}return{data:a,contentType:c[0]}},Ea.data=pe,m("shaka.hls.HlsParser",qe),k=qe.prototype,k.configure=function(a){this.b=a},k.start=function(a,b){return this.c=b,this.j=a,this.c.networkingEngine.request(0,C([a],this.b.retryParameters)).then(function(b){return se(this,b.data,a)}.bind(this))},k.stop=function(){return this.b=this.c=null,this.g={},Promise.resolve()},k.update=function(){},k.onExpirationUpdated=function(){};var Ie=[/^(avc)/,/^(hvc)/,/^(vp[8-9])$/,/^(av1)$/,/^(mp4v)/],Je=[/^(vorbis)/,/^(opus)/,/^(mp4a)/,/^(ac-3)$/,/^(ec-3)$/],Ke={mp4:"audio/mp4",m4s:"audio/mp4",m4i:"audio/mp4",m4a:"audio/mp4",ts:"video/mp2t"},Le={mp4:"video/mp4",m4s:"video/mp4",m4i:"video/mp4",m4v:"video/mp4",ts:"video/mp2t"},Fe={"urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed":function(a){if("SAMPLE-AES-CENC"!=U(a,"METHOD"))return null;var b=U(a,"URI"),b=pe.parse(b),b=new Uint8Array(b.data),b=Ba("com.widevine.alpha",[{initDataType:"cenc",initData:b}]);return(a=a.getAttribute("KEYID"))&&(b.keyIds=[a.value.substr(2).toLowerCase()]),b}};Jd.m3u8=qe,Id["application/x-mpegurl"]=qe,Id["application/vnd.apple.mpegurl"]=qe,Me.prototype.parseInit=function(){},Me.prototype.parseMedia=function(a,b){var c=F(a),d=[],e=new DOMParser,f=null;try{f=e.parseFromString(c,"text/xml")}catch(Jb){throw new t(2,2,2005)}if(f){var g,h,l=f.getElementsByTagName("tt")[0];if(!l)throw new t(2,2,2005);if(e=l.getAttribute("ttp:frameRate"),f=l.getAttribute("ttp:subFrameRate"),g=l.getAttribute("ttp:frameRateMultiplier"),h=l.getAttribute("ttp:tickRate"),c=l.getAttribute("xml:space")||"default","default"!=c&&"preserve"!=c)throw new t(2,2,2005);for(c="default"==c,e=new Ne(e,f,g,h),f=Oe(l.getElementsByTagName("styling")[0]),g=Oe(l.getElementsByTagName("layout")[0]),l=Oe(l.getElementsByTagName("body")[0]),h=0;h<l.length;h++){var n,q=l[h],r=b.periodStart,v=e;n=f;var u=g,w=c;if(q.hasAttribute("begin")||q.hasAttribute("end")||!/^\s*$/.test(q.textContent)){Pe(q,w);var w=Qe(q.getAttribute("begin"),v),K=Qe(q.getAttribute("end"),v),v=Qe(q.getAttribute("dur"),v),pa=q.textContent;if(null==K&&null!=v&&(K=w+v),null==w||null==K)throw new t(2,2,2001);(r=vb(w+r,K+r,pa))?(w=Re(q,"region",u),u=r,(K=Se(q,w,n,"tts:extent"))&&(v=Te.exec(K))&&(u.size=Number(v[1])),v=Se(q,w,n,"tts:writingMode"),K=!0,"tb"==v||"tblr"==v?u.vertical="lr":"tbrl"==v?u.vertical="rl":K=!1,(v=Se(q,w,n,"tts:origin"))&&(v=Te.exec(v))&&(K?(u.position=Number(v[2]),u.line=Number(v[1])):(u.position=Number(v[1]),u.line=Number(v[2])),u.snapToLines=!1),(n=Se(q,w,n,"tts:textAlign"))&&(u.align=n,"center"==n&&("center"!=u.align&&(u.align="middle"),u.position="auto"),u.positionAlign=Ue[n],u.lineAlign=Ve[n]),n=r):n=null}else n=null;n&&d.push(n)}}return d};var We=/^(\d{2,}):(\d{2}):(\d{2}):(\d{2})\.?(\d+)?$/,Xe=/^(?:(\d{2,}):)?(\d{2}):(\d{2})$/,Ye=/^(?:(\d{2,}):)?(\d{2}):(\d{2}\.\d{2,})$/,Ze=/^(\d*\.?\d*)f$/,$e=/^(\d*\.?\d*)t$/,af=/^(?:(\d*\.?\d*)h)?(?:(\d*\.?\d*)m)?(?:(\d*\.?\d*)s)?(?:(\d*\.?\d*)ms)?$/,Te=/^(\d{1,2}|100)% (\d{1,2}|100)%$/,Ve={left:"start",center:"center",right:"end",start:"start",end:"end"},Ue={left:"line-left",center:"center",right:"line-right"};tb("application/ttml+xml",Me),cf.prototype.parseInit=function(a){var b=!1;if((new Q).C("moov",R).C("trak",R).C("mdia",R).C("minf",R).C("stbl",R).$("stsd",hd).C("stpp",function(){b=!0}).parse(a),!b)throw new t(2,2,2007)},cf.prototype.parseMedia=function(a,b){var c=!1,d=[];if((new Q).C("mdat",id(function(a){c=!0,d=this.a.parseMedia(a.buffer,b)}.bind(this))).parse(a),!c)throw new t(2,2,2007);return d},tb('application/mp4; codecs="stpp"',cf),df.prototype.parseInit=function(){},df.prototype.parseMedia=function(a,b){var c=F(a),c=c.replace(/\r\n|\r(?=[^\n]|$)/gm,"\n"),c=c.split(/\n{2,}/m);if(!/^WEBVTT($|[ \t\n])/m.test(c[0]))throw new t(2,2,2e3);var d=b.segmentStart;if(0<=c[0].indexOf("X-TIMESTAMP-MAP")){var e=c[0].match(/LOCAL:((?:(\d{1,}):)?(\d{2}):(\d{2})\.(\d{3}))/m),f=c[0].match(/MPEGTS:(\d+)/m);e&&f&&(d=ef(new fe(e[1])),d=b.periodStart+(Number(f[1])/9e4-d))}for(f=[],e=1;e<c.length;e++){var g,h=c[e].split("\n"),l=d;if(1==h.length&&!h[0]||/^NOTE($|[ \t])/.test(h[0]))g=null;else{g=null,0>h[0].indexOf("-->")&&(g=h[0],h.splice(0,1));var n=new fe(h[0]),q=ef(n),r=ge(n,/[ \t]+--\x3e[ \t]+/g),v=ef(n);if(null==q||!r||null==v)throw new t(2,2,2001);if(h=vb(q+l,v+l,h.slice(1).join("\n").trim())){for(ge(n,/[ \t]+/gm),l=he(n);l;)ff(h,l),ge(n,/[ \t]+/gm),l=he(n);null!=g&&(h.id=g),g=h}else g=null}g&&f.push(g)}return f},tb("text/vtt",df),tb('text/vtt; codecs="vtt"',df),gf.prototype.parseInit=function(a){var b=!1;if((new Q).C("moov",R).C("trak",R).C("mdia",R).$("mdhd",function(a){0==a.version?(P(a.s,4),P(a.s,4),this.a=O(a.s),P(a.s,4)):(P(a.s,8),P(a.s,8),this.a=O(a.s),P(a.s,8)),P(a.s,4)}.bind(this)).C("minf",R).C("stbl",R).$("stsd",hd).C("wvtt",function(){b=!0}).parse(a),!this.a)throw new t(2,2,2008);if(!b)throw new t(2,2,2008)},gf.prototype.parseMedia=function(a,b){var c=0,d=[],e=[],f=[],g=!1,h=!1,l=!1;if((new Q).C("moof",R).C("traf",R).$("tfdt",function(a){g=!0,c=a.version?dd(a.s):O(a.s)}).$("trun",function(a){h=!0;var b=a.version,c=a.Cc;a=a.s;var e=O(a);1&c&&P(a,4),4&c&&P(a,4);for(var f=[],g=0;e>g;g++){var l={duration:null,Eb:null};if(256&c&&(l.duration=O(a)),512&c&&P(a,4),1024&c&&P(a,4),2048&c){var q,n=l;if(b){q=a;try{var r=q.H.getInt32(q.u,q.a)}catch(Qh){bd()}q.u+=4,q=r}else q=O(a);n.Eb=q}f.push(l)}d=f}).C("vtte",function(){e.push(null)}).C("vttc",id(function(a){e.push(a.buffer)})).C("mdat",function(a){l=!0,R(a)}).parse(a),!l&&!g&&!h)throw new t(2,2,2008);for(var n=c,q=0;q<d.length;q++){var r=d[q],v=e[q];if(r.duration){var u=r.Eb?c+r.Eb:n,n=u+r.duration;v&&f.push(hf(v,b.periodStart+u/this.a,b.periodStart+n/this.a))}}return f},tb('application/mp4; codecs="wvtt"',gf),k=kf.prototype,k.m=function(){var a=this.b.m();return this.b=null,null!=this.f&&(window.clearInterval(this.f),this.f=null),null!=this.j&&(window.clearInterval(this.j),this.j=null),this.F=this.I=this.l=this.c=this.a=null,a},k.kb=function(){return this.g},k.tb=function(){this.o=!0,this.Zb()},k.ed=function(){this.a.playbackRate!=(this.h||0>this.g?0:this.g)&&pf(this,this.a.playbackRate)},k.Xb=function(){var a=of(this);.001>Math.abs(this.a.currentTime-a)?(E(this.b,this.a,"seeking",this.$b.bind(this)),E(this.b,this.a,"playing",this.Yb.bind(this))):(Ka(this.b,this.a,"seeking",this.gd.bind(this)),this.a.currentTime=a)},k.gd=function(){E(this.b,this.a,"seeking",this.$b.bind(this)),E(this.b,this.a,"playing",this.Yb.bind(this))},k.Zb=function(){if(this.a.readyState){this.a.readyState!=this.B&&(this.i=!1,this.B=this.a.readyState);var d,a=this.l.smallGapLimit,b=this.a.currentTime,c=this.a.buffered;a:{if(c&&c.length&&!(1==c.length&&1e-6>c.end(0)-c.start(0))){d=.1,/(Edge|Trident)\//.test(navigator.userAgent)&&(d=.5);for(var e=0;e<c.length;e++)if(c.start(e)>b&&(!e||c.end(e-1)-b<=d)){d=e;break a}}d=null}if(null==d){if(3>this.a.readyState&&0<this.a.playbackRate)if(this.M!=b)this.M=b,this.v=Date.now();else if(this.v<Date.now()-1e3)for(this.v=Date.now()+5e3,d=0;d<c.length;d++)if(b>=c.start(d)&&b<c.end(d)-.5){this.a.currentTime=this.a.currentTime;break}}else if((d||this.o)&&(e=c.start(d),!(e>=this.c.presentationTimeline.Xa()))){var f=e-b,a=a>=f,g=!1;a||this.i||(this.i=!0,f=new H("largegap",{currentTime:b,gapSize:f}),f.cancelable=!0,this.F(f),this.l.jumpLargeGaps&&!f.defaultPrevented&&(g=!0)),(a||g)&&(d&&c.end(d-1),qf(this,b,e))}}},k.$b=function(){this.o=!1;var a=this.a.currentTime,b=rf(this,a);.001<Math.abs(b-a)?qf(this,a,b):(this.i=!1,this.I())},k.Yb=function(){var a=this.a.currentTime,b=rf(this,a);.001<Math.abs(b-a)&&qf(this,a,b)},sf.prototype.m=function(){var a=this.j?this.j.m():Promise.resolve();return this.j=null,uf(this),this.B=this.h=this.l=this.A=this.g=this.a=null,this.c=[],a},sf.prototype.v=function(a){if(!this.c.some(function(b){return b.info.schemeIdUri==a.schemeIdUri&&b.info.startTime==a.startTime&&b.info.endTime==a.endTime})){var b={info:a,status:1};this.c.push(b);var c=new H("timelineregionadded",{detail:vf(a)});this.h(c),this.o(!0,b)}},sf.prototype.o=function(a,b){var c=b.info.startTime>this.a.currentTime?1:b.info.endTime<this.a.currentTime?3:2,d=2==b.status,e=2==c;c!=b.status&&((!a||d||e)&&(d||this.h(new H("timelineregionenter",{detail:vf(b.info)})),e||this.h(new H("timelineregionexit",{detail:vf(b.info)}))),b.status=c)},sf.prototype.F=function(){this.f=null,tf(this);var a=fc(this.g,this.a.currentTime);a!=this.i&&(-1!=this.i&&this.B(),this.i=a);var a=Ab(this.a.buffered,this.a.currentTime),b=yb(this.a.buffered)>=this.g.presentationTimeline.ra()-.1||this.a.ended;if(this.b){var c=1*Math.max(this.g.minBufferTime||0,this.A.rebufferingGoal);(b||a>=c)&&0!=this.b&&(this.b=!1,this.l(!1))}else!b&&.5>a&&1!=this.b&&(this.b=!0,this.l(!0));this.c.forEach(this.o.bind(this,!1))},k=wf.prototype,k.m=function(){for(var a in this.c)xf(this.c[a]);return this.h=this.c=this.j=this.g=this.o=this.b=this.a=null,this.f=!0,Promise.resolve()},k.configure=function(a){this.h=a},k.init=function(){var a=this.a.Tb(this.b.periods[fc(this.b,nf(this.a.Ka))]);return La(a)?Promise.reject(new t(2,5,5005)):yf(this,a).then(function(){this.a&&this.a.Xc&&this.a.Xc()}.bind(this))},k.Zd=function(a){if(!this.f&&!a.ta&&null!=a.na&&!a.pa)if(a.na=null,a.oa)Df(this,a,a.fb);else{try{var b=Jf(this,a);null!=b&&(Ff(this,a,b),a.mb=!1)}catch(c){return void this.a.onError(c)}b=Ma(this.c),Kf(this,a),b.every(function(a){return a.endOfStream})&&this.a.G.endOfStream().then(function(){this.b.presentationTimeline.ma(this.a.G.W())}.bind(this))}},k.sd=function(a,b,c){var d=fd(c.s),e=fd(c.s),f=O(c.s),g=O(c.s),h=O(c.s),l=O(c.s);c=ed(c.s,c.s.H.byteLength-c.s.u),a=a.startTime+b.startTime+g/f,"urn:mpeg:dash:event:2012"==d?this.a.Yc():this.a.onEvent(new H("emsg",{detail:{startTime:a,endTime:a+h/f,schemeIdUri:d,value:e,timescale:f,presentationTimeDelta:g,eventDuration:h,id:l,messageData:c}}))},m("shaka.net.HttpPlugin",Uf),Ea.http=Uf,Ea.https=Uf,k=Vf.prototype,k.init=function(a,b){return Wf(this,a,b).then(function(){var b=Object.keys(a);return Promise.all(b.map(function(a){return Xf(this,a).then(function(b){this.b[a]=b}.bind(this))}.bind(this)))}.bind(this))},k.m=function(){return Promise.all(this.c.map(function(a){try{a.transaction.abort()}catch(b){}return a.O["catch"](y)})).then(function(){this.a&&(this.a.close(),this.a=null)}.bind(this))},k.get=function(a,b){return Yf(this,a,"readonly",function(a){return a.get(b)})},k.forEach=function(a,b){return Yf(this,a,"readonly",function(a){return a.openCursor()},function(a){a&&(b(a.value),a["continue"]())})},k.remove=function(a,b){return Yf(this,a,"readwrite",function(a){return a["delete"](b)})};var bg={manifest:"key",segment:"key"};jg.prototype.m=function(){var a=this.j,b=this.l,c=this.i||Promise.resolve(),c=c.then(function(){return Promise.all(b.map(function(b){return a.remove("segment",b)}))});return this.b={},this.l=[],this.i=this.a=this.A=this.v=this.j=this.o=null,c},k=ng.prototype,k.configure=function(){},k.start=function(a){var b=/^offline:([0-9]+)$/.exec(a);if(!b)return Promise.reject(new t(2,1,9004,a));var c=Number(b[1]),d=ig();return this.a=c,d?d.init(bg).then(function(){return d.get("manifest",c)}).then(function(a){if(!a)throw new t(2,9,9003,c);return og(a)}).then(function(a){return d.m().then(function(){return a})},function(a){return d.m().then(function(){throw a})}):Promise.reject(new t(2,9,9e3))},k.stop=function(){return Promise.resolve()},k.update=function(){},k.onExpirationUpdated=function(a,b){var c=ig();c.init(bg).then(function(){return c.get("manifest",this.a)}.bind(this)).then(function(d){return!d||0>d.sessionIds.indexOf(a)||!(void 0==d.expiration||d.expiration>b)?void 0:(d.expiration=b,Zf(c,"manifest",d))})["catch"](function(){}).then(function(){return c.m()})},Id["application/x-offline-manifest"]=ng,m("shaka.offline.OfflineScheme",pg),Ea.offline=pg,qg.prototype.then=function(a){return this.a=this.a.then(a).then(function(a){return this.c?(this.h(),Promise.reject(this.i)):Promise.resolve(a)}.bind(this)),this},qg.prototype.cancel=function(a){return this.b?Promise.resolve():(this.c=!0,this.i=a,this.g)},ba(W),m("shaka.Player",W),W.prototype.m=function(){this.I=!0;var a=Promise.resolve();return this.F&&(a=this.F.cancel(new t(2,7,7e3))),a.then(function(){var a=Promise.all([this.ia,vg(this),this.l?this.l.m():null,this.o?this.o.m():null]);return this.b=this.o=this.Hb=this.l=this.A=this.f=null,a}.bind(this))},W.prototype.destroy=W.prototype.m,W.version="v2.1.1";var wg={};W.registerSupportPlugin=function(a,b){wg[a]=b},W.isBrowserSupported=function(){return!!(window.Promise&&window.Uint8Array&&Array.prototype.forEach&&window.MediaSource&&window.MediaKeys&&window.navigator&&window.navigator.requestMediaKeySystemAccess&&window.MediaKeySystemAccess&&window.MediaKeySystemAccess.prototype.getConfiguration)},W.probeSupport=function(){return ob().then(function(a){var b=Kd(),c=Cb();a={manifest:b,media:c,drm:a};for(var d in wg)a[d]=wg[d]();return a})},W.prototype.load=function(a,b,c){var d=this.bb(),e=new qg;this.F=e,this.dispatchEvent(new H("loading"));var f=Date.now();return rg(e.then(function(){return d}).then(function(){return this.i=tg(),E(this.l,this.f,"playing",this.Na.bind(this)),E(this.l,this.f,"pause",this.Na.bind(this)),E(this.l,this.f,"ended",this.Na.bind(this)),Ld(a,this.o,this.b.manifest.retryParameters,c)}.bind(this)).then(function(b){return this.h=new b,this.h.configure(this.b.manifest),b={networkingEngine:this.o,filterPeriod:this.$a.bind(this),onTimelineRegionAdded:this.ld.bind(this),onEvent:this.ab.bind(this),onError:this.ua.bind(this)},2<this.h.start.length?this.h.start(a,this.o,b.filterPeriod,b.onError,b.onEvent):this.h.start(a,b)}.bind(this)).then(function(b){if(0==b.periods.length)throw new t(2,4,4014);return this.c=b,this.Ta=a,this.j=new $a(this.o,this.ua.bind(this),this.Qd.bind(this),this.Pd.bind(this)),this.j.configure(this.b.drm),this.j.init(b,!1)}.bind(this)).then(function(){return this.c.periods.forEach(this.$a.bind(this)),this.Pa=Date.now()/1e3,this.fa=this.b.preferredAudioLanguage,this.ya=this.b.preferredTextLanguage,Promise.all([cb(this.j,this.f),this.Ra])}.bind(this)).then(function(){return this.b.abr.manager.init(this.Cb.bind(this)),this.g=new kf(this.f,this.c,this.b.streaming,b||null,this.Rd.bind(this),this.ab.bind(this)),this.v=new sf(this.f,this.c,this.b.streaming,this.oc.bind(this),this.ab.bind(this),this.Od.bind(this)),this.ga=new Bb(this.f,this.K,this.A),this.a=new wf(this.c,{Ka:this.g,G:this.ga,Sc:this.o,Tb:this.Tc.bind(this),Sb:this.vc.bind(this),onError:this.ua.bind(this),onEvent:this.ab.bind(this),Yc:this.Zc.bind(this),tb:this.hd.bind(this)}),this.a.configure(this.b.streaming),this.a.init()}.bind(this)).then(function(){if(this.b.streaming.startAtSegmentBoundary){var a=xg(this,nf(this.g));lf(this.g,a)}this.c.periods.forEach(this.$a.bind(this)),yg(this),zg(this);var a=V(this.a),b=bc(a,this.fa);this.b.abr.manager.setVariants(b),a.variants.some(function(a){return a.primary}),this.Sa.forEach(this.v.v.bind(this.v)),this.Sa=[],Ka(this.l,this.f,"loadeddata",function(){this.i.loadLatency=(Date.now()-f)/1e3}.bind(this)),this.F=null}.bind(this)))["catch"](function(a){return this.F==e&&(this.F=null,this.dispatchEvent(new H("unloading"))),Promise.reject(a)}.bind(this))},W.prototype.load=W.prototype.load,W.prototype.configure=function(a){a.abr&&a.abr.manager&&a.abr.manager!=this.b.abr.manager&&(this.b.abr.manager.stop(),a.abr.manager.init(this.Cb.bind(this))),Ca(this.b,a,sg(this),Ag(),""),Bg(this)},W.prototype.configure=W.prototype.configure,W.prototype.getConfiguration=function(){var a=sg(this);return Ca(a,this.b,sg(this),Ag(),""),a},W.prototype.getConfiguration=W.prototype.getConfiguration,W.prototype.Fd=function(){var a=sg(this);a.abr&&a.abr.manager&&a.abr.manager!=this.b.abr.manager&&(this.b.abr.manager.stop(),a.abr.manager.init(this.Cb.bind(this))),this.b=sg(this),Bg(this)},W.prototype.resetConfiguration=W.prototype.Fd,W.prototype.Gc=function(){return this.f},W.prototype.getMediaElement=W.prototype.Gc,W.prototype.Nb=function(){return this.o},W.prototype.getNetworkingEngine=W.prototype.Nb,W.prototype.Fc=function(){return this.Ta},W.prototype.getManifestUri=W.prototype.Fc,W.prototype.aa=function(){return this.c?this.c.presentationTimeline.aa():!1},W.prototype.isLive=W.prototype.aa,W.prototype.sa=function(){return this.c?this.c.presentationTimeline.sa():!1},W.prototype.isInProgress=W.prototype.sa,W.prototype.Hd=function(){var a=0,b=0;return this.c&&(b=this.c.presentationTimeline,a=b.ja(),b=b.Xa()),{start:a,end:b}},W.prototype.seekRange=W.prototype.Hd,W.prototype.keySystem=function(){return this.j?this.j.keySystem():""},W.prototype.keySystem=W.prototype.keySystem,W.prototype.drmInfo=function(){return this.j?this.j.b:null},W.prototype.drmInfo=W.prototype.drmInfo,W.prototype.Wa=function(){return this.j?this.j.Wa():1/0},W.prototype.getExpiration=W.prototype.Wa,W.prototype.Nc=function(){return this.ha},W.prototype.isBuffering=W.prototype.Nc,W.prototype.bb=function(){if(this.I)return Promise.resolve();this.dispatchEvent(new H("unloading"));var a=Promise.resolve();return this.F&&(a=this.F.cancel(new t(2,7,7e3))),a.then(function(){return this.ia||(this.ia=Dg(this).then(function(){this.ia=null}.bind(this))),this.ia}.bind(this))},W.prototype.unload=W.prototype.bb,W.prototype.kb=function(){return this.g?this.g.kb():0},W.prototype.getPlaybackRate=W.prototype.kb,W.prototype.be=function(a){this.g&&pf(this.g,a),this.a&&Bf(this.a,1!=a)},W.prototype.trickPlay=W.prototype.be,W.prototype.wc=function(){this.g&&pf(this.g,1),this.a&&Bf(this.a,!1)},W.prototype.cancelTrickPlay=W.prototype.wc,W.prototype.getTracks=function(){return this.Pb().concat(this.Ob())},W.prototype.getTracks=W.prototype.getTracks,W.prototype.Kd=function(a,b){"text"==a.type?this.ic(a):(this.configure({abr:{enabled:!1}}),this.jc(a,b))},W.prototype.selectTrack=W.prototype.Kd,W.prototype.Pb=function(){if(!this.c)return[];var a=fc(this.c,nf(this.g)),b=this.M[a]||{};return Xb(this.c.periods[a],b.audio,b.video)},W.prototype.getVariantTracks=W.prototype.Pb,W.prototype.Ob=function(){if(!this.c)return[];

var a=fc(this.c,nf(this.g));return Zb(this.c.periods[a],(this.M[a]||{}).text).filter(function(a){return 0>this.Qa.indexOf(a.id)}.bind(this))},W.prototype.getTextTracks=W.prototype.Ob,W.prototype.ic=function(a){if(this.a&&(a=ac(V(this.a),a))){Eg(this,a,!1);var b={};b.text=a,Fg(this,b,!0)}},W.prototype.selectTextTrack=W.prototype.ic,W.prototype.jc=function(a,b){if(this.a){var c={},d=$b(V(this.a),a),e=zf(this.a);if(d){if(!d.allowedByApplication||!d.allowedByKeySystem)return;d.audio&&(Gg(this,d.audio),d.audio!=e.audio&&(c.audio=d.audio)),d.video&&(Gg(this,d.video),d.video!=e.video&&(c.video=d.video))}Ma(c).forEach(function(a){Eg(this,a,!1)}.bind(this)),(d=e.text)&&(c.text=d),Fg(this,c,b)}},W.prototype.selectVariantTrack=W.prototype.jc,W.prototype.Ec=function(){return this.a?Yb(V(this.a).variants).map(function(a){return a.language}).filter(Aa):[]},W.prototype.getAudioLanguages=W.prototype.Ec,W.prototype.Lc=function(){return this.a?V(this.a).textStreams.map(function(a){return a.language}).filter(Aa):[]},W.prototype.getTextLanguages=W.prototype.Lc,W.prototype.Id=function(a){if(this.a){var b=V(this.a);this.fa=a,Cg(this,b)}},W.prototype.selectAudioLanguage=W.prototype.Id,W.prototype.Jd=function(a){if(this.a){var b=V(this.a);this.ya=a,Cg(this,b)}},W.prototype.selectTextLanguage=W.prototype.Jd,W.prototype.Qc=function(){return"showing"==this.A.mode},W.prototype.isTextTrackVisible=W.prototype.Qc,W.prototype.Md=function(a){this.A.mode=a?"showing":"hidden",Hg(this)},W.prototype.setTextTrackVisibility=W.prototype.Md,W.prototype.Ic=function(){return this.c?new Date(1e3*this.c.presentationTimeline.f+1e3*this.f.currentTime):null},W.prototype.getPlayheadTimeAsDate=W.prototype.Ic,W.prototype.getStats=function(){Ig(this),this.Na();var a=null,b=null,c=this.f&&this.f.getVideoPlaybackQuality?this.f.getVideoPlaybackQuality():{};return this.g&&this.c&&(a=fc(this.c,nf(this.g)),b=this.M[a],b=ec(b.audio,b.video,this.c.periods[a].variants),a=b.video||{}),a||(a={}),b||(b={}),{width:a.width||0,height:a.height||0,streamBandwidth:b.bandwidth||0,decodedFrames:Number(c.totalVideoFrames),droppedFrames:Number(c.droppedVideoFrames),estimatedBandwidth:this.b.abr.manager.getBandwidthEstimate(),loadLatency:this.i.loadLatency,playTime:this.i.playTime,bufferingTime:this.i.bufferingTime,switchHistory:Da(this.i.switchHistory),stateHistory:Da(this.i.stateHistory)}},W.prototype.getStats=W.prototype.getStats,W.prototype.addTextTrack=function(a,b,c,d,e){if(!this.a)return Promise.reject();for(var g,f=V(this.a),h=0;h<this.c.periods.length;h++)if(this.c.periods[h]==f){if(h==this.c.periods.length-1){if(g=this.c.presentationTimeline.W()-f.startTime,1/0==g)return Promise.reject()}else g=this.c.periods[h+1].startTime-f.startTime;break}var l={id:this.sc++,createSegmentIndex:Promise.resolve.bind(Promise),findSegmentPosition:function(){return 1},getSegmentReference:function(b){return 1!=b?null:new N(1,0,g,function(){return[a]},0,null)},initSegmentReference:null,presentationTimeOffset:0,mimeType:d,codecs:e||"",kind:c,encrypted:!1,keyId:null,language:b,type:"text",primary:!1,trickModeVideo:null,containsEmsgBoxes:!1};return this.Qa.push(l.id),f.textStreams.push(l),Af(this.a,l).then(function(){return this.I?void 0:(this.Qa.splice(this.Qa.indexOf(l.id),1),Cg(this,f),yg(this),{id:l.id,active:!1,type:"text",bandwidth:0,language:b,kind:c,width:null,height:null})}.bind(this))},W.prototype.addTextTrack=W.prototype.addTextTrack,W.prototype.Ab=function(a,b){this.hb.width=a,this.hb.height=b},W.prototype.setMaxHardwareResolution=W.prototype.Ab,k=W.prototype,k.$a=function(a){var b=this.a?zf(this.a):{};if(Ub(this.j,b,a),b=0<Yb(a.variants).length,Tb(a,this.b.restrictions,this.hb)&&this.a&&V(this.a)==a&&yg(this),a=1>Yb(a.variants).length,!b)throw new t(2,4,4011);if(a)throw new t(2,4,4012)},k.Sd=function(a,b){this.b.abr.manager.segmentDownloaded(a,b)},k.oc=function(a){if(Ig(this),this.ha=a,this.Na(),this.g){var b=this.g;a!=b.h&&(b.h=a,pf(b,b.g))}this.dispatchEvent(new H("buffering",{buffering:a}))},k.Od=function(){yg(this)},k.Na=function(){if(!this.I){var a;a=this.ha?"buffering":this.f.ended?"ended":this.f.paused?"paused":"playing";var b=Date.now()/1e3;if(this.i.stateHistory.length){var c=this.i.stateHistory[this.i.stateHistory.length-1];if(c.duration=b-c.timestamp,a==c.state)return}this.i.stateHistory.push({timestamp:b,state:a,duration:0})}},k.Rd=function(){if(this.v){var a=this.v;a.c.forEach(a.o.bind(a,!0))}this.a&&Ef(this.a)},k.Tc=function(a){this.Ua=!0,this.b.abr.manager.disable();var b=bc(a,this.fa),c=cc(a,this.ya);a=Jg(this,a,b,c,!0);for(var d in this.B)a[d]=this.B[d].stream;this.B={};for(d in a)Eg(this,a[d],!0);return a},k.vc=function(){this.Ua=!1,this.b.abr.enabled&&this.b.abr.manager.enable();for(var a in this.B){var b=this.B[a];Cf(this.a,a,b.stream,b.zc)}this.B={}},k.Zc=function(){this.h&&this.h.update&&this.h.update()},k.hd=function(){this.g&&this.g.tb()},k.Cb=function(a,b){var d,c=zf(this.a);for(d in a){var e=a[d];c[d]!=e?Eg(this,e,!0):delete a[d]}if(!La(a)&&this.a){for(d in a)Cf(this.a,d,a[d],b||!1);zg(this)}},k.ua=function(a){this.I||this.dispatchEvent(new H("error",{detail:a}))},k.ld=function(a){this.v?this.v.v(a):this.Sa.push(a)},k.ab=function(a){this.dispatchEvent(a)},k.md=function(){if(this.f.error){var a=this.f.error.code;if(1!=a){var b=this.f.error.msExtendedCode;b&&(0>b&&(b+=Math.pow(2,32)),b=b.toString(16)),this.ua(new t(2,3,3016,a,b))}}},k.Qd=function(a){var b=["output-restricted","internal-error"],c=V(this.a),d=!1;c.variants.forEach(function(c){var e=[];c.audio&&e.push(c.audio),c.video&&e.push(c.video),e.forEach(function(e){var f=c.allowedByKeySystem;e.keyId&&(e=a[e.keyId],c.allowedByKeySystem=!!e&&0>b.indexOf(e)),f!=c.allowedByKeySystem&&(d=!0)})});var e=zf(this.a);(e=dc(e.audio,e.video,c.variants))&&!e.allowedByKeySystem&&Cg(this,c),d&&yg(this)},k.Pd=function(a,b){this.h&&this.h.onExpirationUpdated&&this.h.onExpirationUpdated(a,b),this.dispatchEvent(new H("expirationupdated"))},m("shaka.offline.Storage",X),X.support=Lg,X.prototype.m=function(){var a=this.a,b=this.h?this.h.m()["catch"](function(){}).then(function(){return a?a.m():void 0}):Promise.resolve();return this.i=this.f=this.h=this.a=null,b},X.prototype.destroy=X.prototype.m,X.prototype.configure=function(a){Ca(this.i,a,Kg(this),{},"")},X.prototype.configure=X.prototype.configure,X.prototype.$d=function(a,b,c){function d(a){f=a}if(this.v)return Promise.reject(new t(2,9,9006));this.v=!0;var e,f=null;return Mg(this).then(function(){return Y(this),Ng(this,a,d,c)}.bind(this)).then(function(c){if(Y(this),this.c=c.manifest,this.b=c.Ac,this.c.presentationTimeline.aa()||this.c.presentationTimeline.sa())throw new t(2,9,9005,a);this.c.periods.forEach(this.o.bind(this)),this.g=this.a.b.manifest++,this.l=0,c=this.c.periods.map(this.B.bind(this));var d=this.b.b,f=hb(this.b);if(d){if(!f.length)throw new t(2,9,9007,a);d.initData=[]}return e={key:this.g,originalManifestUri:a,duration:this.l,size:0,expiration:this.b.Wa(),periods:c,sessionIds:f,drmInfo:d,appMetadata:b},lg(this.h,e)}.bind(this)).then(function(){if(Y(this),f)throw f;return Og(this)}.bind(this)).then(function(){return cg(e)}.bind(this))["catch"](function(a){return Og(this)["catch"](y).then(function(){throw a})}.bind(this))},X.prototype.store=X.prototype.$d,X.prototype.remove=function(a){function b(a){6013!=a.code&&(e=a)}var c=a.offlineUri,d=/^offline:([0-9]+)$/.exec(c);if(!d)return Promise.reject(new t(2,9,9004,c));var f,g,e=null,h=Number(d[1]);return Mg(this).then(function(){return Y(this),this.a.get("manifest",h)}.bind(this)).then(function(a){if(Y(this),!a)throw new t(2,9,9003,c);return f=a,a=og(f),g=new $a(this.f.o,b,function(){},function(){}),g.configure(this.f.getConfiguration().drm),g.init(a,!0)}.bind(this)).then(function(){return eb(g,f.sessionIds)}.bind(this)).then(function(){return g.m()}.bind(this)).then(function(){if(Y(this),e)throw e;var b=f.periods.map(function(a){return a.streams.map(function(a){var b=a.segments.map(function(a){return a=/^offline:[0-9]+\/[0-9]+\/([0-9]+)$/.exec(a.uri),Number(a[1])});return a.initSegmentUri&&(a=/^offline:[0-9]+\/[0-9]+\/([0-9]+)$/.exec(a.initSegmentUri),b.push(Number(a[1]))),b}).reduce(x,[])}).reduce(x,[]),c=0,d=b.length,g=this.i.progressCallback;return $f(this.a,function(e){return e=b.indexOf(e.key),e>=0&&(g(a,c/d),c++),e>=0}.bind(this))}.bind(this)).then(function(){return Y(this),this.i.progressCallback(a,1),this.a.remove("manifest",h)}.bind(this))},X.prototype.remove=X.prototype.remove,X.prototype.list=function(){var a=[];return Mg(this).then(function(){return Y(this),this.a.forEach("manifest",function(b){a.push(cg(b))})}.bind(this)).then(function(){return a})},X.prototype.list=X.prototype.list,X.prototype.A=function(a){for(var f,b=[],c=Qb(this.f.getConfiguration().preferredAudioLanguage),d=[0,Ob,Pb],e=a.filter(function(a){return"variant"==a.type}),d=d.map(function(a){return e.filter(function(b){return b=Qb(b.language),Nb(a,c,b)})}),g=0;g<d.length;g++)if(d[g].length){f=d[g];break}f||(d=e.filter(function(a){return a.primary}),d.length&&(f=d)),f||(f=e,e.map(function(a){return a.language}).filter(Aa));var h=f.filter(function(a){return a.height&&480>=a.height});return h.length&&(h.sort(function(a,b){return b.height-a.height}),f=h.filter(function(a){return a.height==h[0].height})),f.sort(function(a,b){return a.bandwidth-b.bandwidth}),f.length&&b.push(f[Math.floor(f.length/2)]),b.push.apply(b,a.filter(function(a){return"text"==a.type})),b},X.prototype.o=function(a){var b={};if(this.j){var c=this.j.filter(function(a){return"variant"==a.type}),d=null;c.length&&(d=$b(a,c[0])),d&&(d.video&&(b.video=d.video),d.audio&&(b.audio=d.audio))}Ub(this.b,b,a),Tb(a,this.f.getConfiguration().restrictions,{width:1/0,height:1/0})},X.prototype.B=function(a){var b=Xb(a,null,null),c=Zb(a,null),b=this.i.trackSelectionCallback(b.concat(c));for(this.j||(this.j=b,this.c.periods.forEach(this.o.bind(this))),c=b.length-1;c>0;--c){for(var d=!1,e=c-1;e>=0;--e)if(b[c].type==b[e].type&&b[c].kind==b[e].kind&&b[c].language==b[e].language){d=!0;break}if(d)break}for(d=[],c=0;c<b.length;c++){var f=$b(a,b[c]);f?(f.audio&&((e=d.filter(function(a){return a.id==f.audio.id})[0])?e.variantIds.push(f.id):(e=f.video?f.bandwidth/2:f.bandwidth,d.push(Qg(this,a,f.audio,e,f.id)))),f.video&&((e=d.filter(function(a){return a.id==f.video.id})[0])?e.variantIds.push(f.id):(e=f.audio?f.bandwidth/2:f.bandwidth,d.push(Qg(this,a,f.video,e,f.id))))):d.push(Qg(this,a,ac(a,b[c]),0))}return{startTime:a.startTime,streams:d}},wg.offline=Lg,m("shaka.polyfill.installAll",function(){for(var a=0;a<Rg.length;++a)Rg[a]()});var Rg=[];m("shaka.polyfill.register",Sg),Sg(function(){if(window.Document){var a=Element.prototype;a.requestFullscreen=a.requestFullscreen||a.mozRequestFullScreen||a.msRequestFullscreen||a.webkitRequestFullscreen,a=Document.prototype,a.exitFullscreen=a.exitFullscreen||a.mozCancelFullScreen||a.msExitFullscreen||a.webkitExitFullscreen,"fullscreenElement"in document||(Object.defineProperty(document,"fullscreenElement",{get:function(){return document.mozFullScreenElement||document.msFullscreenElement||document.webkitFullscreenElement}}),Object.defineProperty(document,"fullscreenEnabled",{get:function(){return document.mozFullScreenEnabled||document.msFullscreenEnabled||document.webkitFullscreenEnabled}})),document.addEventListener("webkitfullscreenchange",Tg),document.addEventListener("webkitfullscreenerror",Tg),document.addEventListener("mozfullscreenchange",Tg),document.addEventListener("mozfullscreenerror",Tg),document.addEventListener("MSFullscreenChange",Tg),document.addEventListener("MSFullscreenError",Tg)}}),Sg(function(){var a=navigator.userAgent;a&&0<=a.indexOf("CrKey")&&delete window.indexedDB}),Ug.prototype.c=function(a){if(!(1<a.version)){var b=Ya(ed(a.s,16)),c=[];if(0<a.version)for(var d=O(a.s),e=0;d>e;++e){var f=Ya(ed(a.s,16));c.push(f)}d=O(a.s),P(a.s,d),this.b.push.apply(this.b,c),this.f.push(b),this.a.push({start:a.start,end:a.start+a.size-1})}},Wg.prototype.createMediaKeys=function(){var a=new Xg(this.keySystem);return Promise.resolve(a)},Wg.prototype.getConfiguration=function(){return this.a},Xg.prototype.createSession=function(a){if("temporary"!=(a||"temporary"))throw new TypeError("Session type "+a+" is unsupported on this platform.");return new $g(this.a)},Xg.prototype.setServerCertificate=function(){return Promise.resolve(!1)},ba($g),k=$g.prototype,k.generateRequest=function(a,b){this.a=new A;try{this.c=this.g.createSession("video/mp4",new Uint8Array(b),null),E(this.f,this.c,"mskeymessage",this.cd.bind(this)),E(this.f,this.c,"mskeyadded",this.ad.bind(this)),E(this.f,this.c,"mskeyerror",this.bd.bind(this)),ch(this,"status-pending")}catch(c){this.a.reject(c)}return this.a},k.load=function(){return Promise.reject(Error("MediaKeySession.load not yet supported"))},k.update=function(a){this.b=new A;try{this.c.update(new Uint8Array(a))}catch(b){this.b.reject(b)}return this.b},k.close=function(){try{this.c.close(),this.closed.resolve(),Ia(this.f)}catch(a){this.closed.reject(a)}return this.closed},k.remove=function(){return Promise.reject(Error("MediaKeySession.remove is only applicable for persistent licenses, which are not supported on this platform"))},k.cd=function(a){this.a&&(this.a.resolve(),this.a=null),this.dispatchEvent(new H("message",{messageType:void 0==this.keyStatuses.lb()?"licenserequest":"licenserenewal",message:a.message.buffer}))},k.ad=function(){this.a?(ch(this,"usable"),this.a.resolve(),this.a=null):this.b&&(ch(this,"usable"),this.b.resolve(),this.b=null)},k.bd=function(){var a=Error("EME PatchedMediaKeysMs key error");if(a.errorCode=this.c.error,this.a)this.a.reject(a),this.a=null;else if(this.b)this.b.reject(a),this.b=null;else switch(this.c.error.code){case MSMediaKeyError.MS_MEDIA_KEYERR_OUTPUT:case MSMediaKeyError.MS_MEDIA_KEYERR_HARDWARECHANGE:ch(this,"output-not-allowed");default:ch(this,"internal-error")}};var eh;k=bh.prototype,k.Bb=function(a){this.size=void 0==a?0:1,this.a=a},k.lb=function(){return this.a},k.forEach=function(a){this.a&&a(this.a,eh)},k.get=function(a){return this.has(a)?this.a:void 0},k.has=function(a){var b=eh;return this.a&&Za(new Uint8Array(a),new Uint8Array(b))?!0:!1},k.keys=function(){},hh.prototype.createSession=function(){},hh.prototype.setServerCertificate=function(){},ih.prototype.getConfiguration=function(){},ih.prototype.createMediaKeys=function(){};var jh="";ph.prototype.createMediaKeys=function(){var a=new oh(this.a);return Promise.resolve(a)},ph.prototype.getConfiguration=function(){return this.b},k=oh.prototype,k.createSession=function(a){var b=a||"temporary";if("temporary"!=b&&"persistent-license"!=b)throw new TypeError("Session type "+a+" is unsupported on this platform.");return a=this.b||document.createElement("video"),a.src||(a.src="about:blank"),b=new sh(a,this.g,b),this.c.push(b),b},k.setServerCertificate=function(){return Promise.resolve(!1)},k.qd=function(a){var b=document.createEvent("CustomEvent");b.initCustomEvent("encrypted",!1,!1,null),b.initDataType="webm",b.initData=a.initData,this.b.dispatchEvent(b)},k.pd=function(a){var b=th(this,a.sessionId);b&&(a=new H("message",{messageType:void 0==b.keyStatuses.lb()?"licenserequest":"licenserenewal",message:a.message}),b.b&&(b.b.resolve(),b.b=null),b.dispatchEvent(a))},k.nd=function(a){(a=th(this,a.sessionId))&&(uh(a,"usable"),a.a&&a.a.resolve(),a.a=null)},k.od=function(a){var b=th(this,a.sessionId);if(b){var c=Error("EME v0.1b key error");c.errorCode=a.errorCode,c.errorCode.systemCode=a.systemCode,!a.sessionId&&b.b?(c.method="generateRequest",45==a.systemCode&&(c.message="Unsupported session type."),b.b.reject(c),b.b=null):a.sessionId&&b.a?(c.method="update",b.a.reject(c),b.a=null):(c=a.systemCode,a.errorCode.code==MediaKeyError.MEDIA_KEYERR_OUTPUT?uh(b,"output-restricted"):1==c?uh(b,"expired"):uh(b,"internal-error"))}},ba(sh),k=sh.prototype,k.Db=function(a,b){if(this.a)this.a.then(this.Db.bind(this,a,b))["catch"](this.Db.bind(this,a,b));else{this.a=a;var c,d;"webkit-org.w3.clearkey"==this.c?(c=F(b),d=JSON.parse(c),"oct"!=d.keys[0].kty&&(this.a.reject(Error("Response is not a valid JSON Web Key Set.")),this.a=null),c=Wa(d.keys[0].k),d=Wa(d.keys[0].kid)):(c=new Uint8Array(b),d=null);var e=qh("addKey");try{this.f[e](this.c,c,d,this.sessionId)}catch(f){this.a.reject(f),this.a=null}}},k.generateRequest=function(a,b){return wh(this,b,null)},k.load=function(a){return"persistent-license"==this.g?wh(this,null,a):Promise.reject(Error("Not a persistent session."))},k.update=function(a){var b=new A;return this.Db(b,a),b},k.close=function(){if("persistent-license"!=this.g){if(!this.sessionId)return this.closed.reject(Error("The session is not callable.")),this.closed;var a=qh("cancelKeyRequest");try{this.f[a](this.c,this.sessionId)}catch(b){}}return this.closed.resolve(),this.closed},k.remove=function(){return"persistent-license"!=this.g?Promise.reject(Error("Not a persistent session.")):this.close()};var lh;k=vh.prototype,k.Bb=function(a){this.size=void 0==a?0:1,this.a=a},k.lb=function(){return this.a},k.forEach=function(a){this.a&&a(this.a,lh)},k.get=function(a){return this.has(a)?this.a:void 0},k.has=function(a){var b=lh;return this.a&&Za(new Uint8Array(a),new Uint8Array(b))?!0:!1},k.keys=function(){},Sg(function(){!window.HTMLVideoElement||navigator.requestMediaKeySystemAccess&&MediaKeySystemAccess.prototype.getConfiguration||(HTMLMediaElement.prototype.webkitGenerateKeyRequest?kh("webkit"):HTMLMediaElement.prototype.generateKeyRequest?kh(""):window.MSMediaKeys?(eh=new Uint8Array([0]).buffer,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=Yg,window.MediaKeys=Xg,window.MediaKeySystemAccess=Wg,navigator.requestMediaKeySystemAccess=Vg):(navigator.requestMediaKeySystemAccess=fh,delete HTMLMediaElement.prototype.mediaKeys,HTMLMediaElement.prototype.mediaKeys=null,HTMLMediaElement.prototype.setMediaKeys=gh,window.MediaKeys=hh,window.MediaKeySystemAccess=ih))}),Sg(function(){if(window.MediaSource){var a=navigator.vendor,b=navigator.appVersion;!a||!b||0>a.indexOf("Apple")||(0<=b.indexOf("Version/8")?window.MediaSource=null:0<=b.indexOf("Version/9")?xh():0<=b.indexOf("Version/10")&&(xh(),yh()))}});var Bh=0;Z.prototype.then=function(a,b){var c=new Z;switch(this.wa){case 1:Gh(this,c,a);break;case 2:Gh(this,c,b);break;case Bh:this.c.push({O:c,ib:a}),this.b.push({O:c,ib:b})}return c},Z.prototype["catch"]=function(a){return this.then(void 0,a)},Z.prototype.ca=function(a){if(this.wa==Bh){for(this.eb=a,this.wa=1,a=0;a<this.c.length;++a)Gh(this,this.c[a].O,this.c[a].ib);this.c=[],this.b=[]}},Z.prototype.a=function(a){if(this.wa==Bh){for(this.eb=a,this.wa=2,a=0;a<this.b.length;++a)Gh(this,this.b[a].O,this.b[a].ib);this.c=[],this.b=[]}};var Jh=null,Hh=[];Sg(function(a){window.setImmediate?(Kh=function(a){return window.setImmediate(a)},Mh=function(a){return window.clearImmediate(a)}):(Kh=function(a){return window.setTimeout(a,0)},Mh=function(a){return window.clearTimeout(a)}),(!window.Promise||a)&&(window.Promise=Z,window.Promise.resolve=Ch,window.Promise.reject=Dh,window.Promise.all=Eh,window.Promise.race=Fh,window.Promise.prototype.then=Z.prototype.then,window.Promise.prototype["catch"]=Z.prototype["catch"])}),Sg(function(){if(window.HTMLVideoElement){var a=HTMLVideoElement.prototype;!a.getVideoPlaybackQuality&&"webkitDroppedFrameCount"in a&&(a.getVideoPlaybackQuality=Nh)}}),Sg(function(){if(!window.VTTCue&&window.TextTrackCue){var a=TextTrackCue.length;if(3==a)window.VTTCue=Oh;else if(6==a)window.VTTCue=Ph;else{var b;try{b=!!Oh(1,2,"")}catch(c){b=!1}b&&(window.VTTCue=Oh)}}})}).call(g,this),"undefined"!=typeof module&&module.exports?module.exports=g.shaka:"undefined"!=typeof define&&define.amd?define(function(){return g.shaka}):this.shaka=g.shaka}()},{}],5:[function(_dereq_,module){var Stats=function(){var l=Date.now(),m=l,g=0,n=1/0,o=0,h=0,p=1/0,q=0,r=0,s=0,f=document.createElement("div");f.id="stats",f.addEventListener("mousedown",function(b){b.preventDefault(),t(++s%2)},!1),f.style.cssText="width:80px;opacity:0.9;cursor:pointer";var a=document.createElement("div");a.id="fps",a.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#002",f.appendChild(a);var i=document.createElement("div");i.id="fpsText",i.style.cssText="color:#0ff;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px",i.innerHTML="FPS",a.appendChild(i);var c=document.createElement("div");for(c.id="fpsGraph",c.style.cssText="position:relative;width:74px;height:30px;background-color:#0ff",a.appendChild(c);74>c.children.length;){var j=document.createElement("span");j.style.cssText="width:1px;height:30px;float:left;background-color:#113",c.appendChild(j)}var d=document.createElement("div");d.id="ms",d.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#020;display:none",f.appendChild(d);var k=document.createElement("div");k.id="msText",k.style.cssText="color:#0f0;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px",k.innerHTML="MS",d.appendChild(k);var e=document.createElement("div");for(e.id="msGraph",e.style.cssText="position:relative;width:74px;height:30px;background-color:#0f0",d.appendChild(e);74>e.children.length;)j=document.createElement("span"),j.style.cssText="width:1px;height:30px;float:left;background-color:#131",e.appendChild(j);var t=function(b){switch(s=b){case 0:a.style.display="block",d.style.display="none";break;case 1:a.style.display="none",d.style.display="block"}};return{REVISION:12,domElement:f,setMode:t,begin:function(){l=Date.now()},end:function(){var b=Date.now();g=b-l,n=Math.min(n,g),o=Math.max(o,g),k.textContent=g+" MS ("+n+"-"+o+")";var a=Math.min(30,30-30*(g/200));return e.appendChild(e.firstChild).style.height=a+"px",r++,b>m+1e3&&(h=Math.round(1e3*r/(b-m)),p=Math.min(p,h),q=Math.max(q,h),i.textContent=h+" FPS ("+p+"-"+q+")",a=Math.min(30,30-30*(h/100)),c.appendChild(c.firstChild).style.height=a+"px",m=b,r=0),b},update:function(){l=this.end()}}};"object"==typeof module&&(module.exports=Stats)},{}],6:[function(_dereq_,module,exports){(function(process){var TWEEN=TWEEN||function(){var _tweens=[];return{getAll:function(){return _tweens},removeAll:function(){_tweens=[]},add:function(tween){_tweens.push(tween)},remove:function(tween){var i=_tweens.indexOf(tween);-1!==i&&_tweens.splice(i,1)},update:function(time,preserve){if(0===_tweens.length)return!1;var i=0;for(time=void 0!==time?time:TWEEN.now();i<_tweens.length;)_tweens[i].update(time)||preserve?i++:_tweens.splice(i,1);return!0}}}();TWEEN.now="undefined"==typeof window&&"undefined"!=typeof process?function(){var time=process.hrtime();return 1e3*time[0]+time[1]/1e6}:"undefined"!=typeof window&&void 0!==window.performance&&void 0!==window.performance.now?window.performance.now.bind(window.performance):void 0!==Date.now?Date.now:function(){return(new Date).getTime()},TWEEN.Tween=function(object){var _repeatDelayTime,_object=object,_valuesStart={},_valuesEnd={},_valuesStartRepeat={},_duration=1e3,_repeat=0,_yoyo=!1,_isPlaying=!1,_reversed=!1,_delayTime=0,_startTime=null,_easingFunction=TWEEN.Easing.Linear.None,_interpolationFunction=TWEEN.Interpolation.Linear,_chainedTweens=[],_onStartCallback=null,_onStartCallbackFired=!1,_onUpdateCallback=null,_onCompleteCallback=null,_onStopCallback=null;this.to=function(properties,duration){return _valuesEnd=properties,void 0!==duration&&(_duration=duration),this},this.start=function(time){TWEEN.add(this),_isPlaying=!0,_onStartCallbackFired=!1,_startTime=void 0!==time?time:TWEEN.now(),_startTime+=_delayTime;for(var property in _valuesEnd){if(_valuesEnd[property]instanceof Array){if(0===_valuesEnd[property].length)continue;_valuesEnd[property]=[_object[property]].concat(_valuesEnd[property])}void 0!==_object[property]&&(_valuesStart[property]=_object[property],_valuesStart[property]instanceof Array==!1&&(_valuesStart[property]*=1),_valuesStartRepeat[property]=_valuesStart[property]||0)}return this},this.stop=function(){return _isPlaying?(TWEEN.remove(this),_isPlaying=!1,null!==_onStopCallback&&_onStopCallback.call(_object,_object),this.stopChainedTweens(),this):this},this.end=function(){return this.update(_startTime+_duration),this},this.stopChainedTweens=function(){for(var i=0,numChainedTweens=_chainedTweens.length;numChainedTweens>i;i++)_chainedTweens[i].stop()},this.delay=function(amount){return _delayTime=amount,this},this.repeat=function(times){return _repeat=times,this},this.repeatDelay=function(amount){return _repeatDelayTime=amount,this},this.yoyo=function(yoyo){return _yoyo=yoyo,this},this.easing=function(easing){return _easingFunction=easing,this},this.interpolation=function(interpolation){return _interpolationFunction=interpolation,this},this.chain=function(){return _chainedTweens=arguments,this},this.onStart=function(callback){return _onStartCallback=callback,this},this.onUpdate=function(callback){return _onUpdateCallback=callback,this},this.onComplete=function(callback){return _onCompleteCallback=callback,this},this.onStop=function(callback){return _onStopCallback=callback,this},this.update=function(time){var property,elapsed,value;if(_startTime>time)return!0;_onStartCallbackFired===!1&&(null!==_onStartCallback&&_onStartCallback.call(_object,_object),_onStartCallbackFired=!0),elapsed=(time-_startTime)/_duration,elapsed=elapsed>1?1:elapsed,value=_easingFunction(elapsed);for(property in _valuesEnd)if(void 0!==_valuesStart[property]){var start=_valuesStart[property]||0,end=_valuesEnd[property];end instanceof Array?_object[property]=_interpolationFunction(end,value):("string"==typeof end&&(end="+"===end.charAt(0)||"-"===end.charAt(0)?start+parseFloat(end):parseFloat(end)),"number"==typeof end&&(_object[property]=start+(end-start)*value))}if(null!==_onUpdateCallback&&_onUpdateCallback.call(_object,value),1===elapsed){if(_repeat>0){isFinite(_repeat)&&_repeat--;for(property in _valuesStartRepeat){if("string"==typeof _valuesEnd[property]&&(_valuesStartRepeat[property]=_valuesStartRepeat[property]+parseFloat(_valuesEnd[property])),_yoyo){var tmp=_valuesStartRepeat[property];_valuesStartRepeat[property]=_valuesEnd[property],_valuesEnd[property]=tmp}_valuesStart[property]=_valuesStartRepeat[property]}return _yoyo&&(_reversed=!_reversed),_startTime=void 0!==_repeatDelayTime?time+_repeatDelayTime:time+_delayTime,!0}null!==_onCompleteCallback&&_onCompleteCallback.call(_object,_object);for(var i=0,numChainedTweens=_chainedTweens.length;numChainedTweens>i;i++)_chainedTweens[i].start(_startTime+_duration);return!1}return!0}},TWEEN.Easing={Linear:{None:function(k){return k}},Quadratic:{In:function(k){return k*k},Out:function(k){return k*(2-k)},InOut:function(k){return(k*=2)<1?.5*k*k:-.5*(--k*(k-2)-1)}},Cubic:{In:function(k){return k*k*k},Out:function(k){return--k*k*k+1},InOut:function(k){return(k*=2)<1?.5*k*k*k:.5*((k-=2)*k*k+2)}},Quartic:{In:function(k){return k*k*k*k},Out:function(k){return 1- --k*k*k*k},InOut:function(k){return(k*=2)<1?.5*k*k*k*k:-.5*((k-=2)*k*k*k-2)}},Quintic:{In:function(k){return k*k*k*k*k},Out:function(k){return--k*k*k*k*k+1},InOut:function(k){return(k*=2)<1?.5*k*k*k*k*k:.5*((k-=2)*k*k*k*k+2)}},Sinusoidal:{In:function(k){return 1-Math.cos(k*Math.PI/2)},Out:function(k){return Math.sin(k*Math.PI/2)},InOut:function(k){return.5*(1-Math.cos(Math.PI*k))}},Exponential:{In:function(k){return 0===k?0:Math.pow(1024,k-1)},Out:function(k){return 1===k?1:1-Math.pow(2,-10*k)},InOut:function(k){return 0===k?0:1===k?1:(k*=2)<1?.5*Math.pow(1024,k-1):.5*(-Math.pow(2,-10*(k-1))+2)}},Circular:{In:function(k){return 1-Math.sqrt(1-k*k)},Out:function(k){return Math.sqrt(1- --k*k)},InOut:function(k){return(k*=2)<1?-.5*(Math.sqrt(1-k*k)-1):.5*(Math.sqrt(1-(k-=2)*k)+1)}},Elastic:{In:function(k){return 0===k?0:1===k?1:-Math.pow(2,10*(k-1))*Math.sin(5*(k-1.1)*Math.PI)},Out:function(k){return 0===k?0:1===k?1:Math.pow(2,-10*k)*Math.sin(5*(k-.1)*Math.PI)+1},InOut:function(k){return 0===k?0:1===k?1:(k*=2,1>k?-.5*Math.pow(2,10*(k-1))*Math.sin(5*(k-1.1)*Math.PI):.5*Math.pow(2,-10*(k-1))*Math.sin(5*(k-1.1)*Math.PI)+1)}},Back:{In:function(k){var s=1.70158;return k*k*((s+1)*k-s)},Out:function(k){var s=1.70158;return--k*k*((s+1)*k+s)+1},InOut:function(k){var s=2.5949095;return(k*=2)<1?.5*k*k*((s+1)*k-s):.5*((k-=2)*k*((s+1)*k+s)+2)}},Bounce:{In:function(k){return 1-TWEEN.Easing.Bounce.Out(1-k)},Out:function(k){return 1/2.75>k?7.5625*k*k:2/2.75>k?7.5625*(k-=1.5/2.75)*k+.75:2.5/2.75>k?7.5625*(k-=2.25/2.75)*k+.9375:7.5625*(k-=2.625/2.75)*k+.984375},InOut:function(k){return.5>k?.5*TWEEN.Easing.Bounce.In(2*k):.5*TWEEN.Easing.Bounce.Out(2*k-1)+.5}}},TWEEN.Interpolation={Linear:function(v,k){var m=v.length-1,f=m*k,i=Math.floor(f),fn=TWEEN.Interpolation.Utils.Linear;return 0>k?fn(v[0],v[1],f):k>1?fn(v[m],v[m-1],m-f):fn(v[i],v[i+1>m?m:i+1],f-i)},Bezier:function(v,k){for(var b=0,n=v.length-1,pw=Math.pow,bn=TWEEN.Interpolation.Utils.Bernstein,i=0;n>=i;i++)b+=pw(1-k,n-i)*pw(k,i)*v[i]*bn(n,i);return b},CatmullRom:function(v,k){var m=v.length-1,f=m*k,i=Math.floor(f),fn=TWEEN.Interpolation.Utils.CatmullRom;return v[0]===v[m]?(0>k&&(i=Math.floor(f=m*(1+k))),fn(v[(i-1+m)%m],v[i],v[(i+1)%m],v[(i+2)%m],f-i)):0>k?v[0]-(fn(v[0],v[0],v[1],v[1],-f)-v[0]):k>1?v[m]-(fn(v[m],v[m],v[m-1],v[m-1],f-m)-v[m]):fn(v[i?i-1:0],v[i],v[i+1>m?m:i+1],v[i+2>m?m:i+2],f-i)},Utils:{Linear:function(p0,p1,t){return(p1-p0)*t+p0},Bernstein:function(n,i){var fc=TWEEN.Interpolation.Utils.Factorial;return fc(n)/fc(i)/fc(n-i)},Factorial:function(){var a=[1];return function(n){var s=1;if(a[n])return a[n];for(var i=n;i>1;i--)s*=i;return a[n]=s,s}}(),CatmullRom:function(p0,p1,p2,p3,t){var v0=.5*(p2-p0),v1=.5*(p3-p1),t2=t*t,t3=t*t2;return(2*p1-2*p2+v0+v1)*t3+(-3*p1+3*p2-2*v0-v1)*t2+v0*t+p1}}},function(root){"function"==typeof define&&define.amd?define([],function(){return TWEEN}):"undefined"!=typeof module&&"object"==typeof exports?module.exports=TWEEN:void 0!==root&&(root.TWEEN=TWEEN)}(this)}).call(this,_dereq_("_process"))},{_process:3}],7:[function(_dereq_,module,exports){(function(global){!function(f){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=f();else if("function"==typeof define&&define.amd)define([],f);else{var g;g="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,g.WebVRManager=f()}}(function(){return function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a="function"==typeof _dereq_&&_dereq_;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}for(var i="function"==typeof _dereq_&&_dereq_,o=0;o<r.length;o++)s(r[o]);return s}({1:[function(_dereq_,module){function ButtonManager(opt_root){var root=opt_root||document.body;this.loadIcons_();var fsButton=this.createButton();fsButton.src=this.ICONS.fullscreen,fsButton.title="Fullscreen mode";var s=fsButton.style;s.bottom=0,s.right=0,fsButton.addEventListener("click",this.createClickHandler_("fs")),root.appendChild(fsButton),this.fsButton=fsButton;var vrButton=this.createButton();vrButton.src=this.ICONS.cardboard,vrButton.title="Virtual reality mode";var s=vrButton.style;s.bottom=0,s.right="48px",vrButton.addEventListener("click",this.createClickHandler_("vr")),root.appendChild(vrButton),this.vrButton=vrButton,this.isVisible=!0}var Emitter=_dereq_("./emitter.js"),Modes=_dereq_("./modes.js"),Util=_dereq_("./util.js");ButtonManager.prototype=new Emitter,ButtonManager.prototype.createButton=function(){var button=document.createElement("img");button.className="webvr-button";var s=button.style;return s.position="absolute",s.width="24px",s.height="24px",s.backgroundSize="cover",s.backgroundColor="transparent",s.border=0,s.userSelect="none",s.webkitUserSelect="none",s.MozUserSelect="none",s.cursor="pointer",s.padding="12px",s.zIndex=1,s.display="none",s.boxSizing="content-box",button.draggable=!1,button.addEventListener("dragstart",function(e){
e.preventDefault()}),button.addEventListener("mouseenter",function(){s.filter=s.webkitFilter="drop-shadow(0 0 5px rgba(255,255,255,1))"}),button.addEventListener("mouseleave",function(){s.filter=s.webkitFilter=""}),button},ButtonManager.prototype.setMode=function(mode,isVRCompatible){if(isVRCompatible=isVRCompatible||WebVRConfig.FORCE_ENABLE_VR,this.isVisible){switch(mode){case Modes.NORMAL:this.fsButton.style.display="block",this.fsButton.src=this.ICONS.fullscreen,this.vrButton.style.display=isVRCompatible?"block":"none";break;case Modes.MAGIC_WINDOW:this.fsButton.style.display="block",this.fsButton.src=this.ICONS.exitFullscreen,this.vrButton.style.display="none";break;case Modes.VR:this.fsButton.style.display="none",this.vrButton.style.display="none"}var oldValue=this.fsButton.style.display;this.fsButton.style.display="inline-block",this.fsButton.offsetHeight,this.fsButton.style.display=oldValue}},ButtonManager.prototype.setVisibility=function(isVisible){this.isVisible=isVisible,this.fsButton.style.display=isVisible?"block":"none",this.vrButton.style.display=isVisible?"block":"none"},ButtonManager.prototype.createClickHandler_=function(eventName){return function(e){e.stopPropagation(),e.preventDefault(),this.emit(eventName)}.bind(this)},ButtonManager.prototype.loadIcons_=function(){this.ICONS={},this.ICONS.cardboard=Util.base64("image/svg+xml",""),this.ICONS.fullscreen=Util.base64("image/svg+xml",""),this.ICONS.exitFullscreen=Util.base64("image/svg+xml",""),this.ICONS.settings=Util.base64("image/svg+xml","")},module.exports=ButtonManager},{"./emitter.js":2,"./modes.js":3,"./util.js":4}],2:[function(_dereq_,module){function Emitter(){this.callbacks={}}Emitter.prototype.emit=function(eventName){var callbacks=this.callbacks[eventName];if(callbacks){var args=[].slice.call(arguments);args.shift();for(var i=0;i<callbacks.length;i++)callbacks[i].apply(this,args)}},Emitter.prototype.on=function(eventName,callback){eventName in this.callbacks?this.callbacks[eventName].push(callback):this.callbacks[eventName]=[callback]},module.exports=Emitter},{}],3:[function(_dereq_,module){var Modes={UNKNOWN:0,NORMAL:1,MAGIC_WINDOW:2,VR:3};module.exports=Modes},{}],4:[function(_dereq_,module){var Util={};Util.base64=function(mimeType,base64){return"data:"+mimeType+";base64,"+base64},Util.isMobile=function(){var check=!1;return function(a){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(a)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(a.substr(0,4)))&&(check=!0)}(navigator.userAgent||navigator.vendor||window.opera),check},Util.isFirefox=function(){return/firefox/i.test(navigator.userAgent)},Util.isIOS=function(){return/(iPad|iPhone|iPod)/g.test(navigator.userAgent)},Util.isIFrame=function(){try{return window.self!==window.top}catch(e){return!0}},Util.appendQueryParameter=function(url,key,value){var delimiter=url.indexOf("?")<0?"?":"&";return url+=delimiter+key+"="+value},Util.getQueryParameter=function(name){var name=name.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]"),regex=new RegExp("[\\?&]"+name+"=([^&#]*)"),results=regex.exec(location.search);return null===results?"":decodeURIComponent(results[1].replace(/\+/g," "))},Util.isLandscapeMode=function(){return 90==window.orientation||-90==window.orientation},Util.getScreenWidth=function(){return Math.max(window.screen.width,window.screen.height)*window.devicePixelRatio},Util.getScreenHeight=function(){return Math.min(window.screen.width,window.screen.height)*window.devicePixelRatio},module.exports=Util},{}],5:[function(_dereq_,module){function WebVRManager(renderer,effect,params){this.params=params||{},this.mode=Modes.UNKNOWN,this.hideButton=this.params.hideButton||!1,this.predistorted=!!this.params.predistorted,this.renderer=renderer,this.effect=effect;var polyfillWrapper=document.querySelector(".webvr-polyfill-fullscreen-wrapper");this.button=new ButtonManager(polyfillWrapper),this.isFullscreenDisabled=!!Util.getQueryParameter("no_fullscreen"),this.startMode=Modes.NORMAL;var startModeParam=parseInt(Util.getQueryParameter("start_mode"));isNaN(startModeParam)||(this.startMode=startModeParam),this.hideButton&&this.button.setVisibility(!1),this.getDeviceByType_(VRDisplay).then(function(hmd){switch(this.hmd=hmd,this.isVRCompatibleOverride||(this.isVRCompatible=!hmd.isPolyfilled||Util.isMobile()),this.startMode){case Modes.MAGIC_WINDOW:this.setMode_(Modes.MAGIC_WINDOW);break;case Modes.VR:this.enterVRMode_(),this.setMode_(Modes.VR);break;default:this.setMode_(Modes.NORMAL)}this.emit("initialized")}.bind(this)),this.button.on("fs",this.onFSClick_.bind(this)),this.button.on("vr",this.onVRClick_.bind(this)),document.addEventListener("webkitfullscreenchange",this.onFullscreenChange_.bind(this)),document.addEventListener("mozfullscreenchange",this.onFullscreenChange_.bind(this)),document.addEventListener("msfullscreenchange",this.onFullscreenChange_.bind(this)),window.addEventListener("vrdisplaypresentchange",this.onVRDisplayPresentChange_.bind(this)),window.addEventListener("vrdisplaydeviceparamschange",this.onVRDisplayDeviceParamsChange_.bind(this))}var ButtonManager=_dereq_("./button-manager.js"),Emitter=_dereq_("./emitter.js"),Modes=_dereq_("./modes.js"),Util=_dereq_("./util.js");WebVRManager.prototype=new Emitter,WebVRManager.Modes=Modes,WebVRManager.prototype.render=function(scene,camera){scene instanceof Array?this.effect.render(scene[0],camera):this.effect.render(scene,camera)},WebVRManager.prototype.setVRCompatibleOverride=function(isVRCompatible){this.isVRCompatible=isVRCompatible,this.isVRCompatibleOverride=!0,this.button.setMode(this.mode,this.isVRCompatible)},WebVRManager.prototype.setFullscreenCallback=function(callback){this.fullscreenCallback=callback},WebVRManager.prototype.setVRCallback=function(callback){this.vrCallback=callback},WebVRManager.prototype.setExitFullscreenCallback=function(callback){this.exitFullscreenCallback=callback},WebVRManager.prototype.getDeviceByType_=function(type){return new Promise(function(resolve){navigator.getVRDisplays().then(function(displays){for(var i=0;i<displays.length;i++)if(displays[i]instanceof type){resolve(displays[i]);break}resolve(null)},function(){resolve(null)})})},WebVRManager.prototype.enterVRMode_=function(){this.hmd.requestPresent([{source:this.renderer.domElement,predistorted:this.predistorted}])},WebVRManager.prototype.setMode_=function(mode){var oldMode=this.mode;return mode==this.mode?void console.warn("Not changing modes, already in %s",mode):(this.mode=mode,this.button.setMode(mode,this.isVRCompatible),void this.emit("modechange",mode,oldMode))},WebVRManager.prototype.onFSClick_=function(){switch(this.mode){case Modes.NORMAL:if(Util.isIOS()&&Util.isIFrame()){if(!this.fullscreenCallback){var url=window.location.href;return url=Util.appendQueryParameter(url,"no_fullscreen","true"),url=Util.appendQueryParameter(url,"start_mode",Modes.MAGIC_WINDOW),void(top.location.href=url)}this.fullscreenCallback()}this.setMode_(Modes.MAGIC_WINDOW),this.requestFullscreen_();break;case Modes.MAGIC_WINDOW:if(this.isFullscreenDisabled)return void window.history.back();this.exitFullscreenCallback&&this.exitFullscreenCallback(),this.setMode_(Modes.NORMAL),this.exitFullscreen_()}},WebVRManager.prototype.onVRClick_=function(){if(this.mode==Modes.NORMAL&&Util.isIOS()&&Util.isIFrame()){if(!this.vrCallback){var url=window.location.href;return url=Util.appendQueryParameter(url,"no_fullscreen","true"),url=Util.appendQueryParameter(url,"start_mode",Modes.VR),void(top.location.href=url)}this.vrCallback()}this.enterVRMode_()},WebVRManager.prototype.requestFullscreen_=function(){var canvas=document.body;canvas.requestFullscreen?canvas.requestFullscreen():canvas.mozRequestFullScreen?canvas.mozRequestFullScreen():canvas.webkitRequestFullscreen?canvas.webkitRequestFullscreen():canvas.msRequestFullscreen&&canvas.msRequestFullscreen()},WebVRManager.prototype.exitFullscreen_=function(){document.exitFullscreen?document.exitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen?document.webkitExitFullscreen():document.msExitFullscreen&&document.msExitFullscreen()},WebVRManager.prototype.onVRDisplayPresentChange_=function(e){console.log("onVRDisplayPresentChange_",e),this.setMode_(this.hmd.isPresenting?Modes.VR:Modes.NORMAL)},WebVRManager.prototype.onVRDisplayDeviceParamsChange_=function(e){console.log("onVRDisplayDeviceParamsChange_",e)},WebVRManager.prototype.onFullscreenChange_=function(){(null===document.webkitFullscreenElement||null===document.mozFullScreenElement)&&this.setMode_(Modes.NORMAL)},module.exports=WebVRManager},{"./button-manager.js":1,"./emitter.js":2,"./modes.js":3,"./util.js":4}]},{},[5])(5)})}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],8:[function(_dereq_,module,exports){(function(global){!function(f){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=f();else if("function"==typeof define&&define.amd)define([],f);else{var g;g="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,g.WebVRPolyfill=f()}}(function(){return function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a="function"==typeof _dereq_&&_dereq_;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}for(var i="function"==typeof _dereq_&&_dereq_,o=0;o<r.length;o++)s(r[o]);return s}({1:[function(_dereq_,module){"use strict";function Events(){}function EE(fn,context,once){this.fn=fn,this.context=context,this.once=once||!1}function EventEmitter(){this._events=new Events,this._eventsCount=0}var has=Object.prototype.hasOwnProperty,prefix="~";Object.create&&(Events.prototype=Object.create(null),(new Events).__proto__||(prefix=!1)),EventEmitter.prototype.eventNames=function(){var events,name,names=[];if(0===this._eventsCount)return names;for(name in events=this._events)has.call(events,name)&&names.push(prefix?name.slice(1):name);return Object.getOwnPropertySymbols?names.concat(Object.getOwnPropertySymbols(events)):names},EventEmitter.prototype.listeners=function(event,exists){var evt=prefix?prefix+event:event,available=this._events[evt];if(exists)return!!available;if(!available)return[];if(available.fn)return[available.fn];for(var i=0,l=available.length,ee=new Array(l);l>i;i++)ee[i]=available[i].fn;return ee},EventEmitter.prototype.emit=function(event,a1,a2,a3,a4,a5){var evt=prefix?prefix+event:event;if(!this._events[evt])return!1;var args,i,listeners=this._events[evt],len=arguments.length;if(listeners.fn){switch(listeners.once&&this.removeListener(event,listeners.fn,void 0,!0),len){case 1:return listeners.fn.call(listeners.context),!0;case 2:return listeners.fn.call(listeners.context,a1),!0;case 3:return listeners.fn.call(listeners.context,a1,a2),!0;case 4:return listeners.fn.call(listeners.context,a1,a2,a3),!0;case 5:return listeners.fn.call(listeners.context,a1,a2,a3,a4),!0;case 6:return listeners.fn.call(listeners.context,a1,a2,a3,a4,a5),!0}for(i=1,args=new Array(len-1);len>i;i++)args[i-1]=arguments[i];listeners.fn.apply(listeners.context,args)}else{var j,length=listeners.length;for(i=0;length>i;i++)switch(listeners[i].once&&this.removeListener(event,listeners[i].fn,void 0,!0),len){case 1:listeners[i].fn.call(listeners[i].context);break;case 2:listeners[i].fn.call(listeners[i].context,a1);break;case 3:listeners[i].fn.call(listeners[i].context,a1,a2);break;case 4:listeners[i].fn.call(listeners[i].context,a1,a2,a3);break;default:if(!args)for(j=1,args=new Array(len-1);len>j;j++)args[j-1]=arguments[j];listeners[i].fn.apply(listeners[i].context,args)}}return!0},EventEmitter.prototype.on=function(event,fn,context){var listener=new EE(fn,context||this),evt=prefix?prefix+event:event;return this._events[evt]?this._events[evt].fn?this._events[evt]=[this._events[evt],listener]:this._events[evt].push(listener):(this._events[evt]=listener,this._eventsCount++),this},EventEmitter.prototype.once=function(event,fn,context){var listener=new EE(fn,context||this,!0),evt=prefix?prefix+event:event;return this._events[evt]?this._events[evt].fn?this._events[evt]=[this._events[evt],listener]:this._events[evt].push(listener):(this._events[evt]=listener,this._eventsCount++),this},EventEmitter.prototype.removeListener=function(event,fn,context,once){var evt=prefix?prefix+event:event;if(!this._events[evt])return this;if(!fn)return 0===--this._eventsCount?this._events=new Events:delete this._events[evt],this;var listeners=this._events[evt];if(listeners.fn)listeners.fn!==fn||once&&!listeners.once||context&&listeners.context!==context||(0===--this._eventsCount?this._events=new Events:delete this._events[evt]);else{for(var i=0,events=[],length=listeners.length;length>i;i++)(listeners[i].fn!==fn||once&&!listeners[i].once||context&&listeners[i].context!==context)&&events.push(listeners[i]);events.length?this._events[evt]=1===events.length?events[0]:events:0===--this._eventsCount?this._events=new Events:delete this._events[evt]}return this},EventEmitter.prototype.removeAllListeners=function(event){var evt;return event?(evt=prefix?prefix+event:event,this._events[evt]&&(0===--this._eventsCount?this._events=new Events:delete this._events[evt])):(this._events=new Events,this._eventsCount=0),this},EventEmitter.prototype.off=EventEmitter.prototype.removeListener,EventEmitter.prototype.addListener=EventEmitter.prototype.on,EventEmitter.prototype.setMaxListeners=function(){return this},EventEmitter.prefixed=prefix,EventEmitter.EventEmitter=EventEmitter,"undefined"!=typeof module&&(module.exports=EventEmitter)},{}],2:[function(_dereq_,module){"use strict";function toObject(val){if(null===val||void 0===val)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(val)}function shouldUseNative(){try{if(!Object.assign)return!1;var test1=new String("abc");if(test1[5]="de","5"===Object.getOwnPropertyNames(test1)[0])return!1;for(var test2={},i=0;10>i;i++)test2["_"+String.fromCharCode(i)]=i;var order2=Object.getOwnPropertyNames(test2).map(function(n){return test2[n]});if("0123456789"!==order2.join(""))return!1;var test3={};return"abcdefghijklmnopqrst".split("").forEach(function(letter){test3[letter]=letter}),"abcdefghijklmnopqrst"!==Object.keys(Object.assign({},test3)).join("")?!1:!0}catch(e){return!1}}var hasOwnProperty=Object.prototype.hasOwnProperty,propIsEnumerable=Object.prototype.propertyIsEnumerable;module.exports=shouldUseNative()?Object.assign:function(target){for(var from,symbols,to=toObject(target),s=1;s<arguments.length;s++){from=Object(arguments[s]);for(var key in from)hasOwnProperty.call(from,key)&&(to[key]=from[key]);if(Object.getOwnPropertySymbols){symbols=Object.getOwnPropertySymbols(from);for(var i=0;i<symbols.length;i++)propIsEnumerable.call(from,symbols[i])&&(to[symbols[i]]=from[symbols[i]])}}return to}},{}],3:[function(_dereq_,module){function VRFrameData(){this.leftProjectionMatrix=new Float32Array(16),this.leftViewMatrix=new Float32Array(16),this.rightProjectionMatrix=new Float32Array(16),this.rightViewMatrix=new Float32Array(16),this.pose=null}function VRDisplay(){this.isPolyfilled=!0,this.displayId=nextDisplayId++,this.displayName="webvr-polyfill displayName",this.depthNear=.01,this.depthFar=1e4,this.isConnected=!0,this.isPresenting=!1,this.capabilities={hasPosition:!1,hasOrientation:!1,hasExternalDisplay:!1,canPresent:!1,maxLayers:1},this.stageParameters=null,this.waitingForPresent_=!1,this.layer_=null,this.fullscreenElement_=null,this.fullscreenWrapper_=null,this.fullscreenElementCachedStyle_=null,this.fullscreenEventTarget_=null,this.fullscreenChangeHandler_=null,this.fullscreenErrorHandler_=null,this.wakelock_=new WakeLock}function VRDevice(){this.isPolyfilled=!0,this.hardwareUnitId="webvr-polyfill hardwareUnitId",this.deviceId="webvr-polyfill deviceId",this.deviceName="webvr-polyfill deviceName"}function HMDVRDevice(){}function PositionSensorVRDevice(){}var Util=_dereq_("./util.js"),WakeLock=_dereq_("./wakelock.js"),nextDisplayId=1e3,hasShowDeprecationWarning=!1,defaultLeftBounds=[0,0,.5,1],defaultRightBounds=[.5,0,.5,1];VRDisplay.prototype.getFrameData=function(frameData){return Util.frameDataFromPose(frameData,this.getPose(),this)},VRDisplay.prototype.getPose=function(){return this.getImmediatePose()},VRDisplay.prototype.requestAnimationFrame=function(callback){return window.requestAnimationFrame(callback)},VRDisplay.prototype.cancelAnimationFrame=function(id){return window.cancelAnimationFrame(id)},VRDisplay.prototype.wrapForFullscreen=function(element){function applyFullscreenElementStyle(){if(self.fullscreenElement_){var cssProperties=["position: absolute","top: 0","left: 0","width: "+Math.max(screen.width,screen.height)+"px","height: "+Math.min(screen.height,screen.width)+"px","border: 0","margin: 0","padding: 0"];self.fullscreenElement_.setAttribute("style",cssProperties.join("; ")+";")}}if(Util.isIOS())return element;if(!this.fullscreenWrapper_){this.fullscreenWrapper_=document.createElement("div");var cssProperties=["height: "+Math.min(screen.height,screen.width)+"px !important","top: 0 !important","left: 0 !important","right: 0 !important","border: 0","margin: 0","padding: 0","z-index: 999999 !important","position: fixed"];this.fullscreenWrapper_.setAttribute("style",cssProperties.join("; ")+";"),this.fullscreenWrapper_.classList.add("webvr-polyfill-fullscreen-wrapper")}if(this.fullscreenElement_==element)return this.fullscreenWrapper_;this.removeFullscreenWrapper(),this.fullscreenElement_=element;var parent=this.fullscreenElement_.parentElement;parent.insertBefore(this.fullscreenWrapper_,this.fullscreenElement_),parent.removeChild(this.fullscreenElement_),this.fullscreenWrapper_.insertBefore(this.fullscreenElement_,this.fullscreenWrapper_.firstChild),this.fullscreenElementCachedStyle_=this.fullscreenElement_.getAttribute("style");var self=this;return applyFullscreenElementStyle(),this.fullscreenWrapper_},VRDisplay.prototype.removeFullscreenWrapper=function(){if(this.fullscreenElement_){var element=this.fullscreenElement_;this.fullscreenElementCachedStyle_?element.setAttribute("style",this.fullscreenElementCachedStyle_):element.removeAttribute("style"),this.fullscreenElement_=null,this.fullscreenElementCachedStyle_=null;var parent=this.fullscreenWrapper_.parentElement;return this.fullscreenWrapper_.removeChild(element),parent.insertBefore(element,this.fullscreenWrapper_),parent.removeChild(this.fullscreenWrapper_),element}},VRDisplay.prototype.requestPresent=function(layers){var wasPresenting=this.isPresenting,self=this;return layers instanceof Array||(hasShowDeprecationWarning||(console.warn("Using a deprecated form of requestPresent. Should pass in an array of VRLayers."),hasShowDeprecationWarning=!0),layers=[layers]),new Promise(function(resolve,reject){function onFullscreenChange(){var actualFullscreenElement=Util.getFullscreenElement();self.isPresenting=fullscreenElement===actualFullscreenElement,self.isPresenting?(screen.orientation&&screen.orientation.lock&&screen.orientation.lock("landscape-primary")["catch"](function(error){console.error("screen.orientation.lock() failed due to",error.message)}),self.waitingForPresent_=!1,self.beginPresent_(),resolve()):(screen.orientation&&screen.orientation.unlock&&screen.orientation.unlock(),self.removeFullscreenWrapper(),self.wakelock_.release(),self.endPresent_(),self.removeFullscreenListeners_()),self.fireVRDisplayPresentChange_()}function onFullscreenError(){self.waitingForPresent_&&(self.removeFullscreenWrapper(),self.removeFullscreenListeners_(),self.wakelock_.release(),self.waitingForPresent_=!1,self.isPresenting=!1,reject(new Error("Unable to present.")))}if(!self.capabilities.canPresent)return void reject(new Error("VRDisplay is not capable of presenting."));if(0==layers.length||layers.length>self.capabilities.maxLayers)return void reject(new Error("Invalid number of layers."));var incomingLayer=layers[0];if(!incomingLayer.source)return void resolve();var leftBounds=incomingLayer.leftBounds||defaultLeftBounds,rightBounds=incomingLayer.rightBounds||defaultRightBounds;if(wasPresenting){var layer=self.layer_;layer.source!==incomingLayer.source&&(layer.source=incomingLayer.source);for(var i=0;4>i;i++)layer.leftBounds[i]=leftBounds[i],layer.rightBounds[i]=rightBounds[i];return void resolve()}if(self.layer_={predistorted:incomingLayer.predistorted,source:incomingLayer.source,leftBounds:leftBounds.slice(0),rightBounds:rightBounds.slice(0)},self.waitingForPresent_=!1,self.layer_&&self.layer_.source){var fullscreenElement=self.wrapForFullscreen(self.layer_.source);self.addFullscreenListeners_(fullscreenElement,onFullscreenChange,onFullscreenError),Util.requestFullscreen(fullscreenElement)?(self.wakelock_.request(),self.waitingForPresent_=!0):Util.isIOS()&&(self.wakelock_.request(),self.isPresenting=!0,self.beginPresent_(),self.fireVRDisplayPresentChange_(),resolve())}self.waitingForPresent_||Util.isIOS()||(Util.exitFullscreen(),reject(new Error("Unable to present.")))})},VRDisplay.prototype.exitPresent=function(){var wasPresenting=this.isPresenting,self=this;return this.isPresenting=!1,this.layer_=null,this.wakelock_.release(),new Promise(function(resolve,reject){wasPresenting?(!Util.exitFullscreen()&&Util.isIOS()&&(self.endPresent_(),self.fireVRDisplayPresentChange_()),resolve()):reject(new Error("Was not presenting to VRDisplay."))})},VRDisplay.prototype.getLayers=function(){return this.layer_?[this.layer_]:[]},VRDisplay.prototype.fireVRDisplayPresentChange_=function(){var event=new CustomEvent("vrdisplaypresentchange",{detail:{display:this}});window.dispatchEvent(event)},VRDisplay.prototype.addFullscreenListeners_=function(element,changeHandler,errorHandler){this.removeFullscreenListeners_(),this.fullscreenEventTarget_=element,this.fullscreenChangeHandler_=changeHandler,this.fullscreenErrorHandler_=errorHandler,changeHandler&&(document.fullscreenEnabled?element.addEventListener("fullscreenchange",changeHandler,!1):document.webkitFullscreenEnabled?element.addEventListener("webkitfullscreenchange",changeHandler,!1):document.mozFullScreenEnabled?document.addEventListener("mozfullscreenchange",changeHandler,!1):document.msFullscreenEnabled&&element.addEventListener("msfullscreenchange",changeHandler,!1)),errorHandler&&(document.fullscreenEnabled?element.addEventListener("fullscreenerror",errorHandler,!1):document.webkitFullscreenEnabled?element.addEventListener("webkitfullscreenerror",errorHandler,!1):document.mozFullScreenEnabled?document.addEventListener("mozfullscreenerror",errorHandler,!1):document.msFullscreenEnabled&&element.addEventListener("msfullscreenerror",errorHandler,!1))},VRDisplay.prototype.removeFullscreenListeners_=function(){if(this.fullscreenEventTarget_){var element=this.fullscreenEventTarget_;if(this.fullscreenChangeHandler_){var changeHandler=this.fullscreenChangeHandler_;element.removeEventListener("fullscreenchange",changeHandler,!1),element.removeEventListener("webkitfullscreenchange",changeHandler,!1),document.removeEventListener("mozfullscreenchange",changeHandler,!1),element.removeEventListener("msfullscreenchange",changeHandler,!1)}if(this.fullscreenErrorHandler_){var errorHandler=this.fullscreenErrorHandler_;element.removeEventListener("fullscreenerror",errorHandler,!1),element.removeEventListener("webkitfullscreenerror",errorHandler,!1),document.removeEventListener("mozfullscreenerror",errorHandler,!1),element.removeEventListener("msfullscreenerror",errorHandler,!1)}this.fullscreenEventTarget_=null,this.fullscreenChangeHandler_=null,this.fullscreenErrorHandler_=null}},VRDisplay.prototype.beginPresent_=function(){},VRDisplay.prototype.endPresent_=function(){},VRDisplay.prototype.submitFrame=function(){},VRDisplay.prototype.getEyeParameters=function(){return null},HMDVRDevice.prototype=new VRDevice,PositionSensorVRDevice.prototype=new VRDevice,module.exports.VRFrameData=VRFrameData,module.exports.VRDisplay=VRDisplay,module.exports.VRDevice=VRDevice,module.exports.HMDVRDevice=HMDVRDevice,module.exports.PositionSensorVRDevice=PositionSensorVRDevice},{"./util.js":22,"./wakelock.js":24}],4:[function(_dereq_,module){function CardboardDistorter(gl){this.gl=gl,this.ctxAttribs=gl.getContextAttributes(),this.meshWidth=20,this.meshHeight=20,this.bufferScale=WebVRConfig.BUFFER_SCALE,this.bufferWidth=gl.drawingBufferWidth,this.bufferHeight=gl.drawingBufferHeight,this.realBindFramebuffer=gl.bindFramebuffer,this.realEnable=gl.enable,this.realDisable=gl.disable,this.realColorMask=gl.colorMask,this.realClearColor=gl.clearColor,this.realViewport=gl.viewport,Util.isIOS()||(this.realCanvasWidth=Object.getOwnPropertyDescriptor(gl.canvas.__proto__,"width"),this.realCanvasHeight=Object.getOwnPropertyDescriptor(gl.canvas.__proto__,"height")),this.isPatched=!1,this.lastBoundFramebuffer=null,this.cullFace=!1,this.depthTest=!1,this.blend=!1,this.scissorTest=!1,this.stencilTest=!1,this.viewport=[0,0,0,0],this.colorMask=[!0,!0,!0,!0],this.clearColor=[0,0,0,0],this.attribs={position:0,texCoord:1},this.program=Util.linkProgram(gl,distortionVS,distortionFS,this.attribs),this.uniforms=Util.getProgramUniforms(gl,this.program),this.viewportOffsetScale=new Float32Array(8),this.setTextureBounds(),this.vertexBuffer=gl.createBuffer(),this.indexBuffer=gl.createBuffer(),this.indexCount=0,this.renderTarget=gl.createTexture(),this.framebuffer=gl.createFramebuffer(),this.depthStencilBuffer=null,this.depthBuffer=null,this.stencilBuffer=null,this.ctxAttribs.depth&&this.ctxAttribs.stencil?this.depthStencilBuffer=gl.createRenderbuffer():this.ctxAttribs.depth?this.depthBuffer=gl.createRenderbuffer():this.ctxAttribs.stencil&&(this.stencilBuffer=gl.createRenderbuffer()),this.patch(),this.onResize(),WebVRConfig.CARDBOARD_UI_DISABLED||(this.cardboardUI=new CardboardUI(gl))}var CardboardUI=_dereq_("./cardboard-ui.js"),Util=_dereq_("./util.js"),WGLUPreserveGLState=_dereq_("./deps/wglu-preserve-state.js"),distortionVS=["attribute vec2 position;","attribute vec3 texCoord;","varying vec2 vTexCoord;","uniform vec4 viewportOffsetScale[2];","void main() {","  vec4 viewport = viewportOffsetScale[int(texCoord.z)];","  vTexCoord = (texCoord.xy * viewport.zw) + viewport.xy;","  gl_Position = vec4( position, 1.0, 1.0 );","}"].join("\n"),distortionFS=["precision mediump float;","uniform sampler2D diffuse;","varying vec2 vTexCoord;","void main() {","  gl_FragColor = texture2D(diffuse, vTexCoord);","}"].join("\n");CardboardDistorter.prototype.destroy=function(){var gl=this.gl;this.unpatch(),gl.deleteProgram(this.program),gl.deleteBuffer(this.vertexBuffer),gl.deleteBuffer(this.indexBuffer),gl.deleteTexture(this.renderTarget),gl.deleteFramebuffer(this.framebuffer),this.depthStencilBuffer&&gl.deleteRenderbuffer(this.depthStencilBuffer),this.depthBuffer&&gl.deleteRenderbuffer(this.depthBuffer),this.stencilBuffer&&gl.deleteRenderbuffer(this.stencilBuffer),this.cardboardUI&&this.cardboardUI.destroy()},CardboardDistorter.prototype.onResize=function(){var gl=this.gl,self=this,glState=[gl.RENDERBUFFER_BINDING,gl.TEXTURE_BINDING_2D,gl.TEXTURE0];WGLUPreserveGLState(gl,glState,function(gl){self.realBindFramebuffer.call(gl,gl.FRAMEBUFFER,null),self.scissorTest&&self.realDisable.call(gl,gl.SCISSOR_TEST),self.realColorMask.call(gl,!0,!0,!0,!0),self.realViewport.call(gl,0,0,gl.drawingBufferWidth,gl.drawingBufferHeight),self.realClearColor.call(gl,0,0,0,1),gl.clear(gl.COLOR_BUFFER_BIT),self.realBindFramebuffer.call(gl,gl.FRAMEBUFFER,self.framebuffer),
